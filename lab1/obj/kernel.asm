...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200430:	a9450513          	addi	a0,a0,-1388 # 80200ec0 <etext+0x520>
    ...
    80200440:	a7450513          	addi	a0,a0,-1420 # 80200eb0 <etext+0x510>
    ...
    80200456:	e398                	sd	a4,0(a5)
                ticks=0;
    80200458:	00004717          	auipc	a4,0x4
    8020045c:	ba073c23          	sd	zero,-1096(a4) # 80204010 <ticks>
                if(num==10){
