...
ffffffffc020006e:	68c030ef          	jal	ra,ffffffffc02036fa <vmm_init>
...
ffffffffc0200276:	88e90913          	addi	s2,s2,-1906 # ffffffffc0205b00 <default_pmm_manager+0x950>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	78a0306f          	j	ffffffffc0203cd2 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0200b6e:	7ae5b583          	ld	a1,1966(a1) # ffffffffc0206318 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	7aa63603          	ld	a2,1962(a2) # ffffffffc0206320 <nbase>
...
ffffffffc0201614:	1a3010ef          	jal	ra,ffffffffc0202fb6 <swap_out>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0201722:	bfab3b03          	ld	s6,-1030(s6) # ffffffffc0206318 <error_string+0x38>
...
ffffffffc02017d0:	b4cb3b03          	ld	s6,-1204(s6) # ffffffffc0206318 <error_string+0x38>
...
ffffffffc02019f8:	92443403          	ld	s0,-1756(s0) # ffffffffc0206318 <error_string+0x38>
...
ffffffffc0201dfe:	51ecbc83          	ld	s9,1310(s9) # ffffffffc0206318 <error_string+0x38>
...
ffffffffc0202712:	099000ef          	jal	ra,ffffffffc0202faa <swap_map_swappable>
...
ffffffffc02027a4:	b786b683          	ld	a3,-1160(a3) # ffffffffc0206318 <error_string+0x38>
...
ffffffffc020294c:	3ee7ed63          	bltu	a5,a4,ffffffffc0202d46 <swap_init+0x42c>
...
ffffffffc0202958:	6798                	ld	a4,8(a5)
     sm = &swap_manager_clock;//use first in first out Page Replacement Algorithm
ffffffffc020295a:	0000fa97          	auipc	s5,0xf
ffffffffc020295e:	beea8a93          	addi	s5,s5,-1042 # ffffffffc0211548 <sm>
ffffffffc0202962:	00fab023          	sd	a5,0(s5)
     int r = sm->init();
ffffffffc0202966:	9702                	jalr	a4
ffffffffc0202968:	892a                	mv	s2,a0
...
ffffffffc0202972:	79e6                	ld	s3,120(sp)
...
ffffffffc0202984:	854a                	mv	a0,s2
ffffffffc0202986:	690a                	ld	s2,128(sp)
ffffffffc0202988:	610d                	addi	sp,sp,160
ffffffffc020298a:	8082                	ret
          cprintf("SWAP: manager = %s\n", sm->name);
ffffffffc020298c:	000ab783          	ld	a5,0(s5)
...
ffffffffc0202994:	ed850513          	addi	a0,a0,-296 # ffffffffc0205868 <default_pmm_manager+0x6b8>
    return listelm->next;
ffffffffc0202998:	0000e417          	auipc	s0,0xe
ffffffffc020299c:	6a840413          	addi	s0,s0,1704 # ffffffffc0211040 <free_area>
...
ffffffffc02029b0:	641c                	ld	a5,8(s0)
...
ffffffffc02029b2:	4d81                	li	s11,0
ffffffffc02029b4:	4d01                	li	s10,0
     list_entry_t *le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc02029b6:	2c878e63          	beq	a5,s0,ffffffffc0202c92 <swap_init+0x378>
    return (((*(volatile unsigned long *)addr) >> nr) & 1);
ffffffffc02029ba:	fe87b703          	ld	a4,-24(a5)
        struct Page *p = le2page(le, page_link);
        assert(PageProperty(p));
ffffffffc02029be:	8b09                	andi	a4,a4,2
ffffffffc02029c0:	2c070b63          	beqz	a4,ffffffffc0202c96 <swap_init+0x37c>
        count ++, total += p->property;
ffffffffc02029c4:	ff87a703          	lw	a4,-8(a5)
ffffffffc02029c8:	679c                	ld	a5,8(a5)
ffffffffc02029ca:	2d05                	addiw	s10,s10,1
ffffffffc02029cc:	01b70dbb          	addw	s11,a4,s11
     while ((le = list_next(le)) != &free_list) {
ffffffffc02029d0:	fe8795e3          	bne	a5,s0,ffffffffc02029ba <swap_init+0xa0>
     }
     assert(total == nr_free_pages());
ffffffffc02029d4:	84ee                	mv	s1,s11
ffffffffc02029d6:	cbdfe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02029da:	48951263          	bne	a0,s1,ffffffffc0202e5e <swap_init+0x544>
     cprintf("BEGIN check_swap: count %d, total %d\n",count,total);
ffffffffc02029de:	866e                	mv	a2,s11
ffffffffc02029e0:	85ea                	mv	a1,s10
ffffffffc02029e2:	00003517          	auipc	a0,0x3
ffffffffc02029e6:	e9e50513          	addi	a0,a0,-354 # ffffffffc0205880 <default_pmm_manager+0x6d0>
ffffffffc02029ea:	ed0fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ee:	351000ef          	jal	ra,ffffffffc020353e <mm_create>
ffffffffc02029f2:	ec2a                	sd	a0,24(sp)
     assert(mm != NULL);
ffffffffc02029f4:	54050563          	beqz	a0,ffffffffc0202f3e <swap_init+0x624>

     extern struct mm_struct *check_mm_struct;
     assert(check_mm_struct == NULL);
ffffffffc02029f8:	0000f797          	auipc	a5,0xf
ffffffffc02029fc:	b6878793          	addi	a5,a5,-1176 # ffffffffc0211560 <check_mm_struct>
ffffffffc0202a00:	6398                	ld	a4,0(a5)
ffffffffc0202a02:	54071e63          	bnez	a4,ffffffffc0202f5e <swap_init+0x644>

     check_mm_struct = mm;
ffffffffc0202a06:	66e2                	ld	a3,24(sp)

     pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0202a08:	0000fb17          	auipc	s6,0xf
ffffffffc0202a0c:	b10b3b03          	ld	s6,-1264(s6) # ffffffffc0211518 <boot_pgdir>
     assert(pgdir[0] == 0);
ffffffffc0202a10:	000b3703          	ld	a4,0(s6)
     check_mm_struct = mm;
ffffffffc0202a14:	e394                	sd	a3,0(a5)
     pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0202a16:	0166bc23          	sd	s6,24(a3)
     assert(pgdir[0] == 0);
ffffffffc0202a1a:	3e071263          	bnez	a4,ffffffffc0202dfe <swap_init+0x4e4>

     struct vma_struct *vma = vma_create(BEING_CHECK_VALID_VADDR, CHECK_VALID_VADDR, VM_WRITE | VM_READ);
ffffffffc0202a1e:	6599                	lui	a1,0x6
ffffffffc0202a20:	460d                	li	a2,3
ffffffffc0202a22:	6505                	lui	a0,0x1
ffffffffc0202a24:	363000ef          	jal	ra,ffffffffc0203586 <vma_create>
ffffffffc0202a28:	85aa                	mv	a1,a0
     assert(vma != NULL);
ffffffffc0202a2a:	3e050a63          	beqz	a0,ffffffffc0202e1e <swap_init+0x504>

     insert_vma_struct(mm, vma);
ffffffffc0202a2e:	64e2                	ld	s1,24(sp)
ffffffffc0202a30:	8526                	mv	a0,s1
ffffffffc0202a32:	3c3000ef          	jal	ra,ffffffffc02035f4 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a36:	00003517          	auipc	a0,0x3
ffffffffc0202a3a:	eba50513          	addi	a0,a0,-326 # ffffffffc02058f0 <default_pmm_manager+0x740>
ffffffffc0202a3e:	e7cfd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     pte_t *temp_ptep=NULL;
     temp_ptep = get_pte(mm->pgdir, BEING_CHECK_VALID_VADDR, 1);
ffffffffc0202a42:	6c88                	ld	a0,24(s1)
ffffffffc0202a44:	4605                	li	a2,1
ffffffffc0202a46:	6585                	lui	a1,0x1
ffffffffc0202a48:	c85fe0ef          	jal	ra,ffffffffc02016cc <get_pte>
     assert(temp_ptep!= NULL);
ffffffffc0202a4c:	3e050963          	beqz	a0,ffffffffc0202e3e <swap_init+0x524>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
ffffffffc0202a50:	00003517          	auipc	a0,0x3
ffffffffc0202a54:	ef050513          	addi	a0,a0,-272 # ffffffffc0205940 <default_pmm_manager+0x790>
ffffffffc0202a58:	0000e497          	auipc	s1,0xe
ffffffffc0202a5c:	62048493          	addi	s1,s1,1568 # ffffffffc0211078 <check_rp>
ffffffffc0202a60:	e5afd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202a64:	0000e997          	auipc	s3,0xe
ffffffffc0202a68:	63498993          	addi	s3,s3,1588 # ffffffffc0211098 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
ffffffffc0202a6c:	8ba6                	mv	s7,s1
          check_rp[i] = alloc_page();
ffffffffc0202a6e:	4505                	li	a0,1
ffffffffc0202a70:	b51fe0ef          	jal	ra,ffffffffc02015c0 <alloc_pages>
ffffffffc0202a74:	00abb023          	sd	a0,0(s7)
          assert(check_rp[i] != NULL );
ffffffffc0202a78:	2a050763          	beqz	a0,ffffffffc0202d26 <swap_init+0x40c>
ffffffffc0202a7c:	651c                	ld	a5,8(a0)
          assert(!PageProperty(check_rp[i]));
ffffffffc0202a7e:	8b89                	andi	a5,a5,2
ffffffffc0202a80:	28079363          	bnez	a5,ffffffffc0202d06 <swap_init+0x3ec>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202a84:	0ba1                	addi	s7,s7,8
ffffffffc0202a86:	ff3b94e3          	bne	s7,s3,ffffffffc0202a6e <swap_init+0x154>
     }
     list_entry_t free_list_store = free_list;
ffffffffc0202a8a:	601c                	ld	a5,0(s0)
ffffffffc0202a8c:	00843c03          	ld	s8,8(s0)
    elm->prev = elm->next = elm;
ffffffffc0202a90:	e000                	sd	s0,0(s0)
ffffffffc0202a92:	f03e                	sd	a5,32(sp)
     list_init(&free_list);
     assert(list_empty(&free_list));
     ...
     unsigned int nr_free_store = nr_free;
ffffffffc0202a94:	481c                	lw	a5,16(s0)
ffffffffc0202a96:	e400                	sd	s0,8(s0)
     nr_free = 0;
ffffffffc0202a98:	0000eb97          	auipc	s7,0xe
ffffffffc0202a9c:	5e0b8b93          	addi	s7,s7,1504 # ffffffffc0211078 <check_rp>
     unsigned int nr_free_store = nr_free;
ffffffffc0202aa0:	f43e                	sd	a5,40(sp)
     nr_free = 0;
ffffffffc0202aa2:	0000e797          	auipc	a5,0xe
ffffffffc0202aa6:	5a07a723          	sw	zero,1454(a5) # ffffffffc0211050 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
        free_pages(check_rp[i],1);
ffffffffc0202aaa:	000bb503          	ld	a0,0(s7)
ffffffffc0202aae:	4585                	li	a1,1
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202ab0:	0ba1                	addi	s7,s7,8
        free_pages(check_rp[i],1);
ffffffffc0202ab2:	ba1fe0ef          	jal	ra,ffffffffc0201652 <free_pages>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202ab6:	ff3b9ae3          	bne	s7,s3,ffffffffc0202aaa <swap_init+0x190>
     }
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202aba:	01042b83          	lw	s7,16(s0)
ffffffffc0202abe:	4791                	li	a5,4
ffffffffc0202ac0:	4afb9f63          	bne	s7,a5,ffffffffc0202f7e <swap_init+0x664>
     
     cprintf("set up init env for check_swap begin!\n");
ffffffffc0202ac4:	00003517          	auipc	a0,0x3
ffffffffc0202ac8:	f0450513          	addi	a0,a0,-252 # ffffffffc02059c8 <default_pmm_manager+0x818>
ffffffffc0202acc:	deefd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0202ad0:	6685                	lui	a3,0x1
     //setup initial vir_page<->phy_page environment for page relpacement algorithm 

     
     pgfault_num=0;
ffffffffc0202ad2:	0000f797          	auipc	a5,0xf
ffffffffc0202ad6:	a807ab23          	sw	zero,-1386(a5) # ffffffffc0211568 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0202ada:	45a9                	li	a1,10
ffffffffc0202adc:	00b68023          	sb	a1,0(a3) # 1000 <kern_entry-0xffffffffc01ff000>
     assert(pgfault_num==1);
ffffffffc0202ae0:	0000f617          	auipc	a2,0xf
ffffffffc0202ae4:	a8862603          	lw	a2,-1400(a2) # ffffffffc0211568 <pgfault_num>
ffffffffc0202ae8:	4505                	li	a0,1
ffffffffc0202aea:	0000f797          	auipc	a5,0xf
ffffffffc0202aee:	a7e78793          	addi	a5,a5,-1410 # ffffffffc0211568 <pgfault_num>
ffffffffc0202af2:	40a61663          	bne	a2,a0,ffffffffc0202efe <swap_init+0x5e4>
     *(unsigned char *)0x1010 = 0x0a;
ffffffffc0202af6:	00b68823          	sb	a1,16(a3)
     assert(pgfault_num==1);
ffffffffc0202afa:	4394                	lw	a3,0(a5)
ffffffffc0202afc:	2681                	sext.w	a3,a3
ffffffffc0202afe:	42c69063          	bne	a3,a2,ffffffffc0202f1e <swap_init+0x604>
     *(unsigned char *)0x2000 = 0x0b;
ffffffffc0202b02:	6609                	lui	a2,0x2
ffffffffc0202b04:	45ad                	li	a1,11
ffffffffc0202b06:	00b60023          	sb	a1,0(a2) # 2000 <kern_entry-0xffffffffc01fe000>
     assert(pgfault_num==2);
ffffffffc0202b0a:	4394                	lw	a3,0(a5)
ffffffffc0202b0c:	4509                	li	a0,2
ffffffffc0202b0e:	2681                	sext.w	a3,a3
ffffffffc0202b10:	36a69763          	bne	a3,a0,ffffffffc0202e7e <swap_init+0x564>
     *(unsigned char *)0x2010 = 0x0b;
ffffffffc0202b14:	00b60823          	sb	a1,16(a2)
     assert(pgfault_num==2);
ffffffffc0202b18:	4390                	lw	a2,0(a5)
ffffffffc0202b1a:	2601                	sext.w	a2,a2
ffffffffc0202b1c:	38d61163          	bne	a2,a3,ffffffffc0202e9e <swap_init+0x584>
     *(unsigned char *)0x3000 = 0x0c;
ffffffffc0202b20:	660d                	lui	a2,0x3
ffffffffc0202b22:	45b1                	li	a1,12
ffffffffc0202b24:	00b60023          	sb	a1,0(a2) # 3000 <kern_entry-0xffffffffc01fd000>
     assert(pgfault_num==3);
ffffffffc0202b28:	4394                	lw	a3,0(a5)
ffffffffc0202b2a:	450d                	li	a0,3
ffffffffc0202b2c:	2681                	sext.w	a3,a3
ffffffffc0202b2e:	38a69863          	bne	a3,a0,ffffffffc0202ebe <swap_init+0x5a4>
     *(unsigned char *)0x3010 = 0x0c;
ffffffffc0202b32:	00b60823          	sb	a1,16(a2)
     assert(pgfault_num==3);
ffffffffc0202b36:	4390                	lw	a2,0(a5)
ffffffffc0202b38:	2601                	sext.w	a2,a2
ffffffffc0202b3a:	3ad61263          	bne	a2,a3,ffffffffc0202ede <swap_init+0x5c4>
     *(unsigned char *)0x4000 = 0x0d;
ffffffffc0202b3e:	6611                	lui	a2,0x4
ffffffffc0202b40:	45b5                	li	a1,13
ffffffffc0202b42:	00b60023          	sb	a1,0(a2) # 4000 <kern_entry-0xffffffffc01fc000>
     assert(pgfault_num==4);
ffffffffc0202b46:	4394                	lw	a3,0(a5)
ffffffffc0202b48:	2681                	sext.w	a3,a3
ffffffffc0202b4a:	23769a63          	bne	a3,s7,ffffffffc0202d7e <swap_init+0x464>
     *(unsigned char *)0x4010 = 0x0d;
ffffffffc0202b4e:	00b60823          	sb	a1,16(a2)
     assert(pgfault_num==4);
ffffffffc0202b52:	439c                	lw	a5,0(a5)
ffffffffc0202b54:	2781                	sext.w	a5,a5
ffffffffc0202b56:	24d79463          	bne	a5,a3,ffffffffc0202d9e <swap_init+0x484>
     
     check_content_set();
     assert( nr_free == 0);         
ffffffffc0202b5a:	481c                	lw	a5,16(s0)
ffffffffc0202b5c:	26079163          	bnez	a5,ffffffffc0202dbe <swap_init+0x4a4>
ffffffffc0202b60:	0000e797          	auipc	a5,0xe
ffffffffc0202b64:	53878793          	addi	a5,a5,1336 # ffffffffc0211098 <swap_in_seq_no>
ffffffffc0202b68:	0000e697          	auipc	a3,0xe
ffffffffc0202b6c:	55868693          	addi	a3,a3,1368 # ffffffffc02110c0 <swap_out_seq_no>
ffffffffc0202b70:	0000e597          	auipc	a1,0xe
ffffffffc0202b74:	55058593          	addi	a1,a1,1360 # ffffffffc02110c0 <swap_out_seq_no>
     for(i = 0; i<MAX_SEQ_NO ; i++) 
         swap_out_seq_no[i]=swap_in_seq_no[i]=-1;
ffffffffc0202b78:	567d                	li	a2,-1
ffffffffc0202b7a:	c390                	sw	a2,0(a5)
ffffffffc0202b7c:	c290                	sw	a2,0(a3)
     for(i = 0; i<MAX_SEQ_NO ; i++) 
ffffffffc0202b7e:	0791                	addi	a5,a5,4
ffffffffc0202b80:	0691                	addi	a3,a3,4
ffffffffc0202b82:	fef59ce3          	bne	a1,a5,ffffffffc0202b7a <swap_init+0x260>
ffffffffc0202b86:	0000eb97          	auipc	s7,0xe
ffffffffc0202b8a:	4d2b8b93          	addi	s7,s7,1234 # ffffffffc0211058 <check_ptep>
ffffffffc0202b8e:	0000ef17          	auipc	t5,0xe
ffffffffc0202b92:	4eaf0f13          	addi	t5,t5,1258 # ffffffffc0211078 <check_rp>
     
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202b96:	4a01                	li	s4,0
     for(i = 0; i<MAX_SEQ_NO ; i++) 
ffffffffc0202b98:	6e85                	lui	t4,0x1
    return &pages[PPN(pa) - nbase];
ffffffffc0202b9a:	00003c97          	auipc	s9,0x3
ffffffffc0202b9e:	786c8c93          	addi	s9,s9,1926 # ffffffffc0206320 <nbase>
         check_ptep[i]=0;
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202ba2:	85f6                	mv	a1,t4
ffffffffc0202ba4:	4601                	li	a2,0
ffffffffc0202ba6:	855a                	mv	a0,s6
         check_ptep[i]=0;
ffffffffc0202ba8:	000bb023          	sd	zero,0(s7)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202bac:	e87a                	sd	t5,16(sp)
ffffffffc0202bae:	e476                	sd	t4,8(sp)
ffffffffc0202bb0:	b1dfe0ef          	jal	ra,ffffffffc02016cc <get_pte>
         cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
ffffffffc0202bb4:	6114                	ld	a3,0(a0)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202bb6:	862a                	mv	a2,a0
ffffffffc0202bb8:	85d2                	mv	a1,s4
         cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
ffffffffc0202bba:	00003517          	auipc	a0,0x3
ffffffffc0202bbe:	e7650513          	addi	a0,a0,-394 # ffffffffc0205a30 <default_pmm_manager+0x880>
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202bc2:	00cbb023          	sd	a2,0(s7)
         cprintf("i %d, check_ptep addr %x, value %x\n", i, check_ptep[i], *check_ptep[i]);
ffffffffc0202bc6:	cf4fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
         assert(check_ptep[i] != NULL);
ffffffffc0202bca:	000bb783          	ld	a5,0(s7)
ffffffffc0202bce:	6ea2                	ld	t4,8(sp)
ffffffffc0202bd0:	6f42                	ld	t5,16(sp)
         check_ptep[i] = get_pte(pgdir, (i+1)*0x1000, 0);
ffffffffc0202bd2:	2a05                	addiw	s4,s4,1
         assert(check_ptep[i] != NULL);
ffffffffc0202bd4:	0000ff97          	auipc	t6,0xf
ffffffffc0202bd8:	94cf8f93          	addi	t6,t6,-1716 # ffffffffc0211520 <npage>
ffffffffc0202bdc:	0000f717          	auipc	a4,0xf
ffffffffc0202be0:	94c70713          	addi	a4,a4,-1716 # ffffffffc0211528 <pages>
ffffffffc0202be4:	16078d63          	beqz	a5,ffffffffc0202d5e <swap_init+0x444>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202be8:	639c                	ld	a5,0(a5)
    if (!(pte & PTE_V)) {
ffffffffc0202bea:	0017f693          	andi	a3,a5,1
ffffffffc0202bee:	0e068463          	beqz	a3,ffffffffc0202cd6 <swap_init+0x3bc>
    if (PPN(pa) >= npage) {
ffffffffc0202bf2:	000fb683          	ld	a3,0(t6)
    return pa2page(PTE_ADDR(pte));
ffffffffc0202bf6:	078a                	slli	a5,a5,0x2
ffffffffc0202bf8:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0202bfa:	0ed7fa63          	bgeu	a5,a3,ffffffffc0202cee <swap_init+0x3d4>
    return &pages[PPN(pa) - nbase];
ffffffffc0202bfe:	000cb583          	ld	a1,0(s9)
ffffffffc0202c02:	6314                	ld	a3,0(a4)
ffffffffc0202c04:	000f3603          	ld	a2,0(t5)
ffffffffc0202c08:	8f8d                	sub	a5,a5,a1
ffffffffc0202c0a:	00379593          	slli	a1,a5,0x3
ffffffffc0202c0e:	97ae                	add	a5,a5,a1
ffffffffc0202c10:	078e                	slli	a5,a5,0x3
ffffffffc0202c12:	97b6                	add	a5,a5,a3
ffffffffc0202c14:	0af61163          	bne	a2,a5,ffffffffc0202cb6 <swap_init+0x39c>
     for (i= 0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202c18:	6785                	lui	a5,0x1
ffffffffc0202c1a:	9ebe                	add	t4,t4,a5
ffffffffc0202c1c:	4791                	li	a5,4
ffffffffc0202c1e:	0ba1                	addi	s7,s7,8
ffffffffc0202c20:	0f21                	addi	t5,t5,8
ffffffffc0202c22:	f8fa10e3          	bne	s4,a5,ffffffffc0202ba2 <swap_init+0x288>
         assert((*check_ptep[i] & PTE_V));          
     }
     cprintf("set up init env for check_swap over!\n");
ffffffffc0202c26:	00003517          	auipc	a0,0x3
ffffffffc0202c2a:	e7250513          	addi	a0,a0,-398 # ffffffffc0205a98 <default_pmm_manager+0x8e8>
ffffffffc0202c2e:	c8cfd0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = sm->check_swap();
ffffffffc0202c32:	000ab783          	ld	a5,0(s5)
ffffffffc0202c36:	7f9c                	ld	a5,56(a5)
ffffffffc0202c38:	9782                	jalr	a5
     // now access the virt pages to test  page relpacement algorithm 
     ret=check_content_access();
     assert(ret==0);
ffffffffc0202c3a:	1a051263          	bnez	a0,ffffffffc0202dde <swap_init+0x4c4>
     
     //restore kernel mem env
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
         free_pages(check_rp[i],1);
ffffffffc0202c3e:	6088                	ld	a0,0(s1)
ffffffffc0202c40:	4585                	li	a1,1
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202c42:	04a1                	addi	s1,s1,8
         free_pages(check_rp[i],1);
ffffffffc0202c44:	a0ffe0ef          	jal	ra,ffffffffc0201652 <free_pages>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc0202c48:	ff349be3          	bne	s1,s3,ffffffffc0202c3e <swap_init+0x324>
     } 

     //free_page(pte2page(*temp_ptep));
     
     mm_destroy(mm);
ffffffffc0202c4c:	6562                	ld	a0,24(sp)
ffffffffc0202c4e:	277000ef          	jal	ra,ffffffffc02036c4 <mm_destroy>
         
     nr_free = nr_free_store;
ffffffffc0202c52:	77a2                	ld	a5,40(sp)
     free_list = free_list_store;
ffffffffc0202c54:	01843423          	sd	s8,8(s0)
     nr_free = nr_free_store;
ffffffffc0202c58:	c81c                	sw	a5,16(s0)
     free_list = free_list_store;
ffffffffc0202c5a:	7782                	ld	a5,32(sp)
ffffffffc0202c5c:	e01c                	sd	a5,0(s0)

     
     le = &free_list;
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c5e:	008c0b63          	beq	s8,s0,ffffffffc0202c74 <swap_init+0x35a>
         struct Page *p = le2page(le, page_link);
         count --, total -= p->property;
ffffffffc0202c62:	ff8c2783          	lw	a5,-8(s8)
    return listelm->next;
ffffffffc0202c66:	008c3c03          	ld	s8,8(s8)
ffffffffc0202c6a:	3d7d                	addiw	s10,s10,-1
ffffffffc0202c6c:	40fd8dbb          	subw	s11,s11,a5
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c70:	fe8c19e3          	bne	s8,s0,ffffffffc0202c62 <swap_init+0x348>
     }
     cprintf("count is %d, total is %d\n",count,total);
ffffffffc0202c74:	866e                	mv	a2,s11
ffffffffc0202c76:	85ea                	mv	a1,s10
ffffffffc0202c78:	00003517          	auipc	a0,0x3
ffffffffc0202c7c:	e5050513          	addi	a0,a0,-432 # ffffffffc0205ac8 <default_pmm_manager+0x918>
ffffffffc0202c80:	c3afd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c84:	00003517          	auipc	a0,0x3
ffffffffc0202c88:	e6450513          	addi	a0,a0,-412 # ffffffffc0205ae8 <default_pmm_manager+0x938>
ffffffffc0202c8c:	c2efd0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0202c90:	b9f1                	j	ffffffffc020296c <swap_init+0x52>
     while ((le = list_next(le)) != &free_list) {
ffffffffc0202c92:	4481                	li	s1,0
ffffffffc0202c94:	b389                	j	ffffffffc02029d6 <swap_init+0xbc>
        assert(PageProperty(p));
ffffffffc0202c96:	00002697          	auipc	a3,0x2
ffffffffc0202c9a:	15a68693          	addi	a3,a3,346 # ffffffffc0204df0 <commands+0x728>
ffffffffc0202c9e:	00002617          	auipc	a2,0x2
ffffffffc0202ca2:	16260613          	addi	a2,a2,354 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202ca6:	0ba00593          	li	a1,186
ffffffffc0202caa:	00003517          	auipc	a0,0x3
ffffffffc0202cae:	bae50513          	addi	a0,a0,-1106 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202cb2:	ec2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202cb6:	00003697          	auipc	a3,0x3
ffffffffc0202cba:	dba68693          	addi	a3,a3,-582 # ffffffffc0205a70 <default_pmm_manager+0x8c0>
ffffffffc0202cbe:	00002617          	auipc	a2,0x2
ffffffffc0202cc2:	14260613          	addi	a2,a2,322 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202cc6:	0fa00593          	li	a1,250
ffffffffc0202cca:	00003517          	auipc	a0,0x3
ffffffffc0202cce:	b8e50513          	addi	a0,a0,-1138 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202cd2:	ea2fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cd6:	00002617          	auipc	a2,0x2
ffffffffc0202cda:	54260613          	addi	a2,a2,1346 # ffffffffc0205218 <default_pmm_manager+0x68>
ffffffffc0202cde:	07000593          	li	a1,112
ffffffffc0202ce2:	00002517          	auipc	a0,0x2
ffffffffc0202ce6:	52650513          	addi	a0,a0,1318 # ffffffffc0205208 <default_pmm_manager+0x58>
ffffffffc0202cea:	e8afd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cee:	00002617          	auipc	a2,0x2
ffffffffc0202cf2:	4fa60613          	addi	a2,a2,1274 # ffffffffc02051e8 <default_pmm_manager+0x38>
ffffffffc0202cf6:	06500593          	li	a1,101
ffffffffc0202cfa:	00002517          	auipc	a0,0x2
ffffffffc0202cfe:	50e50513          	addi	a0,a0,1294 # ffffffffc0205208 <default_pmm_manager+0x58>
ffffffffc0202d02:	e72fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202d06:	00003697          	auipc	a3,0x3
ffffffffc0202d0a:	c7a68693          	addi	a3,a3,-902 # ffffffffc0205980 <default_pmm_manager+0x7d0>
ffffffffc0202d0e:	00002617          	auipc	a2,0x2
ffffffffc0202d12:	0f260613          	addi	a2,a2,242 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202d16:	0db00593          	li	a1,219
ffffffffc0202d1a:	00003517          	auipc	a0,0x3
ffffffffc0202d1e:	b3e50513          	addi	a0,a0,-1218 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202d22:	e52fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d26:	00003697          	auipc	a3,0x3
ffffffffc0202d2a:	c4268693          	addi	a3,a3,-958 # ffffffffc0205968 <default_pmm_manager+0x7b8>
ffffffffc0202d2e:	00002617          	auipc	a2,0x2
ffffffffc0202d32:	0d260613          	addi	a2,a2,210 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202d36:	0da00593          	li	a1,218
ffffffffc0202d3a:	00003517          	auipc	a0,0x3
ffffffffc0202d3e:	b1e50513          	addi	a0,a0,-1250 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202d42:	e32fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d46:	00003617          	auipc	a2,0x3
ffffffffc0202d4a:	af260613          	addi	a2,a2,-1294 # ffffffffc0205838 <default_pmm_manager+0x688>
ffffffffc0202d4e:	02700593          	li	a1,39
ffffffffc0202d52:	00003517          	auipc	a0,0x3
ffffffffc0202d56:	b0650513          	addi	a0,a0,-1274 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202d5a:	e1afd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d5e:	00003697          	auipc	a3,0x3
ffffffffc0202d62:	cfa68693          	addi	a3,a3,-774 # ffffffffc0205a58 <default_pmm_manager+0x8a8>
ffffffffc0202d66:	00002617          	auipc	a2,0x2
ffffffffc0202d6a:	09a60613          	addi	a2,a2,154 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202d6e:	0f900593          	li	a1,249
ffffffffc0202d72:	00003517          	auipc	a0,0x3
ffffffffc0202d76:	ae650513          	addi	a0,a0,-1306 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202d7a:	dfafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d7e:	00003697          	auipc	a3,0x3
ffffffffc0202d82:	ca268693          	addi	a3,a3,-862 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc0202d86:	00002617          	auipc	a2,0x2
ffffffffc0202d8a:	07a60613          	addi	a2,a2,122 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202d8e:	09d00593          	li	a1,157
ffffffffc0202d92:	00003517          	auipc	a0,0x3
ffffffffc0202d96:	ac650513          	addi	a0,a0,-1338 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202d9a:	ddafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d9e:	00003697          	auipc	a3,0x3
ffffffffc0202da2:	c8268693          	addi	a3,a3,-894 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc0202da6:	00002617          	auipc	a2,0x2
ffffffffc0202daa:	05a60613          	addi	a2,a2,90 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202dae:	09f00593          	li	a1,159
ffffffffc0202db2:	00003517          	auipc	a0,0x3
ffffffffc0202db6:	aa650513          	addi	a0,a0,-1370 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202dba:	dbafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202dbe:	00002697          	auipc	a3,0x2
ffffffffc0202dc2:	21a68693          	addi	a3,a3,538 # ffffffffc0204fd8 <commands+0x910>
ffffffffc0202dc6:	00002617          	auipc	a2,0x2
ffffffffc0202dca:	03a60613          	addi	a2,a2,58 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202dce:	0f100593          	li	a1,241
ffffffffc0202dd2:	00003517          	auipc	a0,0x3
ffffffffc0202dd6:	a8650513          	addi	a0,a0,-1402 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202dda:	d9afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dde:	00003697          	auipc	a3,0x3
ffffffffc0202de2:	ce268693          	addi	a3,a3,-798 # ffffffffc0205ac0 <default_pmm_manager+0x910>
ffffffffc0202de6:	00002617          	auipc	a2,0x2
ffffffffc0202dea:	01a60613          	addi	a2,a2,26 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202dee:	10000593          	li	a1,256
ffffffffc0202df2:	00003517          	auipc	a0,0x3
ffffffffc0202df6:	a6650513          	addi	a0,a0,-1434 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202dfa:	d7afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202dfe:	00003697          	auipc	a3,0x3
ffffffffc0202e02:	ad268693          	addi	a3,a3,-1326 # ffffffffc02058d0 <default_pmm_manager+0x720>
ffffffffc0202e06:	00002617          	auipc	a2,0x2
ffffffffc0202e0a:	ffa60613          	addi	a2,a2,-6 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202e0e:	0ca00593          	li	a1,202
ffffffffc0202e12:	00003517          	auipc	a0,0x3
ffffffffc0202e16:	a4650513          	addi	a0,a0,-1466 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202e1a:	d5afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e1e:	00003697          	auipc	a3,0x3
ffffffffc0202e22:	ac268693          	addi	a3,a3,-1342 # ffffffffc02058e0 <default_pmm_manager+0x730>
ffffffffc0202e26:	00002617          	auipc	a2,0x2
ffffffffc0202e2a:	fda60613          	addi	a2,a2,-38 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202e2e:	0cd00593          	li	a1,205
ffffffffc0202e32:	00003517          	auipc	a0,0x3
ffffffffc0202e36:	a2650513          	addi	a0,a0,-1498 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202e3a:	d3afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e3e:	00003697          	auipc	a3,0x3
ffffffffc0202e42:	aea68693          	addi	a3,a3,-1302 # ffffffffc0205928 <default_pmm_manager+0x778>
ffffffffc0202e46:	00002617          	auipc	a2,0x2
ffffffffc0202e4a:	fba60613          	addi	a2,a2,-70 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202e4e:	0d500593          	li	a1,213
ffffffffc0202e52:	00003517          	auipc	a0,0x3
ffffffffc0202e56:	a0650513          	addi	a0,a0,-1530 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202e5a:	d1afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e5e:	00002697          	auipc	a3,0x2
ffffffffc0202e62:	fd268693          	addi	a3,a3,-46 # ffffffffc0204e30 <commands+0x768>
ffffffffc0202e66:	00002617          	auipc	a2,0x2
ffffffffc0202e6a:	f9a60613          	addi	a2,a2,-102 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202e6e:	0bd00593          	li	a1,189
ffffffffc0202e72:	00003517          	auipc	a0,0x3
ffffffffc0202e76:	9e650513          	addi	a0,a0,-1562 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202e7a:	cfafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e7e:	00003697          	auipc	a3,0x3
ffffffffc0202e82:	b8268693          	addi	a3,a3,-1150 # ffffffffc0205a00 <default_pmm_manager+0x850>
ffffffffc0202e86:	00002617          	auipc	a2,0x2
ffffffffc0202e8a:	f7a60613          	addi	a2,a2,-134 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202e8e:	09500593          	li	a1,149
ffffffffc0202e92:	00003517          	auipc	a0,0x3
ffffffffc0202e96:	9c650513          	addi	a0,a0,-1594 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202e9a:	cdafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e9e:	00003697          	auipc	a3,0x3
ffffffffc0202ea2:	b6268693          	addi	a3,a3,-1182 # ffffffffc0205a00 <default_pmm_manager+0x850>
ffffffffc0202ea6:	00002617          	auipc	a2,0x2
ffffffffc0202eaa:	f5a60613          	addi	a2,a2,-166 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202eae:	09700593          	li	a1,151
ffffffffc0202eb2:	00003517          	auipc	a0,0x3
ffffffffc0202eb6:	9a650513          	addi	a0,a0,-1626 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202eba:	cbafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ebe:	00003697          	auipc	a3,0x3
ffffffffc0202ec2:	b5268693          	addi	a3,a3,-1198 # ffffffffc0205a10 <default_pmm_manager+0x860>
ffffffffc0202ec6:	00002617          	auipc	a2,0x2
ffffffffc0202eca:	f3a60613          	addi	a2,a2,-198 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202ece:	09900593          	li	a1,153
ffffffffc0202ed2:	00003517          	auipc	a0,0x3
ffffffffc0202ed6:	98650513          	addi	a0,a0,-1658 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202eda:	c9afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ede:	00003697          	auipc	a3,0x3
ffffffffc0202ee2:	b3268693          	addi	a3,a3,-1230 # ffffffffc0205a10 <default_pmm_manager+0x860>
ffffffffc0202ee6:	00002617          	auipc	a2,0x2
ffffffffc0202eea:	f1a60613          	addi	a2,a2,-230 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202eee:	09b00593          	li	a1,155
ffffffffc0202ef2:	00003517          	auipc	a0,0x3
ffffffffc0202ef6:	96650513          	addi	a0,a0,-1690 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202efa:	c7afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202efe:	00003697          	auipc	a3,0x3
ffffffffc0202f02:	af268693          	addi	a3,a3,-1294 # ffffffffc02059f0 <default_pmm_manager+0x840>
ffffffffc0202f06:	00002617          	auipc	a2,0x2
ffffffffc0202f0a:	efa60613          	addi	a2,a2,-262 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202f0e:	09100593          	li	a1,145
ffffffffc0202f12:	00003517          	auipc	a0,0x3
ffffffffc0202f16:	94650513          	addi	a0,a0,-1722 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202f1a:	c5afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f1e:	00003697          	auipc	a3,0x3
ffffffffc0202f22:	ad268693          	addi	a3,a3,-1326 # ffffffffc02059f0 <default_pmm_manager+0x840>
ffffffffc0202f26:	00002617          	auipc	a2,0x2
ffffffffc0202f2a:	eda60613          	addi	a2,a2,-294 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202f2e:	09300593          	li	a1,147
ffffffffc0202f32:	00003517          	auipc	a0,0x3
ffffffffc0202f36:	92650513          	addi	a0,a0,-1754 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202f3a:	c3afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f3e:	00003697          	auipc	a3,0x3
ffffffffc0202f42:	96a68693          	addi	a3,a3,-1686 # ffffffffc02058a8 <default_pmm_manager+0x6f8>
ffffffffc0202f46:	00002617          	auipc	a2,0x2
ffffffffc0202f4a:	eba60613          	addi	a2,a2,-326 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202f4e:	0c200593          	li	a1,194
ffffffffc0202f52:	00003517          	auipc	a0,0x3
ffffffffc0202f56:	90650513          	addi	a0,a0,-1786 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202f5a:	c1afd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f5e:	00003697          	auipc	a3,0x3
ffffffffc0202f62:	95a68693          	addi	a3,a3,-1702 # ffffffffc02058b8 <default_pmm_manager+0x708>
ffffffffc0202f66:	00002617          	auipc	a2,0x2
ffffffffc0202f6a:	e9a60613          	addi	a2,a2,-358 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202f6e:	0c500593          	li	a1,197
ffffffffc0202f72:	00003517          	auipc	a0,0x3
ffffffffc0202f76:	8e650513          	addi	a0,a0,-1818 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202f7a:	bfafd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f7e:	00003697          	auipc	a3,0x3
ffffffffc0202f82:	a2268693          	addi	a3,a3,-1502 # ffffffffc02059a0 <default_pmm_manager+0x7f0>
ffffffffc0202f86:	00002617          	auipc	a2,0x2
ffffffffc0202f8a:	e7a60613          	addi	a2,a2,-390 # ffffffffc0204e00 <commands+0x738>
ffffffffc0202f8e:	0e800593          	li	a1,232
ffffffffc0202f92:	00003517          	auipc	a0,0x3
ffffffffc0202f96:	8c650513          	addi	a0,a0,-1850 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0202f9a:	bdafd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0202f9e <swap_init_mm>:
     return sm->init_mm(mm);
ffffffffc0202f9e:	0000e797          	auipc	a5,0xe
ffffffffc0202fa2:	5aa7b783          	ld	a5,1450(a5) # ffffffffc0211548 <sm>
ffffffffc0202fa6:	6b9c                	ld	a5,16(a5)
ffffffffc0202fa8:	8782                	jr	a5

ffffffffc0202faa <swap_map_swappable>:
     return sm->map_swappable(mm, addr, page, swap_in);
ffffffffc0202faa:	0000e797          	auipc	a5,0xe
ffffffffc0202fae:	59e7b783          	ld	a5,1438(a5) # ffffffffc0211548 <sm>
ffffffffc0202fb2:	739c                	ld	a5,32(a5)
ffffffffc0202fb4:	8782                	jr	a5

ffffffffc0202fb6 <swap_out>:
{
ffffffffc0202fb6:	7159                	addi	sp,sp,-112
ffffffffc0202fb8:	f486                	sd	ra,104(sp)
ffffffffc0202fba:	f0a2                	sd	s0,96(sp)
ffffffffc0202fbc:	eca6                	sd	s1,88(sp)
ffffffffc0202fbe:	e8ca                	sd	s2,80(sp)
ffffffffc0202fc0:	e4ce                	sd	s3,72(sp)
ffffffffc0202fc2:	e0d2                	sd	s4,64(sp)
ffffffffc0202fc4:	fc56                	sd	s5,56(sp)
ffffffffc0202fc6:	f85a                	sd	s6,48(sp)
ffffffffc0202fc8:	f45e                	sd	s7,40(sp)
ffffffffc0202fca:	f062                	sd	s8,32(sp)
ffffffffc0202fcc:	ec66                	sd	s9,24(sp)
ffffffffc0202fce:	e86a                	sd	s10,16(sp)
     for (i = 0; i != n; ++ i)
ffffffffc0202fd0:	10058063          	beqz	a1,ffffffffc02030d0 <swap_out+0x11a>
...
ffffffffc0202fe0:	56c98993          	addi	s3,s3,1388 # ffffffffc0211548 <sm>
           cprintf("i %d, SWAP: call swap_out_victim\n",i);
ffffffffc0202fe4:	00003b17          	auipc	s6,0x3
ffffffffc0202fe8:	b24b0b13          	addi	s6,s6,-1244 # ffffffffc0205b08 <default_pmm_manager+0x958>
          cprintf("SWAP: choose victim page 0x%08x\n", page);
ffffffffc0202fec:	00003b97          	auipc	s7,0x3
ffffffffc0202ff0:	b74b8b93          	addi	s7,s7,-1164 # ffffffffc0205b60 <default_pmm_manager+0x9b0>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0202ff4:	00003c17          	auipc	s8,0x3
ffffffffc0202ff8:	bc4c0c13          	addi	s8,s8,-1084 # ffffffffc0205bb8 <default_pmm_manager+0xa08>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202ffc:	00003c97          	auipc	s9,0x3
ffffffffc0203000:	ba4c8c93          	addi	s9,s9,-1116 # ffffffffc0205ba0 <default_pmm_manager+0x9f0>
ffffffffc0203004:	a825                	j	ffffffffc020303c <swap_out+0x86>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
...
ffffffffc020300e:	8562                	mv	a0,s8
     for (i = 0; i != n; ++ i)
...
ffffffffc0203026:	00fd3023          	sd	a5,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
                    free_page(page);
ffffffffc020302a:	e28fe0ef          	jal	ra,ffffffffc0201652 <free_pages>
          tlb_invalidate(mm->pgdir, v);
ffffffffc020302e:	01893503          	ld	a0,24(s2)
ffffffffc0203032:	85a6                	mv	a1,s1
ffffffffc0203034:	e86ff0ef          	jal	ra,ffffffffc02026ba <tlb_invalidate>
     for (i = 0; i != n; ++ i)
ffffffffc0203038:	068a0563          	beq	s4,s0,ffffffffc02030a2 <swap_out+0xec>
           cprintf("i %d, SWAP: call swap_out_victim\n",i);
ffffffffc020303c:	85a2                	mv	a1,s0
ffffffffc020303e:	855a                	mv	a0,s6
ffffffffc0203040:	87afd0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc0203050:	9782                	jalr	a5
          if (r != 0) {
ffffffffc0203052:	e53d                	bnez	a0,ffffffffc02030c0 <swap_out+0x10a>
          cprintf("SWAP: choose victim page 0x%08x\n", page);
ffffffffc0203054:	65a2                	ld	a1,8(sp)
ffffffffc0203056:	855e                	mv	a0,s7
ffffffffc0203058:	862fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
          v=page->pra_vaddr; 
...
ffffffffc0203068:	e64fe0ef          	jal	ra,ffffffffc02016cc <get_pte>
          assert((*ptep & PTE_V) != 0);
ffffffffc020306c:	611c                	ld	a5,0(a0)
          pte_t *ptep = get_pte(mm->pgdir, v, 0);
ffffffffc020306e:	8d2a                	mv	s10,a0
          assert((*ptep & PTE_V) != 0);
ffffffffc0203070:	8b85                	andi	a5,a5,1
ffffffffc0203072:	c3ad                	beqz	a5,ffffffffc02030d4 <swap_out+0x11e>
...
ffffffffc0203080:	609000ef          	jal	ra,ffffffffc0203e88 <swapfs_write>
ffffffffc0203084:	d149                	beqz	a0,ffffffffc0203006 <swap_out+0x50>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203086:	8566                	mv	a0,s9
...
ffffffffc020309c:	9782                	jalr	a5
     for (i = 0; i != n; ++ i)
ffffffffc020309e:	f88a1fe3          	bne	s4,s0,ffffffffc020303c <swap_out+0x86>
}
ffffffffc02030a2:	70a6                	ld	ra,104(sp)
ffffffffc02030a4:	8522                	mv	a0,s0
ffffffffc02030a6:	7406                	ld	s0,96(sp)
ffffffffc02030a8:	64e6                	ld	s1,88(sp)
ffffffffc02030aa:	6946                	ld	s2,80(sp)
ffffffffc02030ac:	69a6                	ld	s3,72(sp)
ffffffffc02030ae:	6a06                	ld	s4,64(sp)
ffffffffc02030b0:	7ae2                	ld	s5,56(sp)
ffffffffc02030b2:	7b42                	ld	s6,48(sp)
ffffffffc02030b4:	7ba2                	ld	s7,40(sp)
ffffffffc02030b6:	7c02                	ld	s8,32(sp)
ffffffffc02030b8:	6ce2                	ld	s9,24(sp)
ffffffffc02030ba:	6d42                	ld	s10,16(sp)
ffffffffc02030bc:	6165                	addi	sp,sp,112
ffffffffc02030be:	8082                	ret
                    cprintf("i %d, swap_out: call swap_out_victim failed\n",i);
ffffffffc02030c0:	85a2                	mv	a1,s0
ffffffffc02030c2:	00003517          	auipc	a0,0x3
ffffffffc02030c6:	a6e50513          	addi	a0,a0,-1426 # ffffffffc0205b30 <default_pmm_manager+0x980>
ffffffffc02030ca:	ff1fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
                  break;
ffffffffc02030ce:	bfd1                	j	ffffffffc02030a2 <swap_out+0xec>
     for (i = 0; i != n; ++ i)
ffffffffc02030d0:	4401                	li	s0,0
ffffffffc02030d2:	bfc1                	j	ffffffffc02030a2 <swap_out+0xec>
          assert((*ptep & PTE_V) != 0);
ffffffffc02030d4:	00003697          	auipc	a3,0x3
ffffffffc02030d8:	ab468693          	addi	a3,a3,-1356 # ffffffffc0205b88 <default_pmm_manager+0x9d8>
ffffffffc02030dc:	00002617          	auipc	a2,0x2
ffffffffc02030e0:	d2460613          	addi	a2,a2,-732 # ffffffffc0204e00 <commands+0x738>
ffffffffc02030e4:	06600593          	li	a1,102
ffffffffc02030e8:	00002517          	auipc	a0,0x2
ffffffffc02030ec:	77050513          	addi	a0,a0,1904 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc02030f0:	a84fd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02030f4 <swap_in>:
{
ffffffffc02030f4:	7179                	addi	sp,sp,-48
ffffffffc02030f6:	ec26                	sd	s1,24(sp)
ffffffffc02030f8:	84aa                	mv	s1,a0
     struct Page *result = alloc_page();
ffffffffc02030fa:	4505                	li	a0,1
{
ffffffffc02030fc:	e84a                	sd	s2,16(sp)
ffffffffc02030fe:	e44e                	sd	s3,8(sp)
ffffffffc0203100:	f406                	sd	ra,40(sp)
ffffffffc0203102:	f022                	sd	s0,32(sp)
ffffffffc0203104:	892e                	mv	s2,a1
ffffffffc0203106:	89b2                	mv	s3,a2
     struct Page *result = alloc_page();
ffffffffc0203108:	cb8fe0ef          	jal	ra,ffffffffc02015c0 <alloc_pages>
     assert(result!=NULL);
ffffffffc020310c:	c53d                	beqz	a0,ffffffffc020317a <swap_in+0x86>
     pte_t *ptep = get_pte(mm->pgdir, addr, 0);
ffffffffc020310e:	842a                	mv	s0,a0
ffffffffc0203110:	6c88                	ld	a0,24(s1)
ffffffffc0203112:	85ca                	mv	a1,s2
ffffffffc0203114:	4601                	li	a2,0
ffffffffc0203116:	db6fe0ef          	jal	ra,ffffffffc02016cc <get_pte>
      cprintf("SWAP: load ptep %x swap entry %d to vaddr 0x%08x, page %x, No %d\n", ptep, (*ptep)>>8, addr, result, (result-pages));
ffffffffc020311a:	0000e797          	auipc	a5,0xe
ffffffffc020311e:	40e7b783          	ld	a5,1038(a5) # ffffffffc0211528 <pages>
ffffffffc0203122:	40f407b3          	sub	a5,s0,a5
ffffffffc0203126:	00003717          	auipc	a4,0x3
ffffffffc020312a:	1f273703          	ld	a4,498(a4) # ffffffffc0206318 <error_string+0x38>
ffffffffc020312e:	878d                	srai	a5,a5,0x3
ffffffffc0203130:	02e787b3          	mul	a5,a5,a4
ffffffffc0203134:	6110                	ld	a2,0(a0)
     pte_t *ptep = get_pte(mm->pgdir, addr, 0);
ffffffffc0203136:	84aa                	mv	s1,a0
      cprintf("SWAP: load ptep %x swap entry %d to vaddr 0x%08x, page %x, No %d\n", ptep, (*ptep)>>8, addr, result, (result-pages));
ffffffffc0203138:	8722                	mv	a4,s0
ffffffffc020313a:	86ca                	mv	a3,s2
ffffffffc020313c:	8221                	srli	a2,a2,0x8
ffffffffc020313e:	85aa                	mv	a1,a0
ffffffffc0203140:	00003517          	auipc	a0,0x3
ffffffffc0203144:	ac850513          	addi	a0,a0,-1336 # ffffffffc0205c08 <default_pmm_manager+0xa58>
ffffffffc0203148:	f73fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
     if ((r = swapfs_read((*ptep), result)) != 0)
ffffffffc020314c:	6088                	ld	a0,0(s1)
ffffffffc020314e:	85a2                	mv	a1,s0
ffffffffc0203150:	49f000ef          	jal	ra,ffffffffc0203dee <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203154:	608c                	ld	a1,0(s1)
ffffffffc0203156:	864a                	mv	a2,s2
ffffffffc0203158:	00003517          	auipc	a0,0x3
ffffffffc020315c:	af850513          	addi	a0,a0,-1288 # ffffffffc0205c50 <default_pmm_manager+0xaa0>
ffffffffc0203160:	81a1                	srli	a1,a1,0x8
ffffffffc0203162:	f59fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203166:	70a2                	ld	ra,40(sp)
     *ptr_result=result;
ffffffffc0203168:	0089b023          	sd	s0,0(s3)
}
ffffffffc020316c:	7402                	ld	s0,32(sp)
ffffffffc020316e:	64e2                	ld	s1,24(sp)
ffffffffc0203170:	6942                	ld	s2,16(sp)
ffffffffc0203172:	69a2                	ld	s3,8(sp)
ffffffffc0203174:	4501                	li	a0,0
ffffffffc0203176:	6145                	addi	sp,sp,48
ffffffffc0203178:	8082                	ret
     assert(result!=NULL);
ffffffffc020317a:	00003697          	auipc	a3,0x3
ffffffffc020317e:	a7e68693          	addi	a3,a3,-1410 # ffffffffc0205bf8 <default_pmm_manager+0xa48>
ffffffffc0203182:	00002617          	auipc	a2,0x2
ffffffffc0203186:	c7e60613          	addi	a2,a2,-898 # ffffffffc0204e00 <commands+0x738>
ffffffffc020318a:	07c00593          	li	a1,124
ffffffffc020318e:	00002517          	auipc	a0,0x2
ffffffffc0203192:	6ca50513          	addi	a0,a0,1738 # ffffffffc0205858 <default_pmm_manager+0x6a8>
ffffffffc0203196:	9defd0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020319a <_clock_init_mm>:
    elm->prev = elm->next = elm;
ffffffffc020319a:	0000e797          	auipc	a5,0xe
ffffffffc020319e:	f4e78793          	addi	a5,a5,-178 # ffffffffc02110e8 <pra_list_head>
...
ffffffffc02031a2:	f51c                	sd	a5,40(a0)
ffffffffc02031a4:	e79c                	sd	a5,8(a5)
ffffffffc02031a6:	e39c                	sd	a5,0(a5)
     curr_ptr=&pra_list_head;
ffffffffc02031a8:	0000e717          	auipc	a4,0xe
ffffffffc02031ac:	3af73823          	sd	a5,944(a4) # ffffffffc0211558 <curr_ptr>
...
ffffffffc02031b4:	4501                	li	a0,0
ffffffffc02031b6:	8082                	ret

ffffffffc02031b8 <_clock_set_unswappable>:
...
ffffffffc02031b8:	4501                	li	a0,0
ffffffffc02031ba:	8082                	ret

ffffffffc02031bc <_clock_tick_event>:
...
ffffffffc02031c0 <_clock_check_swap>:
_clock_check_swap(void) {
ffffffffc02031c0:	1141                	addi	sp,sp,-16
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc02031c2:	4731                	li	a4,12
_clock_check_swap(void) {
ffffffffc02031c4:	e406                	sd	ra,8(sp)
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc02031c6:	678d                	lui	a5,0x3
ffffffffc02031c8:	00e78023          	sb	a4,0(a5) # 3000 <kern_entry-0xffffffffc01fd000>
    assert(pgfault_num==4);
ffffffffc02031cc:	0000e697          	auipc	a3,0xe
ffffffffc02031d0:	39c6a683          	lw	a3,924(a3) # ffffffffc0211568 <pgfault_num>
ffffffffc02031d4:	4711                	li	a4,4
ffffffffc02031d6:	0ae69363          	bne	a3,a4,ffffffffc020327c <_clock_check_swap+0xbc>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc02031da:	6705                	lui	a4,0x1
ffffffffc02031dc:	4629                	li	a2,10
ffffffffc02031de:	0000e797          	auipc	a5,0xe
ffffffffc02031e2:	38a78793          	addi	a5,a5,906 # ffffffffc0211568 <pgfault_num>
ffffffffc02031e6:	00c70023          	sb	a2,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
    assert(pgfault_num==4);
ffffffffc02031ea:	4398                	lw	a4,0(a5)
ffffffffc02031ec:	2701                	sext.w	a4,a4
ffffffffc02031ee:	20d71763          	bne	a4,a3,ffffffffc02033fc <_clock_check_swap+0x23c>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02031f2:	6691                	lui	a3,0x4
ffffffffc02031f4:	4635                	li	a2,13
ffffffffc02031f6:	00c68023          	sb	a2,0(a3) # 4000 <kern_entry-0xffffffffc01fc000>
    assert(pgfault_num==4);
ffffffffc02031fa:	4394                	lw	a3,0(a5)
ffffffffc02031fc:	2681                	sext.w	a3,a3
ffffffffc02031fe:	1ce69f63          	bne	a3,a4,ffffffffc02033dc <_clock_check_swap+0x21c>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203202:	6709                	lui	a4,0x2
ffffffffc0203204:	462d                	li	a2,11
ffffffffc0203206:	00c70023          	sb	a2,0(a4) # 2000 <kern_entry-0xffffffffc01fe000>
    assert(pgfault_num==4);
ffffffffc020320a:	4398                	lw	a4,0(a5)
ffffffffc020320c:	2701                	sext.w	a4,a4
ffffffffc020320e:	1ad71763          	bne	a4,a3,ffffffffc02033bc <_clock_check_swap+0x1fc>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc0203212:	6715                	lui	a4,0x5
ffffffffc0203214:	46b9                	li	a3,14
ffffffffc0203216:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc020321a:	4398                	lw	a4,0(a5)
ffffffffc020321c:	4695                	li	a3,5
ffffffffc020321e:	2701                	sext.w	a4,a4
ffffffffc0203220:	16d71e63          	bne	a4,a3,ffffffffc020339c <_clock_check_swap+0x1dc>
    assert(pgfault_num==5);
ffffffffc0203224:	4394                	lw	a3,0(a5)
ffffffffc0203226:	2681                	sext.w	a3,a3
ffffffffc0203228:	14e69a63          	bne	a3,a4,ffffffffc020337c <_clock_check_swap+0x1bc>
    assert(pgfault_num==5);
ffffffffc020322c:	4398                	lw	a4,0(a5)
ffffffffc020322e:	2701                	sext.w	a4,a4
ffffffffc0203230:	12d71663          	bne	a4,a3,ffffffffc020335c <_clock_check_swap+0x19c>
    assert(pgfault_num==5);
ffffffffc0203234:	4394                	lw	a3,0(a5)
ffffffffc0203236:	2681                	sext.w	a3,a3
ffffffffc0203238:	10e69263          	bne	a3,a4,ffffffffc020333c <_clock_check_swap+0x17c>
    assert(pgfault_num==5);
ffffffffc020323c:	4398                	lw	a4,0(a5)
ffffffffc020323e:	2701                	sext.w	a4,a4
ffffffffc0203240:	0cd71e63          	bne	a4,a3,ffffffffc020331c <_clock_check_swap+0x15c>
    assert(pgfault_num==5);
ffffffffc0203244:	4394                	lw	a3,0(a5)
ffffffffc0203246:	2681                	sext.w	a3,a3
ffffffffc0203248:	0ae69a63          	bne	a3,a4,ffffffffc02032fc <_clock_check_swap+0x13c>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc020324c:	6715                	lui	a4,0x5
ffffffffc020324e:	46b9                	li	a3,14
ffffffffc0203250:	00d70023          	sb	a3,0(a4) # 5000 <kern_entry-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc0203254:	4398                	lw	a4,0(a5)
ffffffffc0203256:	4695                	li	a3,5
ffffffffc0203258:	2701                	sext.w	a4,a4
ffffffffc020325a:	08d71163          	bne	a4,a3,ffffffffc02032dc <_clock_check_swap+0x11c>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020325e:	6705                	lui	a4,0x1
ffffffffc0203260:	00074683          	lbu	a3,0(a4) # 1000 <kern_entry-0xffffffffc01ff000>
ffffffffc0203264:	4729                	li	a4,10
ffffffffc0203266:	04e69b63          	bne	a3,a4,ffffffffc02032bc <_clock_check_swap+0xfc>
    assert(pgfault_num==6);
ffffffffc020326a:	439c                	lw	a5,0(a5)
ffffffffc020326c:	4719                	li	a4,6
ffffffffc020326e:	2781                	sext.w	a5,a5
ffffffffc0203270:	02e79663          	bne	a5,a4,ffffffffc020329c <_clock_check_swap+0xdc>
}
...
ffffffffc0203280:	7a468693          	addi	a3,a3,1956 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc0203284:	00002617          	auipc	a2,0x2
ffffffffc0203288:	b7c60613          	addi	a2,a2,-1156 # ffffffffc0204e00 <commands+0x738>
ffffffffc020328c:	08d00593          	li	a1,141
ffffffffc0203290:	00003517          	auipc	a0,0x3
ffffffffc0203294:	a0050513          	addi	a0,a0,-1536 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203298:	8dcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020329c:	00003697          	auipc	a3,0x3
ffffffffc02032a0:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205ce0 <default_pmm_manager+0xb30>
ffffffffc02032a4:	00002617          	auipc	a2,0x2
ffffffffc02032a8:	b5c60613          	addi	a2,a2,-1188 # ffffffffc0204e00 <commands+0x738>
ffffffffc02032ac:	0a400593          	li	a1,164
ffffffffc02032b0:	00003517          	auipc	a0,0x3
ffffffffc02032b4:	9e050513          	addi	a0,a0,-1568 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02032b8:	8bcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc02032bc:	00003697          	auipc	a3,0x3
ffffffffc02032c0:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0205cb8 <default_pmm_manager+0xb08>
ffffffffc02032c4:	00002617          	auipc	a2,0x2
ffffffffc02032c8:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0204e00 <commands+0x738>
ffffffffc02032cc:	0a200593          	li	a1,162
ffffffffc02032d0:	00003517          	auipc	a0,0x3
ffffffffc02032d4:	9c050513          	addi	a0,a0,-1600 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02032d8:	89cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032dc:	00003697          	auipc	a3,0x3
ffffffffc02032e0:	9cc68693          	addi	a3,a3,-1588 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc02032e4:	00002617          	auipc	a2,0x2
ffffffffc02032e8:	b1c60613          	addi	a2,a2,-1252 # ffffffffc0204e00 <commands+0x738>
ffffffffc02032ec:	0a100593          	li	a1,161
ffffffffc02032f0:	00003517          	auipc	a0,0x3
ffffffffc02032f4:	9a050513          	addi	a0,a0,-1632 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02032f8:	87cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032fc:	00003697          	auipc	a3,0x3
ffffffffc0203300:	9ac68693          	addi	a3,a3,-1620 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc0203304:	00002617          	auipc	a2,0x2
ffffffffc0203308:	afc60613          	addi	a2,a2,-1284 # ffffffffc0204e00 <commands+0x738>
ffffffffc020330c:	09f00593          	li	a1,159
ffffffffc0203310:	00003517          	auipc	a0,0x3
ffffffffc0203314:	98050513          	addi	a0,a0,-1664 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203318:	85cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020331c:	00003697          	auipc	a3,0x3
ffffffffc0203320:	98c68693          	addi	a3,a3,-1652 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc0203324:	00002617          	auipc	a2,0x2
ffffffffc0203328:	adc60613          	addi	a2,a2,-1316 # ffffffffc0204e00 <commands+0x738>
ffffffffc020332c:	09d00593          	li	a1,157
ffffffffc0203330:	00003517          	auipc	a0,0x3
ffffffffc0203334:	96050513          	addi	a0,a0,-1696 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203338:	83cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020333c:	00003697          	auipc	a3,0x3
ffffffffc0203340:	96c68693          	addi	a3,a3,-1684 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc0203344:	00002617          	auipc	a2,0x2
ffffffffc0203348:	abc60613          	addi	a2,a2,-1348 # ffffffffc0204e00 <commands+0x738>
ffffffffc020334c:	09b00593          	li	a1,155
ffffffffc0203350:	00003517          	auipc	a0,0x3
ffffffffc0203354:	94050513          	addi	a0,a0,-1728 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203358:	81cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020335c:	00003697          	auipc	a3,0x3
ffffffffc0203360:	94c68693          	addi	a3,a3,-1716 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc0203364:	00002617          	auipc	a2,0x2
ffffffffc0203368:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0204e00 <commands+0x738>
ffffffffc020336c:	09900593          	li	a1,153
ffffffffc0203370:	00003517          	auipc	a0,0x3
ffffffffc0203374:	92050513          	addi	a0,a0,-1760 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203378:	ffdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020337c:	00003697          	auipc	a3,0x3
ffffffffc0203380:	92c68693          	addi	a3,a3,-1748 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc0203384:	00002617          	auipc	a2,0x2
ffffffffc0203388:	a7c60613          	addi	a2,a2,-1412 # ffffffffc0204e00 <commands+0x738>
ffffffffc020338c:	09700593          	li	a1,151
ffffffffc0203390:	00003517          	auipc	a0,0x3
ffffffffc0203394:	90050513          	addi	a0,a0,-1792 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203398:	fddfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020339c:	00003697          	auipc	a3,0x3
ffffffffc02033a0:	90c68693          	addi	a3,a3,-1780 # ffffffffc0205ca8 <default_pmm_manager+0xaf8>
ffffffffc02033a4:	00002617          	auipc	a2,0x2
ffffffffc02033a8:	a5c60613          	addi	a2,a2,-1444 # ffffffffc0204e00 <commands+0x738>
ffffffffc02033ac:	09500593          	li	a1,149
ffffffffc02033b0:	00003517          	auipc	a0,0x3
ffffffffc02033b4:	8e050513          	addi	a0,a0,-1824 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02033b8:	fbdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02033bc:	00002697          	auipc	a3,0x2
ffffffffc02033c0:	66468693          	addi	a3,a3,1636 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc02033c4:	00002617          	auipc	a2,0x2
ffffffffc02033c8:	a3c60613          	addi	a2,a2,-1476 # ffffffffc0204e00 <commands+0x738>
ffffffffc02033cc:	09300593          	li	a1,147
ffffffffc02033d0:	00003517          	auipc	a0,0x3
ffffffffc02033d4:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02033d8:	f9dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02033dc:	00002697          	auipc	a3,0x2
ffffffffc02033e0:	64468693          	addi	a3,a3,1604 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc02033e4:	00002617          	auipc	a2,0x2
ffffffffc02033e8:	a1c60613          	addi	a2,a2,-1508 # ffffffffc0204e00 <commands+0x738>
ffffffffc02033ec:	09100593          	li	a1,145
ffffffffc02033f0:	00003517          	auipc	a0,0x3
ffffffffc02033f4:	8a050513          	addi	a0,a0,-1888 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02033f8:	f7dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02033fc:	00002697          	auipc	a3,0x2
ffffffffc0203400:	62468693          	addi	a3,a3,1572 # ffffffffc0205a20 <default_pmm_manager+0x870>
ffffffffc0203404:	00002617          	auipc	a2,0x2
ffffffffc0203408:	9fc60613          	addi	a2,a2,-1540 # ffffffffc0204e00 <commands+0x738>
ffffffffc020340c:	08f00593          	li	a1,143
ffffffffc0203410:	00003517          	auipc	a0,0x3
ffffffffc0203414:	88050513          	addi	a0,a0,-1920 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc0203418:	f5dfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020341c <_clock_swap_out_victim>:
{
ffffffffc020341c:	7179                	addi	sp,sp,-48
ffffffffc020341e:	ec26                	sd	s1,24(sp)
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203420:	7504                	ld	s1,40(a0)
{
ffffffffc0203422:	f406                	sd	ra,40(sp)
ffffffffc0203424:	f022                	sd	s0,32(sp)
ffffffffc0203426:	e84a                	sd	s2,16(sp)
ffffffffc0203428:	e44e                	sd	s3,8(sp)
         assert(head != NULL);
ffffffffc020342a:	c4ad                	beqz	s1,ffffffffc0203494 <_clock_swap_out_victim+0x78>
ffffffffc020342c:	89ae                	mv	s3,a1
     assert(in_tick==0);
ffffffffc020342e:	87a6                	mv	a5,s1
ffffffffc0203430:	0000e417          	auipc	s0,0xe
ffffffffc0203434:	12840413          	addi	s0,s0,296 # ffffffffc0211558 <curr_ptr>
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203438:	00003917          	auipc	s2,0x3
ffffffffc020343c:	8d890913          	addi	s2,s2,-1832 # ffffffffc0205d10 <default_pmm_manager+0xb60>
     assert(in_tick==0);
ffffffffc0203440:	ca19                	beqz	a2,ffffffffc0203456 <_clock_swap_out_victim+0x3a>
ffffffffc0203442:	a88d                	j	ffffffffc02034b4 <_clock_swap_out_victim+0x98>
        if(page->visited==0){
ffffffffc0203444:	fe05b783          	ld	a5,-32(a1)
ffffffffc0203448:	c385                	beqz	a5,ffffffffc0203468 <_clock_swap_out_victim+0x4c>
            page->visited=0;
ffffffffc020344a:	fe05b023          	sd	zero,-32(a1)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc020344e:	854a                	mv	a0,s2
ffffffffc0203450:	c6bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        curr_ptr=list_next(curr_ptr);
ffffffffc0203454:	601c                	ld	a5,0(s0)
    return listelm->next;
ffffffffc0203456:	678c                	ld	a1,8(a5)
ffffffffc0203458:	e00c                	sd	a1,0(s0)
        if(curr_ptr==head){curr_ptr=list_next(head);}
ffffffffc020345a:	feb495e3          	bne	s1,a1,ffffffffc0203444 <_clock_swap_out_victim+0x28>
ffffffffc020345e:	648c                	ld	a1,8(s1)
        if(page->visited==0){
ffffffffc0203460:	fe05b783          	ld	a5,-32(a1)
        if(curr_ptr==head){curr_ptr=list_next(head);}
ffffffffc0203464:	e00c                	sd	a1,0(s0)
        if(page->visited==0){
ffffffffc0203466:	f3f5                	bnez	a5,ffffffffc020344a <_clock_swap_out_victim+0x2e>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203468:	6198                	ld	a4,0(a1)
ffffffffc020346a:	659c                	ld	a5,8(a1)
        struct Page* page=le2page(curr_ptr,pra_page_link);
ffffffffc020346c:	fd058693          	addi	a3,a1,-48
            *ptr_page=page;
ffffffffc0203470:	00d9b023          	sd	a3,0(s3)
    prev->next = next;
ffffffffc0203474:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203476:	e398                	sd	a4,0(a5)
            cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203478:	00003517          	auipc	a0,0x3
ffffffffc020347c:	89850513          	addi	a0,a0,-1896 # ffffffffc0205d10 <default_pmm_manager+0xb60>
ffffffffc0203480:	c3bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203484:	70a2                	ld	ra,40(sp)
ffffffffc0203486:	7402                	ld	s0,32(sp)
ffffffffc0203488:	64e2                	ld	s1,24(sp)
ffffffffc020348a:	6942                	ld	s2,16(sp)
ffffffffc020348c:	69a2                	ld	s3,8(sp)
ffffffffc020348e:	4501                	li	a0,0
ffffffffc0203490:	6145                	addi	sp,sp,48
ffffffffc0203492:	8082                	ret
         assert(head != NULL);
ffffffffc0203494:	00003697          	auipc	a3,0x3
ffffffffc0203498:	85c68693          	addi	a3,a3,-1956 # ffffffffc0205cf0 <default_pmm_manager+0xb40>
ffffffffc020349c:	00002617          	auipc	a2,0x2
ffffffffc02034a0:	96460613          	addi	a2,a2,-1692 # ffffffffc0204e00 <commands+0x738>
ffffffffc02034a4:	04b00593          	li	a1,75
ffffffffc02034a8:	00002517          	auipc	a0,0x2
ffffffffc02034ac:	7e850513          	addi	a0,a0,2024 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02034b0:	ec5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc02034b4:	00003697          	auipc	a3,0x3
ffffffffc02034b8:	84c68693          	addi	a3,a3,-1972 # ffffffffc0205d00 <default_pmm_manager+0xb50>
ffffffffc02034bc:	00002617          	auipc	a2,0x2
ffffffffc02034c0:	94460613          	addi	a2,a2,-1724 # ffffffffc0204e00 <commands+0x738>
ffffffffc02034c4:	04c00593          	li	a1,76
ffffffffc02034c8:	00002517          	auipc	a0,0x2
ffffffffc02034cc:	7c850513          	addi	a0,a0,1992 # ffffffffc0205c90 <default_pmm_manager+0xae0>
ffffffffc02034d0:	ea5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034d4 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034d4:	0000e797          	auipc	a5,0xe
ffffffffc02034d8:	0847b783          	ld	a5,132(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc02034dc:	cf89                	beqz	a5,ffffffffc02034f6 <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02034de:	751c                	ld	a5,40(a0)
ffffffffc02034e0:	03060713          	addi	a4,a2,48
}
ffffffffc02034e4:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc02034e6:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc02034e8:	e398                	sd	a4,0(a5)
ffffffffc02034ea:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc02034ec:	fe1c                	sd	a5,56(a2)
    page->visited=1;
ffffffffc02034ee:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc02034f0:	fa14                	sd	a3,48(a2)
ffffffffc02034f2:	ea1c                	sd	a5,16(a2)
}
ffffffffc02034f4:	8082                	ret
{
ffffffffc02034f6:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034f8:	00003697          	auipc	a3,0x3
ffffffffc02034fc:	82868693          	addi	a3,a3,-2008 # ffffffffc0205d20 <default_pmm_manager+0xb70>
ffffffffc0203500:	00002617          	auipc	a2,0x2
ffffffffc0203504:	90060613          	addi	a2,a2,-1792 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203508:	03700593          	li	a1,55
ffffffffc020350c:	00002517          	auipc	a0,0x2
ffffffffc0203510:	78450513          	addi	a0,a0,1924 # ffffffffc0205c90 <default_pmm_manager+0xae0>
{
ffffffffc0203514:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203516:	e5ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020351a <check_vma_overlap.part.0>:
}
...
ffffffffc020351c:	00003697          	auipc	a3,0x3
ffffffffc0203520:	84468693          	addi	a3,a3,-1980 # ffffffffc0205d60 <default_pmm_manager+0xbb0>
ffffffffc0203524:	00002617          	auipc	a2,0x2
ffffffffc0203528:	8dc60613          	addi	a2,a2,-1828 # ffffffffc0204e00 <commands+0x738>
ffffffffc020352c:	07d00593          	li	a1,125
ffffffffc0203530:	00003517          	auipc	a0,0x3
ffffffffc0203534:	85050513          	addi	a0,a0,-1968 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203538:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020353a:	e3bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020353e <mm_create>:
mm_create(void) {
ffffffffc020353e:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203540:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203544:	e022                	sd	s0,0(sp)
ffffffffc0203546:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203548:	a30ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020354c:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020354e:	c105                	beqz	a0,ffffffffc020356e <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203550:	e408                	sd	a0,8(s0)
ffffffffc0203552:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
...
ffffffffc0203560:	0000e797          	auipc	a5,0xe
ffffffffc0203564:	ff07a783          	lw	a5,-16(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203568:	eb81                	bnez	a5,ffffffffc0203578 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc020356a:	02053423          	sd	zero,40(a0)
}
ffffffffc020356e:	60a2                	ld	ra,8(sp)
ffffffffc0203570:	8522                	mv	a0,s0
ffffffffc0203572:	6402                	ld	s0,0(sp)
ffffffffc0203574:	0141                	addi	sp,sp,16
ffffffffc0203576:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203578:	a27ff0ef          	jal	ra,ffffffffc0202f9e <swap_init_mm>
}
...
ffffffffc0203586 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203586:	1101                	addi	sp,sp,-32
ffffffffc0203588:	e04a                	sd	s2,0(sp)
ffffffffc020358a:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020358c:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203590:	e822                	sd	s0,16(sp)
ffffffffc0203592:	e426                	sd	s1,8(sp)
ffffffffc0203594:	ec06                	sd	ra,24(sp)
ffffffffc0203596:	84ae                	mv	s1,a1
ffffffffc0203598:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020359a:	9deff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc020359e:	c509                	beqz	a0,ffffffffc02035a8 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02035a0:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035a4:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035a6:	ed00                	sd	s0,24(a0)
}
ffffffffc02035a8:	60e2                	ld	ra,24(sp)
ffffffffc02035aa:	6442                	ld	s0,16(sp)
ffffffffc02035ac:	64a2                	ld	s1,8(sp)
ffffffffc02035ae:	6902                	ld	s2,0(sp)
ffffffffc02035b0:	6105                	addi	sp,sp,32
ffffffffc02035b2:	8082                	ret

ffffffffc02035b4 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc02035b4:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02035b6:	c505                	beqz	a0,ffffffffc02035de <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02035b8:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02035ba:	c501                	beqz	a0,ffffffffc02035c2 <find_vma+0xe>
ffffffffc02035bc:	651c                	ld	a5,8(a0)
ffffffffc02035be:	02f5f263          	bgeu	a1,a5,ffffffffc02035e2 <find_vma+0x2e>
    return listelm->next;
ffffffffc02035c2:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc02035c4:	00f68d63          	beq	a3,a5,ffffffffc02035de <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc02035c8:	fe87b703          	ld	a4,-24(a5)
ffffffffc02035cc:	00e5e663          	bltu	a1,a4,ffffffffc02035d8 <find_vma+0x24>
ffffffffc02035d0:	ff07b703          	ld	a4,-16(a5)
ffffffffc02035d4:	00e5ec63          	bltu	a1,a4,ffffffffc02035ec <find_vma+0x38>
ffffffffc02035d8:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02035da:	fef697e3          	bne	a3,a5,ffffffffc02035c8 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc02035de:	4501                	li	a0,0
}
ffffffffc02035e0:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02035e2:	691c                	ld	a5,16(a0)
ffffffffc02035e4:	fcf5ffe3          	bgeu	a1,a5,ffffffffc02035c2 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc02035e8:	ea88                	sd	a0,16(a3)
ffffffffc02035ea:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc02035ec:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc02035f0:	ea88                	sd	a0,16(a3)
...
ffffffffc0203604:	a085                	j	ffffffffc0203664 <insert_vma_struct+0x70>
...
ffffffffc020360a:	04e66863          	bltu	a2,a4,ffffffffc020365a <insert_vma_struct+0x66>
...
ffffffffc0203622:	08e8f163          	bgeu	a7,a4,ffffffffc02036a4 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203626:	04e66f63          	bltu	a2,a4,ffffffffc0203684 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
...
ffffffffc020362e:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203632:	05076963          	bltu	a4,a6,ffffffffc0203684 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc0203636:	ff07b603          	ld	a2,-16(a5)
ffffffffc020363a:	02c77363          	bgeu	a4,a2,ffffffffc0203660 <insert_vma_struct+0x6c>
    }
...
ffffffffc020364e:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc0203650:	0017079b          	addiw	a5,a4,1
ffffffffc0203654:	d11c                	sw	a5,32(a0)
}
ffffffffc0203656:	0141                	addi	sp,sp,16
ffffffffc0203658:	8082                	ret
    if (le_prev != list) {
ffffffffc020365a:	fca690e3          	bne	a3,a0,ffffffffc020361a <insert_vma_struct+0x26>
ffffffffc020365e:	bfd1                	j	ffffffffc0203632 <insert_vma_struct+0x3e>
ffffffffc0203660:	ebbff0ef          	jal	ra,ffffffffc020351a <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203664:	00002697          	auipc	a3,0x2
ffffffffc0203668:	72c68693          	addi	a3,a3,1836 # ffffffffc0205d90 <default_pmm_manager+0xbe0>
ffffffffc020366c:	00001617          	auipc	a2,0x1
ffffffffc0203670:	79460613          	addi	a2,a2,1940 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203674:	08400593          	li	a1,132
ffffffffc0203678:	00002517          	auipc	a0,0x2
ffffffffc020367c:	70850513          	addi	a0,a0,1800 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203680:	cf5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203684:	00002697          	auipc	a3,0x2
ffffffffc0203688:	74c68693          	addi	a3,a3,1868 # ffffffffc0205dd0 <default_pmm_manager+0xc20>
ffffffffc020368c:	00001617          	auipc	a2,0x1
ffffffffc0203690:	77460613          	addi	a2,a2,1908 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203694:	07c00593          	li	a1,124
ffffffffc0203698:	00002517          	auipc	a0,0x2
ffffffffc020369c:	6e850513          	addi	a0,a0,1768 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc02036a0:	cd5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02036a4:	00002697          	auipc	a3,0x2
ffffffffc02036a8:	70c68693          	addi	a3,a3,1804 # ffffffffc0205db0 <default_pmm_manager+0xc00>
ffffffffc02036ac:	00001617          	auipc	a2,0x1
ffffffffc02036b0:	75460613          	addi	a2,a2,1876 # ffffffffc0204e00 <commands+0x738>
ffffffffc02036b4:	07b00593          	li	a1,123
ffffffffc02036b8:	00002517          	auipc	a0,0x2
ffffffffc02036bc:	6c850513          	addi	a0,a0,1736 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc02036c0:	cb5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02036c4 <mm_destroy>:
...
ffffffffc02036ce:	00a40e63          	beq	s0,a0,ffffffffc02036ea <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02036d2:	6118                	ld	a4,0(a0)
ffffffffc02036d4:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02036d6:	03000593          	li	a1,48
ffffffffc02036da:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02036dc:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02036de:	e398                	sd	a4,0(a5)
ffffffffc02036e0:	952ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02036e4:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02036e6:	fea416e3          	bne	s0,a0,ffffffffc02036d2 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036ea:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc02036ec:	6402                	ld	s0,0(sp)
ffffffffc02036ee:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036f0:	03000593          	li	a1,48
}
ffffffffc02036f4:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036f6:	93cff06f          	j	ffffffffc0202832 <kfree>

ffffffffc02036fa <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02036fa:	715d                	addi	sp,sp,-80
ffffffffc02036fc:	e486                	sd	ra,72(sp)
ffffffffc02036fe:	f44e                	sd	s3,40(sp)
ffffffffc0203700:	f052                	sd	s4,32(sp)
ffffffffc0203702:	e0a2                	sd	s0,64(sp)
ffffffffc0203704:	fc26                	sd	s1,56(sp)
ffffffffc0203706:	f84a                	sd	s2,48(sp)
ffffffffc0203708:	ec56                	sd	s5,24(sp)
ffffffffc020370a:	e85a                	sd	s6,16(sp)
ffffffffc020370c:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203712:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203714:	f7ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203718:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020371a:	03000513          	li	a0,48
ffffffffc020371e:	85aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc0203722:	56050863          	beqz	a0,ffffffffc0203c92 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc0203726:	e508                	sd	a0,8(a0)
ffffffffc0203728:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020372a:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020372e:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203732:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203736:	0000e797          	auipc	a5,0xe
ffffffffc020373a:	e1a7a783          	lw	a5,-486(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020373e:	84aa                	mv	s1,a0
ffffffffc0203740:	e7b9                	bnez	a5,ffffffffc020378e <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203742:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203746:	03200413          	li	s0,50
ffffffffc020374a:	a811                	j	ffffffffc020375e <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc020374c:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc020374e:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203750:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203754:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203756:	8526                	mv	a0,s1
ffffffffc0203758:	e9dff0ef          	jal	ra,ffffffffc02035f4 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc020375c:	cc05                	beqz	s0,ffffffffc0203794 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020375e:	03000513          	li	a0,48
ffffffffc0203762:	816ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203766:	85aa                	mv	a1,a0
ffffffffc0203768:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc020376c:	f165                	bnez	a0,ffffffffc020374c <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc020376e:	00002697          	auipc	a3,0x2
ffffffffc0203772:	17268693          	addi	a3,a3,370 # ffffffffc02058e0 <default_pmm_manager+0x730>
ffffffffc0203776:	00001617          	auipc	a2,0x1
ffffffffc020377a:	68a60613          	addi	a2,a2,1674 # ffffffffc0204e00 <commands+0x738>
ffffffffc020377e:	0ce00593          	li	a1,206
ffffffffc0203782:	00002517          	auipc	a0,0x2
ffffffffc0203786:	5fe50513          	addi	a0,a0,1534 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc020378a:	bebfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020378e:	811ff0ef          	jal	ra,ffffffffc0202f9e <swap_init_mm>
ffffffffc0203792:	bf55                	j	ffffffffc0203746 <vmm_init+0x4c>
ffffffffc0203794:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203798:	1f900913          	li	s2,505
ffffffffc020379c:	a819                	j	ffffffffc02037b2 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc020379e:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02037a0:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02037a2:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037a6:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02037a8:	8526                	mv	a0,s1
ffffffffc02037aa:	e4bff0ef          	jal	ra,ffffffffc02035f4 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02037ae:	03240a63          	beq	s0,s2,ffffffffc02037e2 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037b2:	03000513          	li	a0,48
ffffffffc02037b6:	fc3fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02037ba:	85aa                	mv	a1,a0
ffffffffc02037bc:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037c0:	fd79                	bnez	a0,ffffffffc020379e <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02037c2:	00002697          	auipc	a3,0x2
ffffffffc02037c6:	11e68693          	addi	a3,a3,286 # ffffffffc02058e0 <default_pmm_manager+0x730>
ffffffffc02037ca:	00001617          	auipc	a2,0x1
ffffffffc02037ce:	63660613          	addi	a2,a2,1590 # ffffffffc0204e00 <commands+0x738>
ffffffffc02037d2:	0d400593          	li	a1,212
ffffffffc02037d6:	00002517          	auipc	a0,0x2
ffffffffc02037da:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc02037de:	b97fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc02037e2:	649c                	ld	a5,8(s1)
ffffffffc02037e4:	471d                	li	a4,7
    ...
    for (i = 1; i <= step2; i ++) {
ffffffffc02037e6:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc02037ea:	2ef48463          	beq	s1,a5,ffffffffc0203ad2 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02037ee:	fe87b603          	ld	a2,-24(a5)
ffffffffc02037f2:	ffe70693          	addi	a3,a4,-2
ffffffffc02037f6:	26d61e63          	bne	a2,a3,ffffffffc0203a72 <vmm_init+0x378>
ffffffffc02037fa:	ff07b683          	ld	a3,-16(a5)
ffffffffc02037fe:	26e69a63          	bne	a3,a4,ffffffffc0203a72 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203802:	0715                	addi	a4,a4,5
ffffffffc0203804:	679c                	ld	a5,8(a5)
ffffffffc0203806:	feb712e3          	bne	a4,a1,ffffffffc02037ea <vmm_init+0xf0>
ffffffffc020380a:	4b1d                	li	s6,7
ffffffffc020380c:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020380e:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203812:	85a2                	mv	a1,s0
ffffffffc0203814:	8526                	mv	a0,s1
ffffffffc0203816:	d9fff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
ffffffffc020381a:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc020381c:	2c050b63          	beqz	a0,ffffffffc0203af2 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203820:	00140593          	addi	a1,s0,1
ffffffffc0203824:	8526                	mv	a0,s1
ffffffffc0203826:	d8fff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
ffffffffc020382a:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc020382c:	2e050363          	beqz	a0,ffffffffc0203b12 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203830:	85da                	mv	a1,s6
ffffffffc0203832:	8526                	mv	a0,s1
ffffffffc0203834:	d81ff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203838:	2e051d63          	bnez	a0,ffffffffc0203b32 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc020383c:	00340593          	addi	a1,s0,3
ffffffffc0203840:	8526                	mv	a0,s1
ffffffffc0203842:	d73ff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203846:	30051663          	bnez	a0,ffffffffc0203b52 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc020384a:	00440593          	addi	a1,s0,4
ffffffffc020384e:	8526                	mv	a0,s1
ffffffffc0203850:	d65ff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203854:	30051f63          	bnez	a0,ffffffffc0203b72 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203858:	00893783          	ld	a5,8(s2)
ffffffffc020385c:	24879b63          	bne	a5,s0,ffffffffc0203ab2 <vmm_init+0x3b8>
ffffffffc0203860:	01093783          	ld	a5,16(s2)
ffffffffc0203864:	25679763          	bne	a5,s6,ffffffffc0203ab2 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203868:	008ab783          	ld	a5,8(s5)
ffffffffc020386c:	22879363          	bne	a5,s0,ffffffffc0203a92 <vmm_init+0x398>
ffffffffc0203870:	010ab783          	ld	a5,16(s5)
ffffffffc0203874:	21679f63          	bne	a5,s6,ffffffffc0203a92 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203878:	0415                	addi	s0,s0,5
ffffffffc020387a:	0b15                	addi	s6,s6,5
ffffffffc020387c:	f9741be3          	bne	s0,s7,ffffffffc0203812 <vmm_init+0x118>
ffffffffc0203880:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203882:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203884:	85a2                	mv	a1,s0
ffffffffc0203886:	8526                	mv	a0,s1
ffffffffc0203888:	d2dff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
ffffffffc020388c:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203890:	c90d                	beqz	a0,ffffffffc02038c2 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203892:	6914                	ld	a3,16(a0)
ffffffffc0203894:	6510                	ld	a2,8(a0)
ffffffffc0203896:	00002517          	auipc	a0,0x2
ffffffffc020389a:	65a50513          	addi	a0,a0,1626 # ffffffffc0205ef0 <default_pmm_manager+0xd40>
ffffffffc020389e:	81dfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02038a2:	00002697          	auipc	a3,0x2
ffffffffc02038a6:	67668693          	addi	a3,a3,1654 # ffffffffc0205f18 <default_pmm_manager+0xd68>
ffffffffc02038aa:	00001617          	auipc	a2,0x1
ffffffffc02038ae:	55660613          	addi	a2,a2,1366 # ffffffffc0204e00 <commands+0x738>
ffffffffc02038b2:	0f600593          	li	a1,246
ffffffffc02038b6:	00002517          	auipc	a0,0x2
ffffffffc02038ba:	4ca50513          	addi	a0,a0,1226 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc02038be:	ab7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02038c2:	147d                	addi	s0,s0,-1
ffffffffc02038c4:	fd2410e3          	bne	s0,s2,ffffffffc0203884 <vmm_init+0x18a>
ffffffffc02038c8:	a811                	j	ffffffffc02038dc <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc02038ca:	6118                	ld	a4,0(a0)
ffffffffc02038cc:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02038ce:	03000593          	li	a1,48
ffffffffc02038d2:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02038d4:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02038d6:	e398                	sd	a4,0(a5)
ffffffffc02038d8:	f5bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02038dc:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc02038de:	fea496e3          	bne	s1,a0,ffffffffc02038ca <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02038e2:	03000593          	li	a1,48
ffffffffc02038e6:	8526                	mv	a0,s1
ffffffffc02038e8:	f4bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02038ec:	da7fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02038f0:	3caa1163          	bne	s4,a0,ffffffffc0203cb2 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc02038f4:	00002517          	auipc	a0,0x2
ffffffffc02038f8:	66450513          	addi	a0,a0,1636 # ffffffffc0205f58 <default_pmm_manager+0xda8>
ffffffffc02038fc:	fbefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203900:	d93fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203904:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203906:	03000513          	li	a0,48
ffffffffc020390a:	e6ffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020390e:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203910:	2a050163          	beqz	a0,ffffffffc0203bb2 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203914:	0000e797          	auipc	a5,0xe
ffffffffc0203918:	c3c7a783          	lw	a5,-964(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
...
ffffffffc0203928:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020392c:	14079063          	bnez	a5,ffffffffc0203a6c <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203930:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203934:	0000e917          	auipc	s2,0xe
ffffffffc0203938:	be493903          	ld	s2,-1052(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc020393c:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203940:	0000e717          	auipc	a4,0xe
ffffffffc0203944:	c2873023          	sd	s0,-992(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203948:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc020394c:	24079363          	bnez	a5,ffffffffc0203b92 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203950:	03000513          	li	a0,48
ffffffffc0203954:	e25fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203958:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc020395a:	28050063          	beqz	a0,ffffffffc0203bda <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc020395e:	002007b7          	lui	a5,0x200
ffffffffc0203962:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
...
ffffffffc0203968:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc020396a:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc020396e:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203970:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203974:	c81ff0ef          	jal	ra,ffffffffc02035f4 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203978:	10000593          	li	a1,256
ffffffffc020397c:	8522                	mv	a0,s0
ffffffffc020397e:	c37ff0ef          	jal	ra,ffffffffc02035b4 <find_vma>
ffffffffc0203982:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203986:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc020398a:	26aa1863          	bne	s4,a0,ffffffffc0203bfa <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc020398e:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203992:	0785                	addi	a5,a5,1
ffffffffc0203994:	fee79de3          	bne	a5,a4,ffffffffc020398e <vmm_init+0x294>
        sum += i;
ffffffffc0203998:	6705                	lui	a4,0x1
ffffffffc020399a:	10000793          	li	a5,256
ffffffffc020399e:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02039a2:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02039a6:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02039aa:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02039ac:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02039ae:	fec79ce3          	bne	a5,a2,ffffffffc02039a6 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02039b2:	26071463          	bnez	a4,ffffffffc0203c1a <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02039b6:	4581                	li	a1,0
ffffffffc02039b8:	854a                	mv	a0,s2
ffffffffc02039ba:	f63fd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039be:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02039c2:	0000e717          	auipc	a4,0xe
ffffffffc02039c6:	b5e73703          	ld	a4,-1186(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039ca:	078a                	slli	a5,a5,0x2
ffffffffc02039cc:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02039ce:	26e7f663          	bgeu	a5,a4,ffffffffc0203c3a <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02039d2:	00003717          	auipc	a4,0x3
ffffffffc02039d6:	94e73703          	ld	a4,-1714(a4) # ffffffffc0206320 <nbase>
ffffffffc02039da:	8f99                	sub	a5,a5,a4
ffffffffc02039dc:	00379713          	slli	a4,a5,0x3
ffffffffc02039e0:	97ba                	add	a5,a5,a4
ffffffffc02039e2:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc02039e4:	0000e517          	auipc	a0,0xe
ffffffffc02039e8:	b4453503          	ld	a0,-1212(a0) # ffffffffc0211528 <pages>
ffffffffc02039ec:	953e                	add	a0,a0,a5
ffffffffc02039ee:	4585                	li	a1,1
ffffffffc02039f0:	c63fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc02039f4:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc02039f6:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc02039fa:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039fe:	00a40e63          	beq	s0,a0,ffffffffc0203a1a <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a02:	6118                	ld	a4,0(a0)
ffffffffc0203a04:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203a06:	03000593          	li	a1,48
ffffffffc0203a0a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a0c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a0e:	e398                	sd	a4,0(a5)
ffffffffc0203a10:	e23fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203a14:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a16:	fea416e3          	bne	s0,a0,ffffffffc0203a02 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a1a:	03000593          	li	a1,48
ffffffffc0203a1e:	8522                	mv	a0,s0
ffffffffc0203a20:	e13fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203a24:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a26:	0000e797          	auipc	a5,0xe
ffffffffc0203a2a:	b207bd23          	sd	zero,-1222(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a2e:	c65fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a32:	22a49063          	bne	s1,a0,ffffffffc0203c52 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a36:	00002517          	auipc	a0,0x2
ffffffffc0203a3a:	57250513          	addi	a0,a0,1394 # ffffffffc0205fa8 <default_pmm_manager+0xdf8>
ffffffffc0203a3e:	e7cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a42:	c51fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a46:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a48:	22a99563          	bne	s3,a0,ffffffffc0203c72 <vmm_init+0x578>
}
ffffffffc0203a4c:	6406                	ld	s0,64(sp)
ffffffffc0203a4e:	60a6                	ld	ra,72(sp)
ffffffffc0203a50:	74e2                	ld	s1,56(sp)
ffffffffc0203a52:	7942                	ld	s2,48(sp)
ffffffffc0203a54:	79a2                	ld	s3,40(sp)
ffffffffc0203a56:	7a02                	ld	s4,32(sp)
ffffffffc0203a58:	6ae2                	ld	s5,24(sp)
ffffffffc0203a5a:	6b42                	ld	s6,16(sp)
ffffffffc0203a5c:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a5e:	00002517          	auipc	a0,0x2
ffffffffc0203a62:	56a50513          	addi	a0,a0,1386 # ffffffffc0205fc8 <default_pmm_manager+0xe18>
}
ffffffffc0203a66:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a68:	e52fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a6c:	d32ff0ef          	jal	ra,ffffffffc0202f9e <swap_init_mm>
ffffffffc0203a70:	b5d1                	j	ffffffffc0203934 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a72:	00002697          	auipc	a3,0x2
ffffffffc0203a76:	39668693          	addi	a3,a3,918 # ffffffffc0205e08 <default_pmm_manager+0xc58>
ffffffffc0203a7a:	00001617          	auipc	a2,0x1
ffffffffc0203a7e:	38660613          	addi	a2,a2,902 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203a82:	0dd00593          	li	a1,221
ffffffffc0203a86:	00002517          	auipc	a0,0x2
ffffffffc0203a8a:	2fa50513          	addi	a0,a0,762 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203a8e:	8e7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a92:	00002697          	auipc	a3,0x2
ffffffffc0203a96:	42e68693          	addi	a3,a3,1070 # ffffffffc0205ec0 <default_pmm_manager+0xd10>
ffffffffc0203a9a:	00001617          	auipc	a2,0x1
ffffffffc0203a9e:	36660613          	addi	a2,a2,870 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203aa2:	0ee00593          	li	a1,238
ffffffffc0203aa6:	00002517          	auipc	a0,0x2
ffffffffc0203aaa:	2da50513          	addi	a0,a0,730 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203aae:	8c7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203ab2:	00002697          	auipc	a3,0x2
ffffffffc0203ab6:	3de68693          	addi	a3,a3,990 # ffffffffc0205e90 <default_pmm_manager+0xce0>
ffffffffc0203aba:	00001617          	auipc	a2,0x1
ffffffffc0203abe:	34660613          	addi	a2,a2,838 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203ac2:	0ed00593          	li	a1,237
ffffffffc0203ac6:	00002517          	auipc	a0,0x2
ffffffffc0203aca:	2ba50513          	addi	a0,a0,698 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203ace:	8a7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203ad2:	00002697          	auipc	a3,0x2
ffffffffc0203ad6:	31e68693          	addi	a3,a3,798 # ffffffffc0205df0 <default_pmm_manager+0xc40>
ffffffffc0203ada:	00001617          	auipc	a2,0x1
ffffffffc0203ade:	32660613          	addi	a2,a2,806 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203ae2:	0db00593          	li	a1,219
ffffffffc0203ae6:	00002517          	auipc	a0,0x2
ffffffffc0203aea:	29a50513          	addi	a0,a0,666 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203aee:	887fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203af2:	00002697          	auipc	a3,0x2
ffffffffc0203af6:	34e68693          	addi	a3,a3,846 # ffffffffc0205e40 <default_pmm_manager+0xc90>
ffffffffc0203afa:	00001617          	auipc	a2,0x1
ffffffffc0203afe:	30660613          	addi	a2,a2,774 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203b02:	0e300593          	li	a1,227
ffffffffc0203b06:	00002517          	auipc	a0,0x2
ffffffffc0203b0a:	27a50513          	addi	a0,a0,634 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203b0e:	867fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203b12:	00002697          	auipc	a3,0x2
ffffffffc0203b16:	33e68693          	addi	a3,a3,830 # ffffffffc0205e50 <default_pmm_manager+0xca0>
ffffffffc0203b1a:	00001617          	auipc	a2,0x1
ffffffffc0203b1e:	2e660613          	addi	a2,a2,742 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203b22:	0e500593          	li	a1,229
ffffffffc0203b26:	00002517          	auipc	a0,0x2
ffffffffc0203b2a:	25a50513          	addi	a0,a0,602 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203b2e:	847fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b32:	00002697          	auipc	a3,0x2
ffffffffc0203b36:	32e68693          	addi	a3,a3,814 # ffffffffc0205e60 <default_pmm_manager+0xcb0>
ffffffffc0203b3a:	00001617          	auipc	a2,0x1
ffffffffc0203b3e:	2c660613          	addi	a2,a2,710 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203b42:	0e700593          	li	a1,231
ffffffffc0203b46:	00002517          	auipc	a0,0x2
ffffffffc0203b4a:	23a50513          	addi	a0,a0,570 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203b4e:	827fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b52:	00002697          	auipc	a3,0x2
ffffffffc0203b56:	31e68693          	addi	a3,a3,798 # ffffffffc0205e70 <default_pmm_manager+0xcc0>
ffffffffc0203b5a:	00001617          	auipc	a2,0x1
ffffffffc0203b5e:	2a660613          	addi	a2,a2,678 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203b62:	0e900593          	li	a1,233
ffffffffc0203b66:	00002517          	auipc	a0,0x2
ffffffffc0203b6a:	21a50513          	addi	a0,a0,538 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203b6e:	807fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b72:	00002697          	auipc	a3,0x2
ffffffffc0203b76:	30e68693          	addi	a3,a3,782 # ffffffffc0205e80 <default_pmm_manager+0xcd0>
ffffffffc0203b7a:	00001617          	auipc	a2,0x1
ffffffffc0203b7e:	28660613          	addi	a2,a2,646 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203b82:	0eb00593          	li	a1,235
ffffffffc0203b86:	00002517          	auipc	a0,0x2
ffffffffc0203b8a:	1fa50513          	addi	a0,a0,506 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203b8e:	fe6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b92:	00002697          	auipc	a3,0x2
ffffffffc0203b96:	d3e68693          	addi	a3,a3,-706 # ffffffffc02058d0 <default_pmm_manager+0x720>
ffffffffc0203b9a:	00001617          	auipc	a2,0x1
ffffffffc0203b9e:	26660613          	addi	a2,a2,614 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203ba2:	10d00593          	li	a1,269
ffffffffc0203ba6:	00002517          	auipc	a0,0x2
ffffffffc0203baa:	1da50513          	addi	a0,a0,474 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203bae:	fc6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203bb2:	00002697          	auipc	a3,0x2
ffffffffc0203bb6:	42e68693          	addi	a3,a3,1070 # ffffffffc0205fe0 <default_pmm_manager+0xe30>
ffffffffc0203bba:	00001617          	auipc	a2,0x1
ffffffffc0203bbe:	24660613          	addi	a2,a2,582 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203bc2:	10a00593          	li	a1,266
ffffffffc0203bc6:	00002517          	auipc	a0,0x2
ffffffffc0203bca:	1ba50513          	addi	a0,a0,442 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
    check_mm_struct = mm_create();
ffffffffc0203bce:	0000e797          	auipc	a5,0xe
ffffffffc0203bd2:	9807b923          	sd	zero,-1646(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203bd6:	f9efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203bda:	00002697          	auipc	a3,0x2
ffffffffc0203bde:	d0668693          	addi	a3,a3,-762 # ffffffffc02058e0 <default_pmm_manager+0x730>
ffffffffc0203be2:	00001617          	auipc	a2,0x1
ffffffffc0203be6:	21e60613          	addi	a2,a2,542 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203bea:	11100593          	li	a1,273
ffffffffc0203bee:	00002517          	auipc	a0,0x2
ffffffffc0203bf2:	19250513          	addi	a0,a0,402 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203bf6:	f7efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203bfa:	00002697          	auipc	a3,0x2
ffffffffc0203bfe:	37e68693          	addi	a3,a3,894 # ffffffffc0205f78 <default_pmm_manager+0xdc8>
ffffffffc0203c02:	00001617          	auipc	a2,0x1
ffffffffc0203c06:	1fe60613          	addi	a2,a2,510 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203c0a:	11600593          	li	a1,278
ffffffffc0203c0e:	00002517          	auipc	a0,0x2
ffffffffc0203c12:	17250513          	addi	a0,a0,370 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203c16:	f5efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c1a:	00002697          	auipc	a3,0x2
ffffffffc0203c1e:	37e68693          	addi	a3,a3,894 # ffffffffc0205f98 <default_pmm_manager+0xde8>
ffffffffc0203c22:	00001617          	auipc	a2,0x1
ffffffffc0203c26:	1de60613          	addi	a2,a2,478 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203c2a:	12000593          	li	a1,288
ffffffffc0203c2e:	00002517          	auipc	a0,0x2
ffffffffc0203c32:	15250513          	addi	a0,a0,338 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203c36:	f3efc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c3a:	00001617          	auipc	a2,0x1
ffffffffc0203c3e:	5ae60613          	addi	a2,a2,1454 # ffffffffc02051e8 <default_pmm_manager+0x38>
ffffffffc0203c42:	06500593          	li	a1,101
ffffffffc0203c46:	00001517          	auipc	a0,0x1
ffffffffc0203c4a:	5c250513          	addi	a0,a0,1474 # ffffffffc0205208 <default_pmm_manager+0x58>
ffffffffc0203c4e:	f26fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c52:	00002697          	auipc	a3,0x2
ffffffffc0203c56:	2de68693          	addi	a3,a3,734 # ffffffffc0205f30 <default_pmm_manager+0xd80>
ffffffffc0203c5a:	00001617          	auipc	a2,0x1
ffffffffc0203c5e:	1a660613          	addi	a2,a2,422 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203c62:	12e00593          	li	a1,302
ffffffffc0203c66:	00002517          	auipc	a0,0x2
ffffffffc0203c6a:	11a50513          	addi	a0,a0,282 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203c6e:	f06fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c72:	00002697          	auipc	a3,0x2
ffffffffc0203c76:	2be68693          	addi	a3,a3,702 # ffffffffc0205f30 <default_pmm_manager+0xd80>
ffffffffc0203c7a:	00001617          	auipc	a2,0x1
ffffffffc0203c7e:	18660613          	addi	a2,a2,390 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203c82:	0bd00593          	li	a1,189
ffffffffc0203c86:	00002517          	auipc	a0,0x2
ffffffffc0203c8a:	0fa50513          	addi	a0,a0,250 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203c8e:	ee6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c92:	00002697          	auipc	a3,0x2
ffffffffc0203c96:	c1668693          	addi	a3,a3,-1002 # ffffffffc02058a8 <default_pmm_manager+0x6f8>
ffffffffc0203c9a:	00001617          	auipc	a2,0x1
ffffffffc0203c9e:	16660613          	addi	a2,a2,358 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203ca2:	0c700593          	li	a1,199
ffffffffc0203ca6:	00002517          	auipc	a0,0x2
ffffffffc0203caa:	0da50513          	addi	a0,a0,218 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203cae:	ec6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203cb2:	00002697          	auipc	a3,0x2
ffffffffc0203cb6:	27e68693          	addi	a3,a3,638 # ffffffffc0205f30 <default_pmm_manager+0xd80>
ffffffffc0203cba:	00001617          	auipc	a2,0x1
ffffffffc0203cbe:	14660613          	addi	a2,a2,326 # ffffffffc0204e00 <commands+0x738>
ffffffffc0203cc2:	0fb00593          	li	a1,251
ffffffffc0203cc6:	00002517          	auipc	a0,0x2
ffffffffc0203cca:	0ba50513          	addi	a0,a0,186 # ffffffffc0205d80 <default_pmm_manager+0xbd0>
ffffffffc0203cce:	ea6fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203cd2 <do_pgfault>:
...
ffffffffc0203cd2:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203cd4:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203cd6:	f822                	sd	s0,48(sp)
ffffffffc0203cd8:	f426                	sd	s1,40(sp)
ffffffffc0203cda:	fc06                	sd	ra,56(sp)
ffffffffc0203cdc:	f04a                	sd	s2,32(sp)
ffffffffc0203cde:	ec4e                	sd	s3,24(sp)
ffffffffc0203ce0:	8432                	mv	s0,a2
ffffffffc0203ce2:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203ce4:	8d1ff0ef          	jal	ra,ffffffffc02035b4 <find_vma>

    pgfault_num++;
ffffffffc0203ce8:	0000e797          	auipc	a5,0xe
ffffffffc0203cec:	8807a783          	lw	a5,-1920(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203cf0:	2785                	addiw	a5,a5,1
ffffffffc0203cf2:	0000e717          	auipc	a4,0xe
ffffffffc0203cf6:	86f72b23          	sw	a5,-1930(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203cfa:	cd49                	beqz	a0,ffffffffc0203d94 <do_pgfault+0xc2>
ffffffffc0203cfc:	651c                	ld	a5,8(a0)
ffffffffc0203cfe:	08f46b63          	bltu	s0,a5,ffffffffc0203d94 <do_pgfault+0xc2>
...
ffffffffc0203d02:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203d04:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203d06:	8b89                	andi	a5,a5,2
ffffffffc0203d08:	ef9d                	bnez	a5,ffffffffc0203d46 <do_pgfault+0x74>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d0a:	75fd                	lui	a1,0xfffff
...
ffffffffc0203d0c:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203d0e:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203d10:	85a2                	mv	a1,s0
ffffffffc0203d12:	4605                	li	a2,1
ffffffffc0203d14:	9b9fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203d18:	610c                	ld	a1,0(a0)
ffffffffc0203d1a:	cdb1                	beqz	a1,ffffffffc0203d76 <do_pgfault+0xa4>
...
ffffffffc0203d20:	8347a783          	lw	a5,-1996(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d24:	c3c9                	beqz	a5,ffffffffc0203da6 <do_pgfault+0xd4>
...
ffffffffc0203d26:	0030                	addi	a2,sp,8
ffffffffc0203d28:	85a2                	mv	a1,s0
ffffffffc0203d2a:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d2c:	e402                	sd	zero,8(sp)
            ret=swap_in(mm,addr,&page);
ffffffffc0203d2e:	bc6ff0ef          	jal	ra,ffffffffc02030f4 <swap_in>
ffffffffc0203d32:	892a                	mv	s2,a0
            if(ret !=0) {
ffffffffc0203d34:	c919                	beqz	a0,ffffffffc0203d4a <do_pgfault+0x78>
   }
...
ffffffffc0203d38:	7442                	ld	s0,48(sp)
ffffffffc0203d3a:	74a2                	ld	s1,40(sp)
ffffffffc0203d3c:	69e2                	ld	s3,24(sp)
ffffffffc0203d3e:	854a                	mv	a0,s2
ffffffffc0203d40:	7902                	ld	s2,32(sp)
ffffffffc0203d42:	6121                	addi	sp,sp,64
ffffffffc0203d44:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d46:	49d9                	li	s3,22
ffffffffc0203d48:	b7c9                	j	ffffffffc0203d0a <do_pgfault+0x38>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203d4a:	65a2                	ld	a1,8(sp)
ffffffffc0203d4c:	6c88                	ld	a0,24(s1)
ffffffffc0203d4e:	86ce                	mv	a3,s3
ffffffffc0203d50:	8622                	mv	a2,s0
ffffffffc0203d52:	c65fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203d56:	6622                	ld	a2,8(sp)
ffffffffc0203d58:	85a2                	mv	a1,s0
ffffffffc0203d5a:	8526                	mv	a0,s1
ffffffffc0203d5c:	4685                	li	a3,1
ffffffffc0203d5e:	a4cff0ef          	jal	ra,ffffffffc0202faa <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203d62:	67a2                	ld	a5,8(sp)
}
ffffffffc0203d64:	70e2                	ld	ra,56(sp)
ffffffffc0203d66:	74a2                	ld	s1,40(sp)
            page->pra_vaddr = addr;
ffffffffc0203d68:	e3a0                	sd	s0,64(a5)
}
ffffffffc0203d6a:	7442                	ld	s0,48(sp)
ffffffffc0203d6c:	69e2                	ld	s3,24(sp)
ffffffffc0203d6e:	854a                	mv	a0,s2
ffffffffc0203d70:	7902                	ld	s2,32(sp)
...
ffffffffc0203d7c:	945fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203d80:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d82:	f955                	bnez	a0,ffffffffc0203d36 <do_pgfault+0x64>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d84:	00002517          	auipc	a0,0x2
ffffffffc0203d88:	2a450513          	addi	a0,a0,676 # ffffffffc0206028 <default_pmm_manager+0xe78>
ffffffffc0203d8c:	b2efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d90:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d92:	b755                	j	ffffffffc0203d36 <do_pgfault+0x64>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d94:	85a2                	mv	a1,s0
ffffffffc0203d96:	00002517          	auipc	a0,0x2
ffffffffc0203d9a:	26250513          	addi	a0,a0,610 # ffffffffc0205ff8 <default_pmm_manager+0xe48>
ffffffffc0203d9e:	b1cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203da2:	5975                	li	s2,-3
        goto failed;
ffffffffc0203da4:	bf49                	j	ffffffffc0203d36 <do_pgfault+0x64>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203da6:	00002517          	auipc	a0,0x2
ffffffffc0203daa:	2aa50513          	addi	a0,a0,682 # ffffffffc0206050 <default_pmm_manager+0xea0>
ffffffffc0203dae:	b0cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203db2:	5971                	li	s2,-4
            goto failed;
ffffffffc0203db4:	b749                	j	ffffffffc0203d36 <do_pgfault+0x64>
...
ffffffffc0203ddc:	2a060613          	addi	a2,a2,672 # ffffffffc0206078 <default_pmm_manager+0xec8>
ffffffffc0203de0:	45b5                	li	a1,13
ffffffffc0203de2:	00002517          	auipc	a0,0x2
ffffffffc0203de6:	2b650513          	addi	a0,a0,694 # ffffffffc0206098 <default_pmm_manager+0xee8>
...
ffffffffc0203e16:	5065b583          	ld	a1,1286(a1) # ffffffffc0206318 <error_string+0x38>
ffffffffc0203e1a:	02b60633          	mul	a2,a2,a1
ffffffffc0203e1e:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e22:	00002797          	auipc	a5,0x2
ffffffffc0203e26:	4fe7b783          	ld	a5,1278(a5) # ffffffffc0206320 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203e5c:	25860613          	addi	a2,a2,600 # ffffffffc02060b0 <default_pmm_manager+0xf00>
ffffffffc0203e60:	45d1                	li	a1,20
ffffffffc0203e62:	00002517          	auipc	a0,0x2
ffffffffc0203e66:	23650513          	addi	a0,a0,566 # ffffffffc0206098 <default_pmm_manager+0xee8>
...
ffffffffc0203eb0:	46c5b583          	ld	a1,1132(a1) # ffffffffc0206318 <error_string+0x38>
ffffffffc0203eb4:	02b60633          	mul	a2,a2,a1
ffffffffc0203eb8:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203ebc:	00002797          	auipc	a5,0x2
ffffffffc0203ec0:	4647b783          	ld	a5,1124(a5) # ffffffffc0206320 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203ef6:	1be60613          	addi	a2,a2,446 # ffffffffc02060b0 <default_pmm_manager+0xf00>
ffffffffc0203efa:	45e5                	li	a1,25
ffffffffc0203efc:	00002517          	auipc	a0,0x2
ffffffffc0203f00:	19c50513          	addi	a0,a0,412 # ffffffffc0206098 <default_pmm_manager+0xee8>
...
ffffffffc0203f60:	17478793          	addi	a5,a5,372 # ffffffffc02060d0 <default_pmm_manager+0xf20>
...
ffffffffc0203fbc:	14ca8a93          	addi	s5,s5,332 # ffffffffc0206104 <default_pmm_manager+0xf54>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fc4:	320b8b93          	addi	s7,s7,800 # ffffffffc02062e0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fc8:	000d4503          	lbu	a0,0(s10)
...
ffffffffc020421a:	eea60613          	addi	a2,a2,-278 # ffffffffc0206100 <default_pmm_manager+0xf50>
...
ffffffffc020422c:	ec860613          	addi	a2,a2,-312 # ffffffffc02060f0 <default_pmm_manager+0xf40>
...
ffffffffc020423e:	eae40413          	addi	s0,s0,-338 # ffffffffc02060e8 <default_pmm_manager+0xf38>
...
ffffffffc02042c8:	e2440413          	addi	s0,s0,-476 # ffffffffc02060e8 <default_pmm_manager+0xf38>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc02042de:	e0fa0a13          	addi	s4,s4,-497 # ffffffffc02060e9 <default_pmm_manager+0xf39>
...
ffffffffc020432a:	dda50513          	addi	a0,a0,-550 # ffffffffc0206100 <default_pmm_manager+0xf50>
