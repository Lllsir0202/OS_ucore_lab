...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6a7040ef          	jal	ra,ffffffffc0204ef0 <memset>
...
ffffffffc0200056:	eee58593          	addi	a1,a1,-274 # ffffffffc0204f40 <etext+0x2>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	f0650513          	addi	a0,a0,-250 # ffffffffc0204f60 <etext+0x22>
...
ffffffffc020007a:	65c040ef          	jal	ra,ffffffffc02046d6 <proc_init>
...
ffffffffc020008e:	097040ef          	jal	ra,ffffffffc0204924 <cpu_idle>
...
ffffffffc02000ac:	ec050513          	addi	a0,a0,-320 # ffffffffc0204f68 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	17f040ef          	jal	ra,ffffffffc0204af2 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	149040ef          	jal	ra,ffffffffc0204af2 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	da650513          	addi	a0,a0,-602 # ffffffffc0204f70 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc02001e4:	db050513          	addi	a0,a0,-592 # ffffffffc0204f90 <etext+0x52>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d5258593          	addi	a1,a1,-686 # ffffffffc0204f3e <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	dbc50513          	addi	a0,a0,-580 # ffffffffc0204fb0 <etext+0x72>
...
ffffffffc020020c:	dc850513          	addi	a0,a0,-568 # ffffffffc0204fd0 <etext+0x92>
...
ffffffffc0200220:	dd450513          	addi	a0,a0,-556 # ffffffffc0204ff0 <etext+0xb2>
...
ffffffffc020024e:	dc650513          	addi	a0,a0,-570 # ffffffffc0205010 <etext+0xd2>
}
...
ffffffffc020025c:	de860613          	addi	a2,a2,-536 # ffffffffc0205040 <etext+0x102>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	df450513          	addi	a0,a0,-524 # ffffffffc0205058 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc0200278:	dfc60613          	addi	a2,a2,-516 # ffffffffc0205070 <etext+0x132>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e1458593          	addi	a1,a1,-492 # ffffffffc0205090 <etext+0x152>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e1450513          	addi	a0,a0,-492 # ffffffffc0205098 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e1660613          	addi	a2,a2,-490 # ffffffffc02050a8 <etext+0x16a>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e3658593          	addi	a1,a1,-458 # ffffffffc02050d0 <etext+0x192>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	df650513          	addi	a0,a0,-522 # ffffffffc0205098 <etext+0x15a>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e3260613          	addi	a2,a2,-462 # ffffffffc02050e0 <etext+0x1a2>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e4a58593          	addi	a1,a1,-438 # ffffffffc0205100 <etext+0x1c2>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dda50513          	addi	a0,a0,-550 # ffffffffc0205098 <etext+0x15a>
...
ffffffffc02002fc:	e1850513          	addi	a0,a0,-488 # ffffffffc0205110 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e1e50513          	addi	a0,a0,-482 # ffffffffc0205138 <etext+0x1fa>
...
ffffffffc0200340:	e6cc0c13          	addi	s8,s8,-404 # ffffffffc02051a8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	e1c90913          	addi	s2,s2,-484 # ffffffffc0205160 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e1c48493          	addi	s1,s1,-484 # ffffffffc0205168 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e1ab0b13          	addi	s6,s6,-486 # ffffffffc0205170 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d32a0a13          	addi	s4,s4,-718 # ffffffffc0205090 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	e28d0d13          	addi	s10,s10,-472 # ffffffffc02051a8 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	32f040ef          	jal	ra,ffffffffc0204ebc <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	31b040ef          	jal	ra,ffffffffc0204ebc <strcmp>
...
ffffffffc02003e0:	2fb040ef          	jal	ra,ffffffffc0204eda <strchr>
...
ffffffffc020041e:	2bd040ef          	jal	ra,ffffffffc0204eda <strchr>
...
ffffffffc020043c:	d5850513          	addi	a0,a0,-680 # ffffffffc0205190 <etext+0x252>
...
ffffffffc0200478:	d7c50513          	addi	a0,a0,-644 # ffffffffc02051f0 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	cd650513          	addi	a0,a0,-810 # ffffffffc0206160 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	d4850513          	addi	a0,a0,-696 # ffffffffc0205210 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	177040ef          	jal	ra,ffffffffc0204f02 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	153040ef          	jal	ra,ffffffffc0204f02 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	c3650513          	addi	a0,a0,-970 # ffffffffc0205230 <commands+0x88>
...
ffffffffc0200626:	c2e60613          	addi	a2,a2,-978 # ffffffffc0205250 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205268 <commands+0xc0>
...
ffffffffc0200660:	c2450513          	addi	a0,a0,-988 # ffffffffc0205280 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	c2c50513          	addi	a0,a0,-980 # ffffffffc0205298 <commands+0xf0>
...
ffffffffc020067e:	c3650513          	addi	a0,a0,-970 # ffffffffc02052b0 <commands+0x108>
...
ffffffffc020068c:	c4050513          	addi	a0,a0,-960 # ffffffffc02052c8 <commands+0x120>
...
ffffffffc020069a:	c4a50513          	addi	a0,a0,-950 # ffffffffc02052e0 <commands+0x138>
...
ffffffffc02006a8:	c5450513          	addi	a0,a0,-940 # ffffffffc02052f8 <commands+0x150>
...
ffffffffc02006b6:	c5e50513          	addi	a0,a0,-930 # ffffffffc0205310 <commands+0x168>
...
ffffffffc02006c4:	c6850513          	addi	a0,a0,-920 # ffffffffc0205328 <commands+0x180>
...
ffffffffc02006d2:	c7250513          	addi	a0,a0,-910 # ffffffffc0205340 <commands+0x198>
...
ffffffffc02006e0:	c7c50513          	addi	a0,a0,-900 # ffffffffc0205358 <commands+0x1b0>
...
ffffffffc02006ee:	c8650513          	addi	a0,a0,-890 # ffffffffc0205370 <commands+0x1c8>
...
ffffffffc02006fc:	c9050513          	addi	a0,a0,-880 # ffffffffc0205388 <commands+0x1e0>
...
ffffffffc020070a:	c9a50513          	addi	a0,a0,-870 # ffffffffc02053a0 <commands+0x1f8>
...
ffffffffc0200718:	ca450513          	addi	a0,a0,-860 # ffffffffc02053b8 <commands+0x210>
...
ffffffffc0200726:	cae50513          	addi	a0,a0,-850 # ffffffffc02053d0 <commands+0x228>
...
ffffffffc0200734:	cb850513          	addi	a0,a0,-840 # ffffffffc02053e8 <commands+0x240>
...
ffffffffc0200742:	cc250513          	addi	a0,a0,-830 # ffffffffc0205400 <commands+0x258>
...
ffffffffc0200750:	ccc50513          	addi	a0,a0,-820 # ffffffffc0205418 <commands+0x270>
...
ffffffffc020075e:	cd650513          	addi	a0,a0,-810 # ffffffffc0205430 <commands+0x288>
...
ffffffffc020076c:	ce050513          	addi	a0,a0,-800 # ffffffffc0205448 <commands+0x2a0>
...
ffffffffc020077a:	cea50513          	addi	a0,a0,-790 # ffffffffc0205460 <commands+0x2b8>
...
ffffffffc0200788:	cf450513          	addi	a0,a0,-780 # ffffffffc0205478 <commands+0x2d0>
...
ffffffffc0200796:	cfe50513          	addi	a0,a0,-770 # ffffffffc0205490 <commands+0x2e8>
...
ffffffffc02007a4:	d0850513          	addi	a0,a0,-760 # ffffffffc02054a8 <commands+0x300>
...
ffffffffc02007b2:	d1250513          	addi	a0,a0,-750 # ffffffffc02054c0 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	d1c50513          	addi	a0,a0,-740 # ffffffffc02054d8 <commands+0x330>
...
ffffffffc02007ce:	d2650513          	addi	a0,a0,-730 # ffffffffc02054f0 <commands+0x348>
...
ffffffffc02007dc:	d3050513          	addi	a0,a0,-720 # ffffffffc0205508 <commands+0x360>
...
ffffffffc02007ea:	d3a50513          	addi	a0,a0,-710 # ffffffffc0205520 <commands+0x378>
...
ffffffffc02007f8:	d4450513          	addi	a0,a0,-700 # ffffffffc0205538 <commands+0x390>
...
ffffffffc0200806:	d4e50513          	addi	a0,a0,-690 # ffffffffc0205550 <commands+0x3a8>
...
ffffffffc0200818:	d5450513          	addi	a0,a0,-684 # ffffffffc0205568 <commands+0x3c0>
}
...
ffffffffc020082c:	d5850513          	addi	a0,a0,-680 # ffffffffc0205580 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	d5850513          	addi	a0,a0,-680 # ffffffffc0205598 <commands+0x3f0>
...
ffffffffc0200854:	d6050513          	addi	a0,a0,-672 # ffffffffc02055b0 <commands+0x408>
...
ffffffffc0200864:	d6850513          	addi	a0,a0,-664 # ffffffffc02055c8 <commands+0x420>
...
ffffffffc0200878:	d6c50513          	addi	a0,a0,-660 # ffffffffc02055e0 <commands+0x438>
}
...
ffffffffc0200894:	e1870713          	addi	a4,a4,-488 # ffffffffc02056a8 <commands+0x500>
...
ffffffffc02008a6:	db650513          	addi	a0,a0,-586 # ffffffffc0205658 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205638 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	d3e50513          	addi	a0,a0,-706 # ffffffffc02055f8 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	d5250513          	addi	a0,a0,-686 # ffffffffc0205618 <commands+0x470>
...
ffffffffc02008fc:	d9050513          	addi	a0,a0,-624 # ffffffffc0205688 <commands+0x4e0>
...
ffffffffc0200910:	d6c50513          	addi	a0,a0,-660 # ffffffffc0205678 <commands+0x4d0>
}
...
ffffffffc0200932:	f6270713          	addi	a4,a4,-158 # ffffffffc0205890 <commands+0x6e8>
...
ffffffffc0200944:	f3850513          	addi	a0,a0,-200 # ffffffffc0205878 <commands+0x6d0>
...
ffffffffc0200966:	d7650513          	addi	a0,a0,-650 # ffffffffc02056d8 <commands+0x530>
}
...
ffffffffc02009c0:	dbc60613          	addi	a2,a2,-580 # ffffffffc0205778 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	8a050513          	addi	a0,a0,-1888 # ffffffffc0205268 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	dc450513          	addi	a0,a0,-572 # ffffffffc0205798 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	dd250513          	addi	a0,a0,-558 # ffffffffc02057b0 <commands+0x608>
...
ffffffffc0200a6a:	d1260613          	addi	a2,a2,-750 # ffffffffc0205778 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	7f650513          	addi	a0,a0,2038 # ffffffffc0205268 <commands+0xc0>
...
ffffffffc0200a96:	ce660613          	addi	a2,a2,-794 # ffffffffc0205778 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	7ca50513          	addi	a0,a0,1994 # ffffffffc0205268 <commands+0xc0>
...
ffffffffc0200e74:	a6068693          	addi	a3,a3,-1440 # ffffffffc02058d0 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a6860613          	addi	a2,a2,-1432 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a7450513          	addi	a0,a0,-1420 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	b0068693          	addi	a3,a3,-1280 # ffffffffc0205990 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	a4860613          	addi	a2,a2,-1464 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	a5450513          	addi	a0,a0,-1452 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	b0868693          	addi	a3,a3,-1272 # ffffffffc02059b8 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	a2860613          	addi	a2,a2,-1496 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	a3450513          	addi	a0,a0,-1484 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	b2868693          	addi	a3,a3,-1240 # ffffffffc02059f8 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	a0860613          	addi	a2,a2,-1528 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	a1450513          	addi	a0,a0,-1516 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	b9068693          	addi	a3,a3,-1136 # ffffffffc0205a80 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	9e860613          	addi	a2,a2,-1560 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	9f450513          	addi	a0,a0,-1548 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	a2068693          	addi	a3,a3,-1504 # ffffffffc0205930 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	9c860613          	addi	a2,a2,-1592 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	9d450513          	addi	a0,a0,-1580 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	b4068693          	addi	a3,a3,-1216 # ffffffffc0205a70 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	9a860613          	addi	a2,a2,-1624 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	9b450513          	addi	a0,a0,-1612 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	b0868693          	addi	a3,a3,-1272 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	98860613          	addi	a2,a2,-1656 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	99450513          	addi	a0,a0,-1644 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	ac868693          	addi	a3,a3,-1336 # ffffffffc0205a38 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	96860613          	addi	a2,a2,-1688 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	97450513          	addi	a0,a0,-1676 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	b3868693          	addi	a3,a3,-1224 # ffffffffc0205ac8 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	94860613          	addi	a2,a2,-1720 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	95450513          	addi	a0,a0,-1708 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	b0868693          	addi	a3,a3,-1272 # ffffffffc0205ab8 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	92860613          	addi	a2,a2,-1752 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	93450513          	addi	a0,a0,-1740 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a8868693          	addi	a3,a3,-1400 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	90860613          	addi	a2,a2,-1784 # ffffffffc02058e0 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	91450513          	addi	a0,a0,-1772 # ffffffffc02058f8 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	aa868693          	addi	a3,a3,-1368 # ffffffffc0205a98 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	8e860613          	addi	a2,a2,-1816 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	8f450513          	addi	a0,a0,-1804 # ffffffffc02058f8 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	92068693          	addi	a3,a3,-1760 # ffffffffc0205930 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	8c860613          	addi	a2,a2,-1848 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	8d450513          	addi	a0,a0,-1836 # ffffffffc02058f8 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	a2868693          	addi	a3,a3,-1496 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	8a860613          	addi	a2,a2,-1880 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	8b450513          	addi	a0,a0,-1868 # ffffffffc02058f8 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	92068693          	addi	a3,a3,-1760 # ffffffffc0205970 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	88860613          	addi	a2,a2,-1912 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	89450513          	addi	a0,a0,-1900 # ffffffffc02058f8 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205950 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	86860613          	addi	a2,a2,-1944 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	87450513          	addi	a0,a0,-1932 # ffffffffc02058f8 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205970 <commands+0x7c8>
ffffffffc0201098:	00005617          	auipc	a2,0x5
ffffffffc020109c:	84860613          	addi	a2,a2,-1976 # ffffffffc02058e0 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00005517          	auipc	a0,0x5
ffffffffc02010a8:	85450513          	addi	a0,a0,-1964 # ffffffffc02058f8 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b6868693          	addi	a3,a3,-1176 # ffffffffc0205c18 <commands+0xa70>
ffffffffc02010b8:	00005617          	auipc	a2,0x5
ffffffffc02010bc:	82860613          	addi	a2,a2,-2008 # ffffffffc02058e0 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00005517          	auipc	a0,0x5
ffffffffc02010c8:	83450513          	addi	a0,a0,-1996 # ffffffffc02058f8 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	9e868693          	addi	a3,a3,-1560 # ffffffffc0205ab8 <commands+0x910>
ffffffffc02010d8:	00005617          	auipc	a2,0x5
ffffffffc02010dc:	80860613          	addi	a2,a2,-2040 # ffffffffc02058e0 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00005517          	auipc	a0,0x5
ffffffffc02010e8:	81450513          	addi	a0,a0,-2028 # ffffffffc02058f8 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	96868693          	addi	a3,a3,-1688 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	7e860613          	addi	a2,a2,2024 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	7f450513          	addi	a0,a0,2036 # ffffffffc02058f8 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	90868693          	addi	a3,a3,-1784 # ffffffffc0205a18 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	7c860613          	addi	a2,a2,1992 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	7d450513          	addi	a0,a0,2004 # ffffffffc02058f8 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	aa868693          	addi	a3,a3,-1368 # ffffffffc0205bd8 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	7a860613          	addi	a2,a2,1960 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	7b450513          	addi	a0,a0,1972 # ffffffffc02058f8 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a6868693          	addi	a3,a3,-1432 # ffffffffc0205bb8 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	78860613          	addi	a2,a2,1928 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	79450513          	addi	a0,a0,1940 # ffffffffc02058f8 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	a2068693          	addi	a3,a3,-1504 # ffffffffc0205b90 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	76860613          	addi	a2,a2,1896 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	77450513          	addi	a0,a0,1908 # ffffffffc02058f8 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	9d868693          	addi	a3,a3,-1576 # ffffffffc0205b68 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	74860613          	addi	a2,a2,1864 # ffffffffc02058e0 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	75450513          	addi	a0,a0,1876 # ffffffffc02058f8 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	9a868693          	addi	a3,a3,-1624 # ffffffffc0205b58 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	72860613          	addi	a2,a2,1832 # ffffffffc02058e0 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	73450513          	addi	a0,a0,1844 # ffffffffc02058f8 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	88868693          	addi	a3,a3,-1912 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	70860613          	addi	a2,a2,1800 # ffffffffc02058e0 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	71450513          	addi	a0,a0,1812 # ffffffffc02058f8 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	94868693          	addi	a3,a3,-1720 # ffffffffc0205b38 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	6e860613          	addi	a2,a2,1768 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	6f450513          	addi	a0,a0,1780 # ffffffffc02058f8 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	8f868693          	addi	a3,a3,-1800 # ffffffffc0205b08 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	6c860613          	addi	a2,a2,1736 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	6d450513          	addi	a0,a0,1748 # ffffffffc02058f8 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205af0 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	6a860613          	addi	a2,a2,1704 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	6b450513          	addi	a0,a0,1716 # ffffffffc02058f8 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00005697          	auipc	a3,0x5
ffffffffc0201254:	80868693          	addi	a3,a3,-2040 # ffffffffc0205a58 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	68860613          	addi	a2,a2,1672 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	69450513          	addi	a0,a0,1684 # ffffffffc02058f8 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	86868693          	addi	a3,a3,-1944 # ffffffffc0205ad8 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	66860613          	addi	a2,a2,1640 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	67450513          	addi	a0,a0,1652 # ffffffffc02058f8 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	96868693          	addi	a3,a3,-1688 # ffffffffc0205bf8 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	64860613          	addi	a2,a2,1608 # ffffffffc02058e0 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	65450513          	addi	a0,a0,1620 # ffffffffc02058f8 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	97868693          	addi	a3,a3,-1672 # ffffffffc0205c28 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	62860613          	addi	a2,a2,1576 # ffffffffc02058e0 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	63450513          	addi	a0,a0,1588 # ffffffffc02058f8 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	64068693          	addi	a3,a3,1600 # ffffffffc0205910 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	60860613          	addi	a2,a2,1544 # ffffffffc02058e0 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	61450513          	addi	a0,a0,1556 # ffffffffc02058f8 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	66068693          	addi	a3,a3,1632 # ffffffffc0205950 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	5e860613          	addi	a2,a2,1512 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	5f450513          	addi	a0,a0,1524 # ffffffffc02058f8 <commands+0x750>
...
ffffffffc0201440:	80468693          	addi	a3,a3,-2044 # ffffffffc0205c40 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	49c60613          	addi	a2,a2,1180 # ffffffffc02058e0 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	4a850513          	addi	a0,a0,1192 # ffffffffc02058f8 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7dc68693          	addi	a3,a3,2012 # ffffffffc0205c38 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	47c60613          	addi	a2,a2,1148 # ffffffffc02058e0 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	48850513          	addi	a0,a0,1160 # ffffffffc02058f8 <commands+0x750>
...
ffffffffc0201512:	72a68693          	addi	a3,a3,1834 # ffffffffc0205c38 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	3ca60613          	addi	a2,a2,970 # ffffffffc02058e0 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	3d650513          	addi	a0,a0,982 # ffffffffc02058f8 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	68868693          	addi	a3,a3,1672 # ffffffffc0205c68 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	2f860613          	addi	a2,a2,760 # ffffffffc02058e0 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	30450513          	addi	a0,a0,772 # ffffffffc02058f8 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	63868693          	addi	a3,a3,1592 # ffffffffc0205c38 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2d860613          	addi	a2,a2,728 # ffffffffc02058e0 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	2e450513          	addi	a0,a0,740 # ffffffffc02058f8 <commands+0x750>
...
ffffffffc0201724:	5a860613          	addi	a2,a2,1448 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	5c450513          	addi	a0,a0,1476 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc0201812:	4f268693          	addi	a3,a3,1266 # ffffffffc0205d00 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	0ca60613          	addi	a2,a2,202 # ffffffffc02058e0 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	4fe50513          	addi	a0,a0,1278 # ffffffffc0205d20 <default_pmm_manager+0x90>
...
ffffffffc0201834:	50850513          	addi	a0,a0,1288 # ffffffffc0205d38 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	51050513          	addi	a0,a0,1296 # ffffffffc0205d50 <default_pmm_manager+0xc0>
}
...
ffffffffc02019c6:	3d660613          	addi	a2,a2,982 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	32250513          	addi	a0,a0,802 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	39460613          	addi	a2,a2,916 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	30850513          	addi	a0,a0,776 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	3a260613          	addi	a2,a2,930 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	2ee50513          	addi	a0,a0,750 # ffffffffc0205cf0 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	3a660613          	addi	a2,a2,934 # ffffffffc0205db8 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	2d250513          	addi	a0,a0,722 # ffffffffc0205cf0 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	332030ef          	jal	ra,ffffffffc0204ef0 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	2a0030ef          	jal	ra,ffffffffc0204ef0 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	02260613          	addi	a2,a2,34 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	12e50513          	addi	a0,a0,302 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	00a60613          	addi	a2,a2,10 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	11650513          	addi	a0,a0,278 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	ff060613          	addi	a2,a2,-16 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	0fc50513          	addi	a0,a0,252 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	fd660613          	addi	a2,a2,-42 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	0e250513          	addi	a0,a0,226 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	da078793          	addi	a5,a5,-608 # ffffffffc0205c90 <default_pmm_manager>
...
ffffffffc0201f02:	ef250513          	addi	a0,a0,-270 # ffffffffc0205df0 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	ebc50513          	addi	a0,a0,-324 # ffffffffc0205e08 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	eb450513          	addi	a0,a0,-332 # ffffffffc0205e20 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e7450513          	addi	a0,a0,-396 # ffffffffc0205e48 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e7050513          	addi	a0,a0,-400 # ffffffffc0205e60 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	eb850513          	addi	a0,a0,-328 # ffffffffc0206148 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f3a58593          	addi	a1,a1,-198 # ffffffffc0206280 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	359020ef          	jal	ra,ffffffffc0204eaa <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	35f020ef          	jal	ra,ffffffffc0204ebc <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2e1020ef          	jal	ra,ffffffffc0204e74 <strlen>
...
ffffffffc0202458:	ea450513          	addi	a0,a0,-348 # ffffffffc02062f8 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c3a68693          	addi	a3,a3,-966 # ffffffffc02061a8 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	36a60613          	addi	a2,a2,874 # ffffffffc02058e0 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	85e50513          	addi	a0,a0,-1954 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	bda68693          	addi	a3,a3,-1062 # ffffffffc0206168 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	34a60613          	addi	a2,a2,842 # ffffffffc02058e0 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	83e50513          	addi	a0,a0,-1986 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	71860613          	addi	a2,a2,1816 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00004517          	auipc	a0,0x4
ffffffffc02025c0:	82450513          	addi	a0,a0,-2012 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	7a460613          	addi	a2,a2,1956 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00004517          	auipc	a0,0x4
ffffffffc02025dc:	80850513          	addi	a0,a0,-2040 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	78c60613          	addi	a2,a2,1932 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	7f050513          	addi	a0,a0,2032 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	8a468693          	addi	a3,a3,-1884 # ffffffffc0205ea0 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2dc60613          	addi	a2,a2,732 # ffffffffc02058e0 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	7d050513          	addi	a0,a0,2000 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	86468693          	addi	a3,a3,-1948 # ffffffffc0205e80 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	2bc60613          	addi	a2,a2,700 # ffffffffc02058e0 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	7b050513          	addi	a0,a0,1968 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0202644:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205f30 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	29860613          	addi	a2,a2,664 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	78c50513          	addi	a0,a0,1932 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	8a068693          	addi	a3,a3,-1888 # ffffffffc0205f00 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	27860613          	addi	a2,a2,632 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	76c50513          	addi	a0,a0,1900 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	85868693          	addi	a3,a3,-1960 # ffffffffc0205ed8 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	25860613          	addi	a2,a2,600 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	74c50513          	addi	a0,a0,1868 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	91868693          	addi	a3,a3,-1768 # ffffffffc0205fb8 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	23860613          	addi	a2,a2,568 # ffffffffc02058e0 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	72c50513          	addi	a0,a0,1836 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	99868693          	addi	a3,a3,-1640 # ffffffffc0206058 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	21860613          	addi	a2,a2,536 # ffffffffc02058e0 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	70c50513          	addi	a0,a0,1804 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205f90 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	1f860613          	addi	a2,a2,504 # ffffffffc02058e0 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0202706:	5c660613          	addi	a2,a2,1478 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	6d250513          	addi	a0,a0,1746 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	8d668693          	addi	a3,a3,-1834 # ffffffffc0205ff0 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	1be60613          	addi	a2,a2,446 # ffffffffc02058e0 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	6b250513          	addi	a0,a0,1714 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	97e68693          	addi	a3,a3,-1666 # ffffffffc02060b8 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	19e60613          	addi	a2,a2,414 # ffffffffc02058e0 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	69250513          	addi	a0,a0,1682 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	94668693          	addi	a3,a3,-1722 # ffffffffc02060a0 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	17e60613          	addi	a2,a2,382 # ffffffffc02058e0 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	67250513          	addi	a0,a0,1650 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	8f668693          	addi	a3,a3,-1802 # ffffffffc0206070 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	15e60613          	addi	a2,a2,350 # ffffffffc02058e0 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	65250513          	addi	a0,a0,1618 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a8e68693          	addi	a3,a3,-1394 # ffffffffc0206228 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	13e60613          	addi	a2,a2,318 # ffffffffc02058e0 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	63250513          	addi	a0,a0,1586 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	88668693          	addi	a3,a3,-1914 # ffffffffc0206040 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	11e60613          	addi	a2,a2,286 # ffffffffc02058e0 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	61250513          	addi	a0,a0,1554 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	85668693          	addi	a3,a3,-1962 # ffffffffc0206030 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	0fe60613          	addi	a2,a2,254 # ffffffffc02058e0 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	5f250513          	addi	a0,a0,1522 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	92e68693          	addi	a3,a3,-1746 # ffffffffc0206128 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0de60613          	addi	a2,a2,222 # ffffffffc02058e0 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	5d250513          	addi	a0,a0,1490 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00004697          	auipc	a3,0x4
ffffffffc020281e:	80668693          	addi	a3,a3,-2042 # ffffffffc0206020 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	0be60613          	addi	a2,a2,190 # ffffffffc02058e0 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	5b250513          	addi	a0,a0,1458 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	73e68693          	addi	a3,a3,1854 # ffffffffc0205f78 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	09e60613          	addi	a2,a2,158 # ffffffffc02058e0 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	59250513          	addi	a0,a0,1426 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	87668693          	addi	a3,a3,-1930 # ffffffffc02060d0 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	07e60613          	addi	a2,a2,126 # ffffffffc02058e0 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	57250513          	addi	a0,a0,1394 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	6e668693          	addi	a3,a3,1766 # ffffffffc0205f60 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	05e60613          	addi	a2,a2,94 # ffffffffc02058e0 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	55250513          	addi	a0,a0,1362 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	42e60613          	addi	a2,a2,1070 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	44a50513          	addi	a0,a0,1098 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	84e68693          	addi	a3,a3,-1970 # ffffffffc0206100 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	02660613          	addi	a2,a2,38 # ffffffffc02058e0 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	51a50513          	addi	a0,a0,1306 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	7e668693          	addi	a3,a3,2022 # ffffffffc02060b8 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	00660613          	addi	a2,a2,6 # ffffffffc02058e0 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	4fa50513          	addi	a0,a0,1274 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	7f668693          	addi	a3,a3,2038 # ffffffffc02060e8 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	fe660613          	addi	a2,a2,-26 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4da50513          	addi	a0,a0,1242 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	7a668693          	addi	a3,a3,1958 # ffffffffc02060b8 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	fc660613          	addi	a2,a2,-58 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8de68693          	addi	a3,a3,-1826 # ffffffffc0206210 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	fa660613          	addi	a2,a2,-90 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	49a50513          	addi	a0,a0,1178 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	88668693          	addi	a3,a3,-1914 # ffffffffc02061d8 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f8660613          	addi	a2,a2,-122 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	47a50513          	addi	a0,a0,1146 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	84e68693          	addi	a3,a3,-1970 # ffffffffc02061c0 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f6660613          	addi	a2,a2,-154 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	45a50513          	addi	a0,a0,1114 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	79668693          	addi	a3,a3,1942 # ffffffffc0206128 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f4660613          	addi	a2,a2,-186 # ffffffffc02058e0 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	43a50513          	addi	a0,a0,1082 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	5ae68693          	addi	a3,a3,1454 # ffffffffc0205f60 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	f2660613          	addi	a2,a2,-218 # ffffffffc02058e0 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	41a50513          	addi	a0,a0,1050 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	2f660613          	addi	a2,a2,758 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	40250513          	addi	a0,a0,1026 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	58e68693          	addi	a3,a3,1422 # ffffffffc0205f78 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	eee60613          	addi	a2,a2,-274 # ffffffffc02058e0 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	3e250513          	addi	a0,a0,994 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	5e668693          	addi	a3,a3,1510 # ffffffffc0205ff0 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	ece60613          	addi	a2,a2,-306 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	3c250513          	addi	a0,a0,962 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	8a668693          	addi	a3,a3,-1882 # ffffffffc02062d0 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	eae60613          	addi	a2,a2,-338 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	3a250513          	addi	a0,a0,930 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	84e68693          	addi	a3,a3,-1970 # ffffffffc0206298 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e8e60613          	addi	a2,a2,-370 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	38250513          	addi	a0,a0,898 # ffffffffc0205de0 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	7fe68693          	addi	a3,a3,2046 # ffffffffc0206268 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e6e60613          	addi	a2,a2,-402 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	36250513          	addi	a0,a0,866 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	82868693          	addi	a3,a3,-2008 # ffffffffc0206318 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	de860613          	addi	a2,a2,-536 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2dc50513          	addi	a0,a0,732 # ffffffffc0205de0 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	24e60613          	addi	a2,a2,590 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	19a50513          	addi	a0,a0,410 # ffffffffc0205cf0 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	554010ef          	jal	ra,ffffffffc02040d4 <swapfs_init>
...
ffffffffc0202bde:	78650513          	addi	a0,a0,1926 # ffffffffc0206360 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	74c50513          	addi	a0,a0,1868 # ffffffffc0206378 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	76850513          	addi	a0,a0,1896 # ffffffffc02063e8 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	79c50513          	addi	a0,a0,1948 # ffffffffc0206438 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	7b050513          	addi	a0,a0,1968 # ffffffffc02064c0 <default_pmm_manager+0x830>
...
ffffffffc0202e58:	71450513          	addi	a0,a0,1812 # ffffffffc0206568 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	69050513          	addi	a0,a0,1680 # ffffffffc02065b8 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	99668693          	addi	a3,a3,-1642 # ffffffffc02058d0 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	99e60613          	addi	a2,a2,-1634 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	40250513          	addi	a0,a0,1026 # ffffffffc0206350 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e3a60613          	addi	a2,a2,-454 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d8650513          	addi	a0,a0,-634 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	5ca68693          	addi	a3,a3,1482 # ffffffffc0206540 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	96260613          	addi	a2,a2,-1694 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	3c650513          	addi	a0,a0,966 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	4ca68693          	addi	a3,a3,1226 # ffffffffc0206460 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	94260613          	addi	a2,a2,-1726 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	3a650513          	addi	a0,a0,934 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	37a60613          	addi	a2,a2,890 # ffffffffc0206330 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	38e50513          	addi	a0,a0,910 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	55a68693          	addi	a3,a3,1370 # ffffffffc0206528 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	90a60613          	addi	a2,a2,-1782 # ffffffffc02058e0 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	36e50513          	addi	a0,a0,878 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	dca60613          	addi	a2,a2,-566 # ffffffffc0205db8 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	cf650513          	addi	a0,a0,-778 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	47268693          	addi	a3,a3,1138 # ffffffffc0206478 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	8d260613          	addi	a2,a2,-1838 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	33650513          	addi	a0,a0,822 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	38a68693          	addi	a3,a3,906 # ffffffffc02063b0 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	8b260613          	addi	a2,a2,-1870 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	31650513          	addi	a0,a0,790 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	8ca68693          	addi	a3,a3,-1846 # ffffffffc0205910 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	89260613          	addi	a2,a2,-1902 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	2f650513          	addi	a0,a0,758 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a5268693          	addi	a3,a3,-1454 # ffffffffc0205ab8 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	87260613          	addi	a2,a2,-1934 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	2d650513          	addi	a0,a0,726 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	34268693          	addi	a3,a3,834 # ffffffffc02063c8 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	85260613          	addi	a2,a2,-1966 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	2b650513          	addi	a0,a0,694 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	2fa68693          	addi	a3,a3,762 # ffffffffc02063a0 <default_pmm_manager+0x710>
ffffffffc02030ae:	00003617          	auipc	a2,0x3
ffffffffc02030b2:	83260613          	addi	a2,a2,-1998 # ffffffffc02058e0 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	29650513          	addi	a0,a0,662 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	4e268693          	addi	a3,a3,1250 # ffffffffc02065a8 <default_pmm_manager+0x918>
ffffffffc02030ce:	00003617          	auipc	a2,0x3
ffffffffc02030d2:	81260613          	addi	a2,a2,-2030 # ffffffffc02058e0 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	27650513          	addi	a0,a0,630 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	be260613          	addi	a2,a2,-1054 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	bfe50513          	addi	a0,a0,-1026 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	49a68693          	addi	a3,a3,1178 # ffffffffc0206598 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7da60613          	addi	a2,a2,2010 # ffffffffc02058e0 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	23e50513          	addi	a0,a0,574 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	3ca68693          	addi	a3,a3,970 # ffffffffc02064e8 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	7ba60613          	addi	a2,a2,1978 # ffffffffc02058e0 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	21e50513          	addi	a0,a0,542 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	35a68693          	addi	a3,a3,858 # ffffffffc0206498 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	79a60613          	addi	a2,a2,1946 # ffffffffc02058e0 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	1fe50513          	addi	a0,a0,510 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	2c268693          	addi	a3,a3,706 # ffffffffc0206420 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	77a60613          	addi	a2,a2,1914 # ffffffffc02058e0 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1de50513          	addi	a0,a0,478 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	41268693          	addi	a3,a3,1042 # ffffffffc0206590 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	75a60613          	addi	a2,a2,1882 # ffffffffc02058e0 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	1be50513          	addi	a0,a0,446 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	23a68693          	addi	a3,a3,570 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	73a60613          	addi	a2,a2,1850 # ffffffffc02058e0 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	19e50513          	addi	a0,a0,414 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	35a68693          	addi	a3,a3,858 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	71a60613          	addi	a2,a2,1818 # ffffffffc02058e0 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	17e50513          	addi	a0,a0,382 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	33a68693          	addi	a3,a3,826 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	6fa60613          	addi	a2,a2,1786 # ffffffffc02058e0 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	15e50513          	addi	a0,a0,350 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	2fa68693          	addi	a3,a3,762 # ffffffffc02064f8 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6da60613          	addi	a2,a2,1754 # ffffffffc02058e0 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	13e50513          	addi	a0,a0,318 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2da68693          	addi	a3,a3,730 # ffffffffc02064f8 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	6ba60613          	addi	a2,a2,1722 # ffffffffc02058e0 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	11e50513          	addi	a0,a0,286 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	2ca68693          	addi	a3,a3,714 # ffffffffc0206508 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	69a60613          	addi	a2,a2,1690 # ffffffffc02058e0 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	0fe50513          	addi	a0,a0,254 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	2aa68693          	addi	a3,a3,682 # ffffffffc0206508 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	67a60613          	addi	a2,a2,1658 # ffffffffc02058e0 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0de50513          	addi	a0,a0,222 # ffffffffc0206350 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	26a68693          	addi	a3,a3,618 # ffffffffc02064e8 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	65a60613          	addi	a2,a2,1626 # ffffffffc02058e0 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	0be50513          	addi	a0,a0,190 # ffffffffc0206350 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	35ab0b13          	addi	s6,s6,858 # ffffffffc0206638 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	33ab8b93          	addi	s7,s7,826 # ffffffffc0206620 <default_pmm_manager+0x990>
...
ffffffffc020335a:	641000ef          	jal	ra,ffffffffc020419a <swapfs_write>
...
ffffffffc020339c:	24050513          	addi	a0,a0,576 # ffffffffc02065d8 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	25e68693          	addi	a3,a3,606 # ffffffffc0206608 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	52e60613          	addi	a2,a2,1326 # ffffffffc02058e0 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f9250513          	addi	a0,a0,-110 # ffffffffc0206350 <default_pmm_manager+0x6c0>
...
ffffffffc02033f8:	515000ef          	jal	ra,ffffffffc020410c <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02033fc:	00093583          	ld	a1,0(s2)
ffffffffc0203400:	8626                	mv	a2,s1
ffffffffc0203402:	00003517          	auipc	a0,0x3
ffffffffc0203406:	28650513          	addi	a0,a0,646 # ffffffffc0206688 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	25468693          	addi	a3,a3,596 # ffffffffc0206678 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	4b460613          	addi	a2,a2,1204 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	f1850513          	addi	a0,a0,-232 # ffffffffc0206350 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	26050513          	addi	a0,a0,608 # ffffffffc02066c8 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	26a50513          	addi	a0,a0,618 # ffffffffc0206708 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	26e50513          	addi	a0,a0,622 # ffffffffc0206730 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	27850513          	addi	a0,a0,632 # ffffffffc0206758 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	28450513          	addi	a0,a0,644 # ffffffffc0206780 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	23e50513          	addi	a0,a0,574 # ffffffffc0206758 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	1d650513          	addi	a0,a0,470 # ffffffffc0206708 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	20c50513          	addi	a0,a0,524 # ffffffffc0206758 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	16250513          	addi	a0,a0,354 # ffffffffc02066c8 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	1b050513          	addi	a0,a0,432 # ffffffffc0206730 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	1e650513          	addi	a0,a0,486 # ffffffffc0206780 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	15050513          	addi	a0,a0,336 # ffffffffc0206708 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	f2268693          	addi	a3,a3,-222 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	2e260613          	addi	a2,a2,738 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	0e650513          	addi	a0,a0,230 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	21a68693          	addi	a3,a3,538 # ffffffffc0206830 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	2c260613          	addi	a2,a2,706 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	0c650513          	addi	a0,a0,198 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	1d268693          	addi	a3,a3,466 # ffffffffc0206808 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	2a260613          	addi	a2,a2,674 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	0a650513          	addi	a0,a0,166 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	1a268693          	addi	a3,a3,418 # ffffffffc02067f8 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	28260613          	addi	a2,a2,642 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	08650513          	addi	a0,a0,134 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	17268693          	addi	a3,a3,370 # ffffffffc02067e8 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	26260613          	addi	a2,a2,610 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	06650513          	addi	a0,a0,102 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	14268693          	addi	a3,a3,322 # ffffffffc02067d8 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	24260613          	addi	a2,a2,578 # ffffffffc02058e0 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	04650513          	addi	a0,a0,70 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	11268693          	addi	a3,a3,274 # ffffffffc02067c8 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	22260613          	addi	a2,a2,546 # ffffffffc02058e0 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	02650513          	addi	a0,a0,38 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	0e268693          	addi	a3,a3,226 # ffffffffc02067b8 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	20260613          	addi	a2,a2,514 # ffffffffc02058e0 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	00650513          	addi	a0,a0,6 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	0b268693          	addi	a3,a3,178 # ffffffffc02067a8 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	1e260613          	addi	a2,a2,482 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	fe650513          	addi	a0,a0,-26 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	09268693          	addi	a3,a3,146 # ffffffffc02067a8 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	1c260613          	addi	a2,a2,450 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	fc650513          	addi	a0,a0,-58 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	de268693          	addi	a3,a3,-542 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	1a260613          	addi	a2,a2,418 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	fa650513          	addi	a0,a0,-90 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	dc268693          	addi	a3,a3,-574 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	18260613          	addi	a2,a2,386 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f8650513          	addi	a0,a0,-122 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	da268693          	addi	a3,a3,-606 # ffffffffc0206518 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	16260613          	addi	a2,a2,354 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f6650513          	addi	a0,a0,-154 # ffffffffc02066f0 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	08868693          	addi	a3,a3,136 # ffffffffc0206840 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	12060613          	addi	a2,a2,288 # ffffffffc02058e0 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	f2450513          	addi	a0,a0,-220 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	07868693          	addi	a3,a3,120 # ffffffffc0206850 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	10060613          	addi	a2,a2,256 # ffffffffc02058e0 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	f0450513          	addi	a0,a0,-252 # ffffffffc02066f0 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	05068693          	addi	a3,a3,80 # ffffffffc0206860 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	0c860613          	addi	a2,a2,200 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	ecc50513          	addi	a0,a0,-308 # ffffffffc02066f0 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	06468693          	addi	a3,a3,100 # ffffffffc0206898 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	0a460613          	addi	a2,a2,164 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	07050513          	addi	a0,a0,112 # ffffffffc02068b8 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	f4c68693          	addi	a3,a3,-180 # ffffffffc02068c8 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	f5c60613          	addi	a2,a2,-164 # ffffffffc02058e0 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	f2850513          	addi	a0,a0,-216 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f6c68693          	addi	a3,a3,-148 # ffffffffc0206908 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	f3c60613          	addi	a2,a2,-196 # ffffffffc02058e0 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	f0850513          	addi	a0,a0,-248 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	f2c68693          	addi	a3,a3,-212 # ffffffffc02068e8 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	f1c60613          	addi	a2,a2,-228 # ffffffffc02058e0 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	ee850513          	addi	a0,a0,-280 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	96a68693          	addi	a3,a3,-1686 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e6a60613          	addi	a2,a2,-406 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	e3650513          	addi	a0,a0,-458 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	91668693          	addi	a3,a3,-1770 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	e1660613          	addi	a2,a2,-490 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	de250513          	addi	a0,a0,-542 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e9250513          	addi	a0,a0,-366 # ffffffffc0206a28 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	eae68693          	addi	a3,a3,-338 # ffffffffc0206a50 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	d3660613          	addi	a2,a2,-714 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	d0250513          	addi	a0,a0,-766 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e8450513          	addi	a0,a0,-380 # ffffffffc0206a68 <default_pmm_manager+0xdd8>
...
ffffffffc0203d7c:	d6850513          	addi	a0,a0,-664 # ffffffffc0206ae0 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d6e50513          	addi	a0,a0,-658 # ffffffffc0206b00 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b9a68693          	addi	a3,a3,-1126 # ffffffffc0206940 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	b3260613          	addi	a2,a2,-1230 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	afe50513          	addi	a0,a0,-1282 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	c0268693          	addi	a3,a3,-1022 # ffffffffc02069c8 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	b1260613          	addi	a2,a2,-1262 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	ade50513          	addi	a0,a0,-1314 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	c1268693          	addi	a3,a3,-1006 # ffffffffc02069f8 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	af260613          	addi	a2,a2,-1294 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	abe50513          	addi	a0,a0,-1346 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	b2268693          	addi	a3,a3,-1246 # ffffffffc0206928 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	ad260613          	addi	a2,a2,-1326 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a9e50513          	addi	a0,a0,-1378 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b8268693          	addi	a3,a3,-1150 # ffffffffc02069a8 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	ab260613          	addi	a2,a2,-1358 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a7e50513          	addi	a0,a0,-1410 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b7268693          	addi	a3,a3,-1166 # ffffffffc02069b8 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a9260613          	addi	a2,a2,-1390 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	a5e50513          	addi	a0,a0,-1442 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206978 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a7260613          	addi	a2,a2,-1422 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	a3e50513          	addi	a0,a0,-1474 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	b0268693          	addi	a3,a3,-1278 # ffffffffc0206988 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	a5260613          	addi	a2,a2,-1454 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	a1e50513          	addi	a0,a0,-1506 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	af268693          	addi	a3,a3,-1294 # ffffffffc0206998 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	a3260613          	addi	a2,a2,-1486 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	9fe50513          	addi	a0,a0,-1538 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	c5268693          	addi	a3,a3,-942 # ffffffffc0206b18 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	a1260613          	addi	a2,a2,-1518 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	9de50513          	addi	a0,a0,-1570 # ffffffffc02068b8 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	4ea68693          	addi	a3,a3,1258 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	9ea60613          	addi	a2,a2,-1558 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	9b650513          	addi	a0,a0,-1610 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b7a68693          	addi	a3,a3,-1158 # ffffffffc0206a88 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	9ca60613          	addi	a2,a2,-1590 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	99650513          	addi	a0,a0,-1642 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b7a68693          	addi	a3,a3,-1158 # ffffffffc0206aa8 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	9aa60613          	addi	a2,a2,-1622 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	97650513          	addi	a0,a0,-1674 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	e4a60613          	addi	a2,a2,-438 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d9650513          	addi	a0,a0,-618 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d6260613          	addi	a2,a2,-670 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d7e50513          	addi	a0,a0,-642 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	b3a68693          	addi	a3,a3,-1222 # ffffffffc0206ab8 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	95a60613          	addi	a2,a2,-1702 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	92650513          	addi	a0,a0,-1754 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	42a68693          	addi	a3,a3,1066 # ffffffffc02063c8 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	93a60613          	addi	a2,a2,-1734 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	90650513          	addi	a0,a0,-1786 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	3e268693          	addi	a3,a3,994 # ffffffffc02063a0 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	91a60613          	addi	a2,a2,-1766 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	8e650513          	addi	a0,a0,-1818 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203fde:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203fe0:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
ffffffffc0203fe2:	f822                	sd	s0,48(sp)
ffffffffc0203fe4:	f426                	sd	s1,40(sp)
ffffffffc0203fe6:	fc06                	sd	ra,56(sp)
ffffffffc0203fe8:	f04a                	sd	s2,32(sp)
ffffffffc0203fea:	ec4e                	sd	s3,24(sp)
ffffffffc0203fec:	8432                	mv	s0,a2
ffffffffc0203fee:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203ff0:	8ddff0ef          	jal	ra,ffffffffc02038cc <find_vma>

    pgfault_num++;
ffffffffc0203ff4:	00012797          	auipc	a5,0x12
ffffffffc0203ff8:	5b47a783          	lw	a5,1460(a5) # ffffffffc02165a8 <pgfault_num>
ffffffffc0203ffc:	2785                	addiw	a5,a5,1
ffffffffc0203ffe:	00012717          	auipc	a4,0x12
ffffffffc0204002:	5af72523          	sw	a5,1450(a4) # ffffffffc02165a8 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0204006:	cd51                	beqz	a0,ffffffffc02040a2 <do_pgfault+0xc4>
ffffffffc0204008:	651c                	ld	a5,8(a0)
ffffffffc020400a:	08f46c63          	bltu	s0,a5,ffffffffc02040a2 <do_pgfault+0xc4>
...
ffffffffc020400e:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0204010:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0204012:	8b89                	andi	a5,a5,2
ffffffffc0204014:	e3a1                	bnez	a5,ffffffffc0204054 <do_pgfault+0x76>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204016:	75fd                	lui	a1,0xfffff
...
ffffffffc0204018:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc020401a:	8c6d                	and	s0,s0,a1
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc020401c:	4605                	li	a2,1
ffffffffc020401e:	85a2                	mv	a1,s0
ffffffffc0204020:	b19fd0ef          	jal	ra,ffffffffc0201b38 <get_pte>
ffffffffc0204024:	c145                	beqz	a0,ffffffffc02040c4 <do_pgfault+0xe6>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204026:	610c                	ld	a1,0(a0)
ffffffffc0204028:	cdb1                	beqz	a1,ffffffffc0204084 <do_pgfault+0xa6>
        ...
        */
        if (swap_init_ok) {
ffffffffc020402a:	00012797          	auipc	a5,0x12
ffffffffc020402e:	56e7a783          	lw	a5,1390(a5) # ffffffffc0216598 <swap_init_ok>
ffffffffc0204032:	c3c9                	beqz	a5,ffffffffc02040b4 <do_pgfault+0xd6>
...
ffffffffc0204038:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc020403a:	e402                	sd	zero,8(sp)
            ret=swap_in(mm,addr,&page);
ffffffffc020403c:	b8eff0ef          	jal	ra,ffffffffc02033ca <swap_in>
ffffffffc0204040:	892a                	mv	s2,a0
            if(ret !=0) {
ffffffffc0204042:	c919                	beqz	a0,ffffffffc0204058 <do_pgfault+0x7a>
   }
...
ffffffffc0204044:	70e2                	ld	ra,56(sp)
ffffffffc0204046:	7442                	ld	s0,48(sp)
ffffffffc0204048:	74a2                	ld	s1,40(sp)
ffffffffc020404a:	69e2                	ld	s3,24(sp)
ffffffffc020404c:	854a                	mv	a0,s2
ffffffffc020404e:	7902                	ld	s2,32(sp)
ffffffffc0204050:	6121                	addi	sp,sp,64
ffffffffc0204052:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204054:	49dd                	li	s3,23
ffffffffc0204056:	b7c1                	j	ffffffffc0204016 <do_pgfault+0x38>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0204058:	65a2                	ld	a1,8(sp)
ffffffffc020405a:	6c88                	ld	a0,24(s1)
ffffffffc020405c:	86ce                	mv	a3,s3
ffffffffc020405e:	8622                	mv	a2,s0
ffffffffc0204060:	d9bfd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0204064:	6622                	ld	a2,8(sp)
ffffffffc0204066:	85a2                	mv	a1,s0
ffffffffc0204068:	8526                	mv	a0,s1
ffffffffc020406a:	4685                	li	a3,1
ffffffffc020406c:	a3eff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0204070:	67a2                	ld	a5,8(sp)
}
ffffffffc0204072:	70e2                	ld	ra,56(sp)
ffffffffc0204074:	74a2                	ld	s1,40(sp)
            page->pra_vaddr = addr;
ffffffffc0204076:	ff80                	sd	s0,56(a5)
}
ffffffffc0204078:	7442                	ld	s0,48(sp)
ffffffffc020407a:	69e2                	ld	s3,24(sp)
ffffffffc020407c:	854a                	mv	a0,s2
ffffffffc020407e:	7902                	ld	s2,32(sp)
ffffffffc0204080:	6121                	addi	sp,sp,64
ffffffffc0204082:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204084:	6c88                	ld	a0,24(s1)
ffffffffc0204086:	864e                	mv	a2,s3
ffffffffc0204088:	85a2                	mv	a1,s0
ffffffffc020408a:	a07fe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
   ret = 0;
ffffffffc020408e:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204090:	f955                	bnez	a0,ffffffffc0204044 <do_pgfault+0x66>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0204092:	00003517          	auipc	a0,0x3
ffffffffc0204096:	aee50513          	addi	a0,a0,-1298 # ffffffffc0206b80 <default_pmm_manager+0xef0>
ffffffffc020409a:	8e6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc020409e:	5971                	li	s2,-4
            goto failed;
ffffffffc02040a0:	b755                	j	ffffffffc0204044 <do_pgfault+0x66>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc02040a2:	85a2                	mv	a1,s0
ffffffffc02040a4:	00003517          	auipc	a0,0x3
ffffffffc02040a8:	a8c50513          	addi	a0,a0,-1396 # ffffffffc0206b30 <default_pmm_manager+0xea0>
ffffffffc02040ac:	8d4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc02040b0:	5975                	li	s2,-3
        goto failed;
ffffffffc02040b2:	bf49                	j	ffffffffc0204044 <do_pgfault+0x66>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040b4:	00003517          	auipc	a0,0x3
ffffffffc02040b8:	af450513          	addi	a0,a0,-1292 # ffffffffc0206ba8 <default_pmm_manager+0xf18>
ffffffffc02040bc:	8c4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040c0:	5971                	li	s2,-4
            goto failed;
ffffffffc02040c2:	b749                	j	ffffffffc0204044 <do_pgfault+0x66>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040c4:	00003517          	auipc	a0,0x3
ffffffffc02040c8:	a9c50513          	addi	a0,a0,-1380 # ffffffffc0206b60 <default_pmm_manager+0xed0>
ffffffffc02040cc:	8b4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040d0:	5971                	li	s2,-4
        goto failed;
ffffffffc02040d2:	bf8d                	j	ffffffffc0204044 <do_pgfault+0x66>

ffffffffc02040d4 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc02040d8:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040da:	c8efc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040de:	cd01                	beqz	a0,ffffffffc02040f6 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040e0:	4505                	li	a0,1
ffffffffc02040e2:	c8cfc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040e6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040e8:	810d                	srli	a0,a0,0x3
ffffffffc02040ea:	00012797          	auipc	a5,0x12
ffffffffc02040ee:	48a7bf23          	sd	a0,1182(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc02040f2:	0141                	addi	sp,sp,16
ffffffffc02040f4:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040f6:	00003617          	auipc	a2,0x3
ffffffffc02040fa:	ada60613          	addi	a2,a2,-1318 # ffffffffc0206bd0 <default_pmm_manager+0xf40>
ffffffffc02040fe:	45b5                	li	a1,13
ffffffffc0204100:	00003517          	auipc	a0,0x3
ffffffffc0204104:	af050513          	addi	a0,a0,-1296 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
ffffffffc0204108:	b3efc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020410c <swapfs_read>:
...
ffffffffc0204110:	00855793          	srli	a5,a0,0x8
ffffffffc0204114:	cbb1                	beqz	a5,ffffffffc0204168 <swapfs_read+0x5c>
ffffffffc0204116:	00012717          	auipc	a4,0x12
ffffffffc020411a:	47273703          	ld	a4,1138(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc020411e:	04e7f563          	bgeu	a5,a4,ffffffffc0204168 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204122:	00012617          	auipc	a2,0x12
ffffffffc0204126:	44e63603          	ld	a2,1102(a2) # ffffffffc0216570 <pages>
ffffffffc020412a:	8d91                	sub	a1,a1,a2
ffffffffc020412c:	4065d613          	srai	a2,a1,0x6
ffffffffc0204130:	00003717          	auipc	a4,0x3
ffffffffc0204134:	ef073703          	ld	a4,-272(a4) # ffffffffc0207020 <nbase>
ffffffffc0204138:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc020413a:	00c61713          	slli	a4,a2,0xc
ffffffffc020413e:	8331                	srli	a4,a4,0xc
ffffffffc0204140:	00012697          	auipc	a3,0x12
ffffffffc0204144:	4286b683          	ld	a3,1064(a3) # ffffffffc0216568 <npage>
ffffffffc0204148:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc020414c:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc020414e:	02d77963          	bgeu	a4,a3,ffffffffc0204180 <swapfs_read+0x74>
}
ffffffffc0204152:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204154:	00012797          	auipc	a5,0x12
ffffffffc0204158:	42c7b783          	ld	a5,1068(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc020415c:	46a1                	li	a3,8
ffffffffc020415e:	963e                	add	a2,a2,a5
ffffffffc0204160:	4505                	li	a0,1
}
ffffffffc0204162:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204164:	c10fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204168:	86aa                	mv	a3,a0
ffffffffc020416a:	00003617          	auipc	a2,0x3
ffffffffc020416e:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0206c08 <default_pmm_manager+0xf78>
ffffffffc0204172:	45d1                	li	a1,20
ffffffffc0204174:	00003517          	auipc	a0,0x3
ffffffffc0204178:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
ffffffffc020417c:	acafc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204180:	86b2                	mv	a3,a2
ffffffffc0204182:	06900593          	li	a1,105
ffffffffc0204186:	00002617          	auipc	a2,0x2
ffffffffc020418a:	b4260613          	addi	a2,a2,-1214 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc020418e:	00002517          	auipc	a0,0x2
ffffffffc0204192:	b6250513          	addi	a0,a0,-1182 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204196:	ab0fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020419a <swapfs_write>:
...
ffffffffc020419e:	00855793          	srli	a5,a0,0x8
ffffffffc02041a2:	cbb1                	beqz	a5,ffffffffc02041f6 <swapfs_write+0x5c>
ffffffffc02041a4:	00012717          	auipc	a4,0x12
ffffffffc02041a8:	3e473703          	ld	a4,996(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc02041ac:	04e7f563          	bgeu	a5,a4,ffffffffc02041f6 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041b0:	00012617          	auipc	a2,0x12
ffffffffc02041b4:	3c063603          	ld	a2,960(a2) # ffffffffc0216570 <pages>
ffffffffc02041b8:	8d91                	sub	a1,a1,a2
ffffffffc02041ba:	4065d613          	srai	a2,a1,0x6
ffffffffc02041be:	00003717          	auipc	a4,0x3
ffffffffc02041c2:	e6273703          	ld	a4,-414(a4) # ffffffffc0207020 <nbase>
ffffffffc02041c6:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041c8:	00c61713          	slli	a4,a2,0xc
ffffffffc02041cc:	8331                	srli	a4,a4,0xc
ffffffffc02041ce:	00012697          	auipc	a3,0x12
ffffffffc02041d2:	39a6b683          	ld	a3,922(a3) # ffffffffc0216568 <npage>
ffffffffc02041d6:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041da:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041dc:	02d77963          	bgeu	a4,a3,ffffffffc020420e <swapfs_write+0x74>
}
ffffffffc02041e0:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041e2:	00012797          	auipc	a5,0x12
ffffffffc02041e6:	39e7b783          	ld	a5,926(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02041ea:	46a1                	li	a3,8
ffffffffc02041ec:	963e                	add	a2,a2,a5
ffffffffc02041ee:	4505                	li	a0,1
}
ffffffffc02041f0:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041f2:	ba6fc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc02041f6:	86aa                	mv	a3,a0
ffffffffc02041f8:	00003617          	auipc	a2,0x3
ffffffffc02041fc:	a1060613          	addi	a2,a2,-1520 # ffffffffc0206c08 <default_pmm_manager+0xf78>
ffffffffc0204200:	45e5                	li	a1,25
ffffffffc0204202:	00003517          	auipc	a0,0x3
ffffffffc0204206:	9ee50513          	addi	a0,a0,-1554 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
ffffffffc020420a:	a3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020420e:	86b2                	mv	a3,a2
ffffffffc0204210:	06900593          	li	a1,105
ffffffffc0204214:	00002617          	auipc	a2,0x2
ffffffffc0204218:	ab460613          	addi	a2,a2,-1356 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc020421c:	00002517          	auipc	a0,0x2
ffffffffc0204220:	ad450513          	addi	a0,a0,-1324 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204224:	a22fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204228 <kernel_thread_entry>:
.text
.globl kernel_thread_entry
kernel_thread_entry:        # void kernel_thread(void)
	move a0, s1
ffffffffc0204228:	8526                	mv	a0,s1
	jalr s0
ffffffffc020422a:	9402                	jalr	s0

	jal do_exit
ffffffffc020422c:	48e000ef          	jal	ra,ffffffffc02046ba <do_exit>

ffffffffc0204230 <alloc_proc>:
...
alloc_proc(void) {
ffffffffc0204230:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204232:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc0204236:	e022                	sd	s0,0(sp)
ffffffffc0204238:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc020423a:	e14fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020423e:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204240:	c521                	beqz	a0,ffffffffc0204288 <alloc_proc+0x58>
...
ffffffffc0204242:	57fd                	li	a5,-1
ffffffffc0204244:	1782                	slli	a5,a5,0x20
ffffffffc0204246:	e11c                	sd	a5,0(a0)
        proc->runs=0;
        proc->kstack=0;
        proc->need_resched=0;
        proc->parent=NULL;
...
ffffffffc0204248:	07000613          	li	a2,112
ffffffffc020424c:	4581                	li	a1,0
        proc->runs=0;
ffffffffc020424e:	00052423          	sw	zero,8(a0)
        proc->kstack=0;
ffffffffc0204252:	00053823          	sd	zero,16(a0)
        proc->need_resched=0;
ffffffffc0204256:	00052c23          	sw	zero,24(a0)
        proc->parent=NULL;
ffffffffc020425a:	02053023          	sd	zero,32(a0)
        proc->mm=NULL;
ffffffffc020425e:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204262:	03050513          	addi	a0,a0,48
ffffffffc0204266:	48b000ef          	jal	ra,ffffffffc0204ef0 <memset>
        proc->tf=NULL;
        proc->cr3=boot_cr3;
ffffffffc020426a:	00012797          	auipc	a5,0x12
ffffffffc020426e:	2ee7b783          	ld	a5,750(a5) # ffffffffc0216558 <boot_cr3>
        proc->tf=NULL;
ffffffffc0204272:	0a043023          	sd	zero,160(s0)
        proc->cr3=boot_cr3;
ffffffffc0204276:	f45c                	sd	a5,168(s0)
        proc->flags=0;
ffffffffc0204278:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc020427c:	463d                	li	a2,15
ffffffffc020427e:	4581                	li	a1,0
ffffffffc0204280:	0b440513          	addi	a0,s0,180
ffffffffc0204284:	46d000ef          	jal	ra,ffffffffc0204ef0 <memset>
    }
    return proc;
}
ffffffffc0204288:	60a2                	ld	ra,8(sp)
ffffffffc020428a:	8522                	mv	a0,s0
ffffffffc020428c:	6402                	ld	s0,0(sp)
ffffffffc020428e:	0141                	addi	sp,sp,16
ffffffffc0204290:	8082                	ret

ffffffffc0204292 <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc0204292:	00012797          	auipc	a5,0x12
ffffffffc0204296:	31e7b783          	ld	a5,798(a5) # ffffffffc02165b0 <current>
ffffffffc020429a:	73c8                	ld	a0,160(a5)
ffffffffc020429c:	8d1fc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc02042a0 <init_main>:
    panic("process exit!!.\n");
}
...
ffffffffc02042a2:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042a4:	00012497          	auipc	s1,0x12
ffffffffc02042a8:	27448493          	addi	s1,s1,628 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042ac:	f022                	sd	s0,32(sp)
ffffffffc02042ae:	e84a                	sd	s2,16(sp)
ffffffffc02042b0:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042b2:	00012917          	auipc	s2,0x12
ffffffffc02042b6:	2fe93903          	ld	s2,766(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc02042ba:	4641                	li	a2,16
...
ffffffffc02042c2:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c4:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042c8:	429000ef          	jal	ra,ffffffffc0204ef0 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042cc:	0b490593          	addi	a1,s2,180
ffffffffc02042d0:	463d                	li	a2,15
ffffffffc02042d2:	8526                	mv	a0,s1
ffffffffc02042d4:	42f000ef          	jal	ra,ffffffffc0204f02 <memcpy>
ffffffffc02042d8:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042da:	85ce                	mv	a1,s3
ffffffffc02042dc:	00003517          	auipc	a0,0x3
ffffffffc02042e0:	94c50513          	addi	a0,a0,-1716 # ffffffffc0206c28 <default_pmm_manager+0xf98>
ffffffffc02042e4:	e9dfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042e8:	85a2                	mv	a1,s0
ffffffffc02042ea:	00003517          	auipc	a0,0x3
ffffffffc02042ee:	96650513          	addi	a0,a0,-1690 # ffffffffc0206c50 <default_pmm_manager+0xfc0>
ffffffffc02042f2:	e8ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042f6:	00003517          	auipc	a0,0x3
ffffffffc02042fa:	96a50513          	addi	a0,a0,-1686 # ffffffffc0206c60 <default_pmm_manager+0xfd0>
ffffffffc02042fe:	e83fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
...
ffffffffc0204312 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204312:	7179                	addi	sp,sp,-48
ffffffffc0204314:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204316:	00012497          	auipc	s1,0x12
ffffffffc020431a:	29a48493          	addi	s1,s1,666 # ffffffffc02165b0 <current>
ffffffffc020431e:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc0204320:	f406                	sd	ra,40(sp)
ffffffffc0204322:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204324:	02a70863          	beq	a4,a0,ffffffffc0204354 <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204328:	100027f3          	csrr	a5,sstatus
ffffffffc020432c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020432e:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204330:	ef8d                	bnez	a5,ffffffffc020436a <proc_run+0x58>
        lcr3(proc->cr3);
...
ffffffffc0204334:	800006b7          	lui	a3,0x80000
        current=proc;
ffffffffc0204338:	e088                	sd	a0,0(s1)
ffffffffc020433a:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020433e:	8fd5                	or	a5,a5,a3
ffffffffc0204340:	18079073          	csrw	satp,a5
        switch_to(&(temp->context),&(proc->context));
ffffffffc0204344:	03050593          	addi	a1,a0,48
ffffffffc0204348:	03070513          	addi	a0,a4,48
ffffffffc020434c:	5f4000ef          	jal	ra,ffffffffc0204940 <switch_to>
    if (flag) {
ffffffffc0204350:	00091763          	bnez	s2,ffffffffc020435e <proc_run+0x4c>
}
ffffffffc0204354:	70a2                	ld	ra,40(sp)
ffffffffc0204356:	7482                	ld	s1,32(sp)
ffffffffc0204358:	6962                	ld	s2,24(sp)
ffffffffc020435a:	6145                	addi	sp,sp,48
ffffffffc020435c:	8082                	ret
ffffffffc020435e:	70a2                	ld	ra,40(sp)
ffffffffc0204360:	7482                	ld	s1,32(sp)
ffffffffc0204362:	6962                	ld	s2,24(sp)
...
ffffffffc0204370:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0204372:	6522                	ld	a0,8(sp)
ffffffffc0204374:	4905                	li	s2,1
ffffffffc0204376:	bf75                	j	ffffffffc0204332 <proc_run+0x20>

ffffffffc0204378 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204378:	7179                	addi	sp,sp,-48
ffffffffc020437a:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020437c:	00012497          	auipc	s1,0x12
ffffffffc0204380:	24c48493          	addi	s1,s1,588 # ffffffffc02165c8 <nr_process>
ffffffffc0204384:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204386:	f406                	sd	ra,40(sp)
ffffffffc0204388:	f022                	sd	s0,32(sp)
ffffffffc020438a:	e84a                	sd	s2,16(sp)
ffffffffc020438c:	e44e                	sd	s3,8(sp)
ffffffffc020438e:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204390:	6785                	lui	a5,0x1
ffffffffc0204392:	26f75163          	bge	a4,a5,ffffffffc02045f4 <do_fork+0x27c>
ffffffffc0204396:	892e                	mv	s2,a1
ffffffffc0204398:	8432                	mv	s0,a2
    proc = alloc_proc();    // 调用alloc_proc函数分配一个proc_struct结构体
ffffffffc020439a:	e97ff0ef          	jal	ra,ffffffffc0204230 <alloc_proc>
ffffffffc020439e:	89aa                	mv	s3,a0
    if (proc == NULL) { // 如果分配失败，返回错误码
ffffffffc02043a0:	24050f63          	beqz	a0,ffffffffc02045fe <do_fork+0x286>
    proc->parent = current; // 设置父进程为当前进程
ffffffffc02043a4:	00012a17          	auipc	s4,0x12
ffffffffc02043a8:	20ca0a13          	addi	s4,s4,524 # ffffffffc02165b0 <current>
ffffffffc02043ac:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043b0:	4509                	li	a0,2
    proc->parent = current; // 设置父进程为当前进程
ffffffffc02043b2:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043b6:	e76fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043ba:	1e050763          	beqz	a0,ffffffffc02045a8 <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043be:	00012697          	auipc	a3,0x12
ffffffffc02043c2:	1b26b683          	ld	a3,434(a3) # ffffffffc0216570 <pages>
ffffffffc02043c6:	40d506b3          	sub	a3,a0,a3
ffffffffc02043ca:	8699                	srai	a3,a3,0x6
ffffffffc02043cc:	00003517          	auipc	a0,0x3
ffffffffc02043d0:	c5453503          	ld	a0,-940(a0) # ffffffffc0207020 <nbase>
ffffffffc02043d4:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043d6:	00c69793          	slli	a5,a3,0xc
ffffffffc02043da:	83b1                	srli	a5,a5,0xc
ffffffffc02043dc:	00012717          	auipc	a4,0x12
ffffffffc02043e0:	18c73703          	ld	a4,396(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043e4:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043e6:	22e7fe63          	bgeu	a5,a4,ffffffffc0204622 <do_fork+0x2aa>
    assert(current->mm == NULL);
ffffffffc02043ea:	000a3783          	ld	a5,0(s4)
ffffffffc02043ee:	00012717          	auipc	a4,0x12
ffffffffc02043f2:	19273703          	ld	a4,402(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc02043f6:	96ba                	add	a3,a3,a4
ffffffffc02043f8:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043fa:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043fe:	20079263          	bnez	a5,ffffffffc0204602 <do_fork+0x28a>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204402:	6789                	lui	a5,0x2
ffffffffc0204404:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc0204408:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc020440a:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020440c:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc0204410:	87b6                	mv	a5,a3
ffffffffc0204412:	12040893          	addi	a7,s0,288
...
ffffffffc0204432:	ff1612e3          	bne	a2,a7,ffffffffc0204416 <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc0204436:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020443a:	12090563          	beqz	s2,ffffffffc0204564 <do_fork+0x1ec>
ffffffffc020443e:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204442:	00000797          	auipc	a5,0x0
ffffffffc0204446:	e5078793          	addi	a5,a5,-432 # ffffffffc0204292 <forkret>
ffffffffc020444a:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020444e:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204452:	100027f3          	csrr	a5,sstatus
ffffffffc0204456:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204458:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020445a:	12079663          	bnez	a5,ffffffffc0204586 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc020445e:	00007817          	auipc	a6,0x7
ffffffffc0204462:	bfa80813          	addi	a6,a6,-1030 # ffffffffc020b058 <last_pid.1>
...
ffffffffc0204474:	08e55163          	bge	a0,a4,ffffffffc02044f6 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204478:	00007317          	auipc	t1,0x7
ffffffffc020447c:	be430313          	addi	t1,t1,-1052 # ffffffffc020b05c <next_safe.0>
ffffffffc0204480:	00032783          	lw	a5,0(t1)
ffffffffc0204484:	00012417          	auipc	s0,0x12
ffffffffc0204488:	0a440413          	addi	s0,s0,164 # ffffffffc0216528 <proc_list>
ffffffffc020448c:	06f55d63          	bge	a0,a5,ffffffffc0204506 <do_fork+0x18e>
    proc->pid = get_pid();  // 为子进程分配pid
ffffffffc0204490:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204494:	45a9                	li	a1,10
ffffffffc0204496:	2501                	sext.w	a0,a0
ffffffffc0204498:	5d8000ef          	jal	ra,ffffffffc0204a70 <hash32>
ffffffffc020449c:	02051793          	slli	a5,a0,0x20
ffffffffc02044a0:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044a4:	0000e797          	auipc	a5,0xe
ffffffffc02044a8:	07478793          	addi	a5,a5,116 # ffffffffc0212518 <hash_list>
ffffffffc02044ac:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044ae:	6510                	ld	a2,8(a0)
ffffffffc02044b0:	0d898793          	addi	a5,s3,216
ffffffffc02044b4:	6414                	ld	a3,8(s0)
    nr_process++;
ffffffffc02044b6:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044b8:	e21c                	sd	a5,0(a2)
ffffffffc02044ba:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044bc:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link));   // 将子进程添加到proc_list中
ffffffffc02044c0:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044c4:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044c8:	e29c                	sd	a5,0(a3)
    nr_process++;
ffffffffc02044ca:	2705                	addiw	a4,a4,1
ffffffffc02044cc:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044ce:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044d2:	0c89b423          	sd	s0,200(s3)
ffffffffc02044d6:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044d8:	0a091b63          	bnez	s2,ffffffffc020458e <do_fork+0x216>
    wakeup_proc(proc);  // 唤醒子进程
ffffffffc02044dc:	854e                	mv	a0,s3
ffffffffc02044de:	4cc000ef          	jal	ra,ffffffffc02049aa <wakeup_proc>
    ret = proc->pid;    // 设置返回值为子进程的pid
ffffffffc02044e2:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044e6:	70a2                	ld	ra,40(sp)
ffffffffc02044e8:	7402                	ld	s0,32(sp)
ffffffffc02044ea:	64e2                	ld	s1,24(sp)
ffffffffc02044ec:	6942                	ld	s2,16(sp)
ffffffffc02044ee:	69a2                	ld	s3,8(sp)
ffffffffc02044f0:	6a02                	ld	s4,0(sp)
ffffffffc02044f2:	6145                	addi	sp,sp,48
ffffffffc02044f4:	8082                	ret
        last_pid = 1;
ffffffffc02044f6:	4785                	li	a5,1
ffffffffc02044f8:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044fc:	4505                	li	a0,1
ffffffffc02044fe:	00007317          	auipc	t1,0x7
ffffffffc0204502:	b5e30313          	addi	t1,t1,-1186 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204506:	00012417          	auipc	s0,0x12
ffffffffc020450a:	02240413          	addi	s0,s0,34 # ffffffffc0216528 <proc_list>
ffffffffc020450e:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204512:	6789                	lui	a5,0x2
ffffffffc0204514:	00f32023          	sw	a5,0(t1)
ffffffffc0204518:	86aa                	mv	a3,a0
ffffffffc020451a:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc020451c:	6e89                	lui	t4,0x2
ffffffffc020451e:	088e0063          	beq	t3,s0,ffffffffc020459e <do_fork+0x226>
ffffffffc0204522:	88ae                	mv	a7,a1
ffffffffc0204524:	87f2                	mv	a5,t3
ffffffffc0204526:	6609                	lui	a2,0x2
ffffffffc0204528:	a811                	j	ffffffffc020453c <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020452a:	00e6d663          	bge	a3,a4,ffffffffc0204536 <do_fork+0x1be>
ffffffffc020452e:	00c75463          	bge	a4,a2,ffffffffc0204536 <do_fork+0x1be>
ffffffffc0204532:	863a                	mv	a2,a4
ffffffffc0204534:	4885                	li	a7,1
ffffffffc0204536:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204538:	00878d63          	beq	a5,s0,ffffffffc0204552 <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc020453c:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204540:	fed715e3          	bne	a4,a3,ffffffffc020452a <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204544:	2685                	addiw	a3,a3,1
ffffffffc0204546:	04c6d763          	bge	a3,a2,ffffffffc0204594 <do_fork+0x21c>
ffffffffc020454a:	679c                	ld	a5,8(a5)
ffffffffc020454c:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020454e:	fe8797e3          	bne	a5,s0,ffffffffc020453c <do_fork+0x1c4>
ffffffffc0204552:	c581                	beqz	a1,ffffffffc020455a <do_fork+0x1e2>
ffffffffc0204554:	00d82023          	sw	a3,0(a6)
ffffffffc0204558:	8536                	mv	a0,a3
ffffffffc020455a:	f2088be3          	beqz	a7,ffffffffc0204490 <do_fork+0x118>
ffffffffc020455e:	00c32023          	sw	a2,0(t1)
ffffffffc0204562:	b73d                	j	ffffffffc0204490 <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204564:	8936                	mv	s2,a3
ffffffffc0204566:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020456a:	00000797          	auipc	a5,0x0
ffffffffc020456e:	d2878793          	addi	a5,a5,-728 # ffffffffc0204292 <forkret>
ffffffffc0204572:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204576:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020457a:	100027f3          	csrr	a5,sstatus
ffffffffc020457e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204580:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204582:	ec078ee3          	beqz	a5,ffffffffc020445e <do_fork+0xe6>
        intr_disable();
ffffffffc0204586:	83cfc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020458a:	4905                	li	s2,1
ffffffffc020458c:	bdc9                	j	ffffffffc020445e <do_fork+0xe6>
        intr_enable();
ffffffffc020458e:	82efc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204592:	b7a9                	j	ffffffffc02044dc <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc0204594:	01d6c363          	blt	a3,t4,ffffffffc020459a <do_fork+0x222>
                        last_pid = 1;
ffffffffc0204598:	4685                	li	a3,1
                    goto repeat;
ffffffffc020459a:	4585                	li	a1,1
ffffffffc020459c:	b749                	j	ffffffffc020451e <do_fork+0x1a6>
ffffffffc020459e:	cda9                	beqz	a1,ffffffffc02045f8 <do_fork+0x280>
ffffffffc02045a0:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045a4:	8536                	mv	a0,a3
ffffffffc02045a6:	b5ed                	j	ffffffffc0204490 <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045a8:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc02045ac:	c02007b7          	lui	a5,0xc0200
ffffffffc02045b0:	0af6e163          	bltu	a3,a5,ffffffffc0204652 <do_fork+0x2da>
ffffffffc02045b4:	00012797          	auipc	a5,0x12
ffffffffc02045b8:	fcc7b783          	ld	a5,-52(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045bc:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045c0:	83b1                	srli	a5,a5,0xc
ffffffffc02045c2:	00012717          	auipc	a4,0x12
ffffffffc02045c6:	fa673703          	ld	a4,-90(a4) # ffffffffc0216568 <npage>
ffffffffc02045ca:	06e7f863          	bgeu	a5,a4,ffffffffc020463a <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045ce:	00003717          	auipc	a4,0x3
ffffffffc02045d2:	a5273703          	ld	a4,-1454(a4) # ffffffffc0207020 <nbase>
ffffffffc02045d6:	8f99                	sub	a5,a5,a4
ffffffffc02045d8:	079a                	slli	a5,a5,0x6
ffffffffc02045da:	00012517          	auipc	a0,0x12
ffffffffc02045de:	f9653503          	ld	a0,-106(a0) # ffffffffc0216570 <pages>
ffffffffc02045e2:	953e                	add	a0,a0,a5
ffffffffc02045e4:	4589                	li	a1,2
ffffffffc02045e6:	cd8fd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045ea:	854e                	mv	a0,s3
ffffffffc02045ec:	b12fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045f0:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045f2:	bdd5                	j	ffffffffc02044e6 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045f4:	556d                	li	a0,-5
ffffffffc02045f6:	bdc5                	j	ffffffffc02044e6 <do_fork+0x16e>
    return last_pid;
ffffffffc02045f8:	00082503          	lw	a0,0(a6)
ffffffffc02045fc:	bd51                	j	ffffffffc0204490 <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc02045fe:	5571                	li	a0,-4
    return ret;
ffffffffc0204600:	b5dd                	j	ffffffffc02044e6 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc0204602:	00002697          	auipc	a3,0x2
ffffffffc0204606:	67e68693          	addi	a3,a3,1662 # ffffffffc0206c80 <default_pmm_manager+0xff0>
ffffffffc020460a:	00001617          	auipc	a2,0x1
ffffffffc020460e:	2d660613          	addi	a2,a2,726 # ffffffffc02058e0 <commands+0x738>
ffffffffc0204612:	10d00593          	li	a1,269
ffffffffc0204616:	00002517          	auipc	a0,0x2
ffffffffc020461a:	68250513          	addi	a0,a0,1666 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc020461e:	e29fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0204622:	00001617          	auipc	a2,0x1
ffffffffc0204626:	6a660613          	addi	a2,a2,1702 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc020462a:	06900593          	li	a1,105
ffffffffc020462e:	00001517          	auipc	a0,0x1
ffffffffc0204632:	6c250513          	addi	a0,a0,1730 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204636:	e11fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020463a:	00001617          	auipc	a2,0x1
ffffffffc020463e:	75e60613          	addi	a2,a2,1886 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0204642:	06200593          	li	a1,98
ffffffffc0204646:	00001517          	auipc	a0,0x1
ffffffffc020464a:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc020464e:	df9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204652:	00001617          	auipc	a2,0x1
ffffffffc0204656:	71e60613          	addi	a2,a2,1822 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc020465a:	06e00593          	li	a1,110
ffffffffc020465e:	00001517          	auipc	a0,0x1
ffffffffc0204662:	69250513          	addi	a0,a0,1682 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204666:	de1fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020466a <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020466a:	7129                	addi	sp,sp,-320
ffffffffc020466c:	fa22                	sd	s0,304(sp)
ffffffffc020466e:	f626                	sd	s1,296(sp)
ffffffffc0204670:	f24a                	sd	s2,288(sp)
ffffffffc0204672:	84ae                	mv	s1,a1
ffffffffc0204674:	892a                	mv	s2,a0
ffffffffc0204676:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204678:	4581                	li	a1,0
ffffffffc020467a:	12000613          	li	a2,288
ffffffffc020467e:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204680:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204682:	06f000ef          	jal	ra,ffffffffc0204ef0 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0204686:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0204688:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020468a:	100027f3          	csrr	a5,sstatus
ffffffffc020468e:	edd7f793          	andi	a5,a5,-291
ffffffffc0204692:	1207e793          	ori	a5,a5,288
ffffffffc0204696:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204698:	860a                	mv	a2,sp
ffffffffc020469a:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020469e:	00000797          	auipc	a5,0x0
ffffffffc02046a2:	b8a78793          	addi	a5,a5,-1142 # ffffffffc0204228 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046a6:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046a8:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046aa:	ccfff0ef          	jal	ra,ffffffffc0204378 <do_fork>
}
ffffffffc02046ae:	70f2                	ld	ra,312(sp)
ffffffffc02046b0:	7452                	ld	s0,304(sp)
ffffffffc02046b2:	74b2                	ld	s1,296(sp)
ffffffffc02046b4:	7912                	ld	s2,288(sp)
ffffffffc02046b6:	6131                	addi	sp,sp,320
ffffffffc02046b8:	8082                	ret

ffffffffc02046ba <do_exit>:
do_exit(int error_code) {
ffffffffc02046ba:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02046bc:	00002617          	auipc	a2,0x2
ffffffffc02046c0:	5f460613          	addi	a2,a2,1524 # ffffffffc0206cb0 <default_pmm_manager+0x1020>
ffffffffc02046c4:	17100593          	li	a1,369
ffffffffc02046c8:	00002517          	auipc	a0,0x2
ffffffffc02046cc:	5d050513          	addi	a0,a0,1488 # ffffffffc0206c98 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc02046d0:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046d2:	d75fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02046d6 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc02046d6:	7179                	addi	sp,sp,-48
ffffffffc02046d8:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046da:	00012797          	auipc	a5,0x12
ffffffffc02046de:	e4e78793          	addi	a5,a5,-434 # ffffffffc0216528 <proc_list>
ffffffffc02046e2:	f406                	sd	ra,40(sp)
ffffffffc02046e4:	f022                	sd	s0,32(sp)
ffffffffc02046e6:	e84a                	sd	s2,16(sp)
ffffffffc02046e8:	e44e                	sd	s3,8(sp)
ffffffffc02046ea:	0000e497          	auipc	s1,0xe
ffffffffc02046ee:	e2e48493          	addi	s1,s1,-466 # ffffffffc0212518 <hash_list>
...
ffffffffc02046fa:	e2270713          	addi	a4,a4,-478 # ffffffffc0216518 <name.2>
ffffffffc02046fe:	87a6                	mv	a5,s1
ffffffffc0204700:	e79c                	sd	a5,8(a5)
ffffffffc0204702:	e39c                	sd	a5,0(a5)
ffffffffc0204704:	07c1                	addi	a5,a5,16
ffffffffc0204706:	fef71de3          	bne	a4,a5,ffffffffc0204700 <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc020470a:	b27ff0ef          	jal	ra,ffffffffc0204230 <alloc_proc>
ffffffffc020470e:	00012917          	auipc	s2,0x12
ffffffffc0204712:	eaa90913          	addi	s2,s2,-342 # ffffffffc02165b8 <idleproc>
ffffffffc0204716:	00a93023          	sd	a0,0(s2)
ffffffffc020471a:	18050d63          	beqz	a0,ffffffffc02048b4 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020471e:	07000513          	li	a0,112
ffffffffc0204722:	92cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204726:	07000613          	li	a2,112
ffffffffc020472a:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020472c:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020472e:	7c2000ef          	jal	ra,ffffffffc0204ef0 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204732:	00093503          	ld	a0,0(s2)
ffffffffc0204736:	85a2                	mv	a1,s0
ffffffffc0204738:	07000613          	li	a2,112
ffffffffc020473c:	03050513          	addi	a0,a0,48
ffffffffc0204740:	7da000ef          	jal	ra,ffffffffc0204f1a <memcmp>
ffffffffc0204744:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204746:	453d                	li	a0,15
ffffffffc0204748:	906fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc0204750:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204752:	79e000ef          	jal	ra,ffffffffc0204ef0 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204756:	00093503          	ld	a0,0(s2)
ffffffffc020475a:	463d                	li	a2,15
ffffffffc020475c:	85a2                	mv	a1,s0
ffffffffc020475e:	0b450513          	addi	a0,a0,180
ffffffffc0204762:	7b8000ef          	jal	ra,ffffffffc0204f1a <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204766:	00093783          	ld	a5,0(s2)
ffffffffc020476a:	00012717          	auipc	a4,0x12
ffffffffc020476e:	dee73703          	ld	a4,-530(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc0204772:	77d4                	ld	a3,168(a5)
ffffffffc0204774:	0ee68463          	beq	a3,a4,ffffffffc020485c <proc_init+0x186>
...
ffffffffc020477a:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020477c:	00004717          	auipc	a4,0x4
ffffffffc0204780:	88470713          	addi	a4,a4,-1916 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204784:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204788:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc020478a:	4705                	li	a4,1
ffffffffc020478c:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020478e:	4641                	li	a2,16
ffffffffc0204790:	4581                	li	a1,0
ffffffffc0204792:	8522                	mv	a0,s0
ffffffffc0204794:	75c000ef          	jal	ra,ffffffffc0204ef0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204798:	463d                	li	a2,15
ffffffffc020479a:	00002597          	auipc	a1,0x2
ffffffffc020479e:	55e58593          	addi	a1,a1,1374 # ffffffffc0206cf8 <default_pmm_manager+0x1068>
ffffffffc02047a2:	8522                	mv	a0,s0
ffffffffc02047a4:	75e000ef          	jal	ra,ffffffffc0204f02 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02047a8:	00012717          	auipc	a4,0x12
ffffffffc02047ac:	e2070713          	addi	a4,a4,-480 # ffffffffc02165c8 <nr_process>
ffffffffc02047b0:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02047b2:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047b6:	4601                	li	a2,0
    nr_process ++;
ffffffffc02047b8:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047ba:	00002597          	auipc	a1,0x2
ffffffffc02047be:	54658593          	addi	a1,a1,1350 # ffffffffc0206d00 <default_pmm_manager+0x1070>
ffffffffc02047c2:	00000517          	auipc	a0,0x0
ffffffffc02047c6:	ade50513          	addi	a0,a0,-1314 # ffffffffc02042a0 <init_main>
    nr_process ++;
ffffffffc02047ca:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047cc:	00012797          	auipc	a5,0x12
ffffffffc02047d0:	ded7b223          	sd	a3,-540(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047d4:	e97ff0ef          	jal	ra,ffffffffc020466a <kernel_thread>
ffffffffc02047d8:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047da:	0ea05963          	blez	a0,ffffffffc02048cc <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047de:	6789                	lui	a5,0x2
ffffffffc02047e0:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047e4:	17f9                	addi	a5,a5,-2
ffffffffc02047e6:	2501                	sext.w	a0,a0
ffffffffc02047e8:	02e7e363          	bltu	a5,a4,ffffffffc020480e <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047ec:	45a9                	li	a1,10
ffffffffc02047ee:	282000ef          	jal	ra,ffffffffc0204a70 <hash32>
ffffffffc02047f2:	02051793          	slli	a5,a0,0x20
ffffffffc02047f6:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047fa:	96a6                	add	a3,a3,s1
ffffffffc02047fc:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047fe:	a029                	j	ffffffffc0204808 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc0204800:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204804:	0a870563          	beq	a4,s0,ffffffffc02048ae <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204808:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020480a:	fef69be3          	bne	a3,a5,ffffffffc0204800 <proc_init+0x12a>
    return NULL;
ffffffffc020480e:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204810:	0b478493          	addi	s1,a5,180
ffffffffc0204814:	4641                	li	a2,16
ffffffffc0204816:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204818:	00012417          	auipc	s0,0x12
ffffffffc020481c:	da840413          	addi	s0,s0,-600 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204820:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204822:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204824:	6cc000ef          	jal	ra,ffffffffc0204ef0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204828:	463d                	li	a2,15
ffffffffc020482a:	00002597          	auipc	a1,0x2
ffffffffc020482e:	50658593          	addi	a1,a1,1286 # ffffffffc0206d30 <default_pmm_manager+0x10a0>
ffffffffc0204832:	8526                	mv	a0,s1
ffffffffc0204834:	6ce000ef          	jal	ra,ffffffffc0204f02 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204838:	00093783          	ld	a5,0(s2)
ffffffffc020483c:	c7e1                	beqz	a5,ffffffffc0204904 <proc_init+0x22e>
ffffffffc020483e:	43dc                	lw	a5,4(a5)
ffffffffc0204840:	e3f1                	bnez	a5,ffffffffc0204904 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204842:	601c                	ld	a5,0(s0)
ffffffffc0204844:	c3c5                	beqz	a5,ffffffffc02048e4 <proc_init+0x20e>
ffffffffc0204846:	43d8                	lw	a4,4(a5)
ffffffffc0204848:	4785                	li	a5,1
ffffffffc020484a:	08f71d63          	bne	a4,a5,ffffffffc02048e4 <proc_init+0x20e>
}
ffffffffc020484e:	70a2                	ld	ra,40(sp)
ffffffffc0204850:	7402                	ld	s0,32(sp)
ffffffffc0204852:	64e2                	ld	s1,24(sp)
ffffffffc0204854:	6942                	ld	s2,16(sp)
ffffffffc0204856:	69a2                	ld	s3,8(sp)
ffffffffc0204858:	6145                	addi	sp,sp,48
ffffffffc020485a:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020485c:	73d8                	ld	a4,160(a5)
ffffffffc020485e:	ff09                	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
ffffffffc0204860:	f0099ce3          	bnez	s3,ffffffffc0204778 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204864:	6394                	ld	a3,0(a5)
ffffffffc0204866:	577d                	li	a4,-1
ffffffffc0204868:	1702                	slli	a4,a4,0x20
ffffffffc020486a:	f0e697e3          	bne	a3,a4,ffffffffc0204778 <proc_init+0xa2>
ffffffffc020486e:	4798                	lw	a4,8(a5)
ffffffffc0204870:	f00714e3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204874:	6b98                	ld	a4,16(a5)
ffffffffc0204876:	f00711e3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
ffffffffc020487a:	4f98                	lw	a4,24(a5)
ffffffffc020487c:	2701                	sext.w	a4,a4
ffffffffc020487e:	ee071de3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
ffffffffc0204882:	7398                	ld	a4,32(a5)
ffffffffc0204884:	ee071ae3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204888:	7798                	ld	a4,40(a5)
ffffffffc020488a:	ee0717e3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
ffffffffc020488e:	0b07a703          	lw	a4,176(a5)
ffffffffc0204892:	8d59                	or	a0,a0,a4
ffffffffc0204894:	0005071b          	sext.w	a4,a0
ffffffffc0204898:	ee0710e3          	bnez	a4,ffffffffc0204778 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc020489c:	00002517          	auipc	a0,0x2
ffffffffc02048a0:	44450513          	addi	a0,a0,1092 # ffffffffc0206ce0 <default_pmm_manager+0x1050>
ffffffffc02048a4:	8ddfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02048a8:	00093783          	ld	a5,0(s2)
ffffffffc02048ac:	b5f1                	j	ffffffffc0204778 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02048ae:	f2878793          	addi	a5,a5,-216
ffffffffc02048b2:	bfb9                	j	ffffffffc0204810 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02048b4:	00002617          	auipc	a2,0x2
ffffffffc02048b8:	41460613          	addi	a2,a2,1044 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048bc:	18900593          	li	a1,393
ffffffffc02048c0:	00002517          	auipc	a0,0x2
ffffffffc02048c4:	3d850513          	addi	a0,a0,984 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc02048c8:	b7ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048cc:	00002617          	auipc	a2,0x2
ffffffffc02048d0:	44460613          	addi	a2,a2,1092 # ffffffffc0206d10 <default_pmm_manager+0x1080>
ffffffffc02048d4:	1a900593          	li	a1,425
ffffffffc02048d8:	00002517          	auipc	a0,0x2
ffffffffc02048dc:	3c050513          	addi	a0,a0,960 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc02048e0:	b67fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048e4:	00002697          	auipc	a3,0x2
ffffffffc02048e8:	47c68693          	addi	a3,a3,1148 # ffffffffc0206d60 <default_pmm_manager+0x10d0>
ffffffffc02048ec:	00001617          	auipc	a2,0x1
ffffffffc02048f0:	ff460613          	addi	a2,a2,-12 # ffffffffc02058e0 <commands+0x738>
ffffffffc02048f4:	1b000593          	li	a1,432
ffffffffc02048f8:	00002517          	auipc	a0,0x2
ffffffffc02048fc:	3a050513          	addi	a0,a0,928 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204900:	b47fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204904:	00002697          	auipc	a3,0x2
ffffffffc0204908:	43468693          	addi	a3,a3,1076 # ffffffffc0206d38 <default_pmm_manager+0x10a8>
ffffffffc020490c:	00001617          	auipc	a2,0x1
ffffffffc0204910:	fd460613          	addi	a2,a2,-44 # ffffffffc02058e0 <commands+0x738>
ffffffffc0204914:	1af00593          	li	a1,431
ffffffffc0204918:	00002517          	auipc	a0,0x2
ffffffffc020491c:	38050513          	addi	a0,a0,896 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204920:	b27fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204924 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204924:	1141                	addi	sp,sp,-16
ffffffffc0204926:	e022                	sd	s0,0(sp)
ffffffffc0204928:	e406                	sd	ra,8(sp)
ffffffffc020492a:	00012417          	auipc	s0,0x12
ffffffffc020492e:	c8640413          	addi	s0,s0,-890 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204932:	6018                	ld	a4,0(s0)
ffffffffc0204934:	4f1c                	lw	a5,24(a4)
ffffffffc0204936:	2781                	sext.w	a5,a5
ffffffffc0204938:	dff5                	beqz	a5,ffffffffc0204934 <cpu_idle+0x10>
            schedule();
ffffffffc020493a:	0a2000ef          	jal	ra,ffffffffc02049dc <schedule>
ffffffffc020493e:	bfd5                	j	ffffffffc0204932 <cpu_idle+0xe>

ffffffffc0204940 <switch_to>:
.text
...
ffffffffc0204940:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204944:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204948:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020494a:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020494c:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204950:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204954:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204958:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020495c:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204960:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204964:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204968:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020496c:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204970:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204974:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204978:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020497c:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020497e:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204980:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204984:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204988:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020498c:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204990:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204994:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204998:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020499c:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02049a0:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049a4:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02049a8:	8082                	ret

ffffffffc02049aa <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02049aa:	411c                	lw	a5,0(a0)
ffffffffc02049ac:	4705                	li	a4,1
ffffffffc02049ae:	37f9                	addiw	a5,a5,-2
ffffffffc02049b0:	00f77563          	bgeu	a4,a5,ffffffffc02049ba <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02049b4:	4789                	li	a5,2
ffffffffc02049b6:	c11c                	sw	a5,0(a0)
ffffffffc02049b8:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049ba:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049bc:	00002697          	auipc	a3,0x2
ffffffffc02049c0:	3cc68693          	addi	a3,a3,972 # ffffffffc0206d88 <default_pmm_manager+0x10f8>
ffffffffc02049c4:	00001617          	auipc	a2,0x1
ffffffffc02049c8:	f1c60613          	addi	a2,a2,-228 # ffffffffc02058e0 <commands+0x738>
ffffffffc02049cc:	45a5                	li	a1,9
ffffffffc02049ce:	00002517          	auipc	a0,0x2
ffffffffc02049d2:	3fa50513          	addi	a0,a0,1018 # ffffffffc0206dc8 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049d6:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049d8:	a6ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049dc <schedule>:
}

void
schedule(void) {
ffffffffc02049dc:	1141                	addi	sp,sp,-16
ffffffffc02049de:	e406                	sd	ra,8(sp)
ffffffffc02049e0:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049e2:	100027f3          	csrr	a5,sstatus
ffffffffc02049e6:	8b89                	andi	a5,a5,2
ffffffffc02049e8:	4401                	li	s0,0
ffffffffc02049ea:	efbd                	bnez	a5,ffffffffc0204a68 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049ec:	00012897          	auipc	a7,0x12
ffffffffc02049f0:	bc48b883          	ld	a7,-1084(a7) # ffffffffc02165b0 <current>
ffffffffc02049f4:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049f8:	00012517          	auipc	a0,0x12
ffffffffc02049fc:	bc053503          	ld	a0,-1088(a0) # ffffffffc02165b8 <idleproc>
ffffffffc0204a00:	04a88e63          	beq	a7,a0,ffffffffc0204a5c <schedule+0x80>
ffffffffc0204a04:	0c888693          	addi	a3,a7,200
ffffffffc0204a08:	00012617          	auipc	a2,0x12
ffffffffc0204a0c:	b2060613          	addi	a2,a2,-1248 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc0204a10:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204a14:	4809                	li	a6,2
ffffffffc0204a16:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a18:	00c78863          	beq	a5,a2,ffffffffc0204a28 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a1c:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a20:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a24:	03070163          	beq	a4,a6,ffffffffc0204a46 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a28:	fef697e3          	bne	a3,a5,ffffffffc0204a16 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a2c:	ed89                	bnez	a1,ffffffffc0204a46 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a2e:	451c                	lw	a5,8(a0)
ffffffffc0204a30:	2785                	addiw	a5,a5,1
ffffffffc0204a32:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a34:	00a88463          	beq	a7,a0,ffffffffc0204a3c <schedule+0x60>
            proc_run(next);
ffffffffc0204a38:	8dbff0ef          	jal	ra,ffffffffc0204312 <proc_run>
    if (flag) {
ffffffffc0204a3c:	e819                	bnez	s0,ffffffffc0204a52 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a3e:	60a2                	ld	ra,8(sp)
ffffffffc0204a40:	6402                	ld	s0,0(sp)
ffffffffc0204a42:	0141                	addi	sp,sp,16
ffffffffc0204a44:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a46:	4198                	lw	a4,0(a1)
ffffffffc0204a48:	4789                	li	a5,2
ffffffffc0204a4a:	fef712e3          	bne	a4,a5,ffffffffc0204a2e <schedule+0x52>
ffffffffc0204a4e:	852e                	mv	a0,a1
ffffffffc0204a50:	bff9                	j	ffffffffc0204a2e <schedule+0x52>
}
ffffffffc0204a52:	6402                	ld	s0,0(sp)
ffffffffc0204a54:	60a2                	ld	ra,8(sp)
ffffffffc0204a56:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a58:	b65fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a5c:	00012617          	auipc	a2,0x12
ffffffffc0204a60:	acc60613          	addi	a2,a2,-1332 # ffffffffc0216528 <proc_list>
ffffffffc0204a64:	86b2                	mv	a3,a2
ffffffffc0204a66:	b76d                	j	ffffffffc0204a10 <schedule+0x34>
        intr_disable();
ffffffffc0204a68:	b5bfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a6c:	4405                	li	s0,1
ffffffffc0204a6e:	bfbd                	j	ffffffffc02049ec <schedule+0x10>

ffffffffc0204a70 <hash32>:
 *
...
ffffffffc0204a70:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a74:	2785                	addiw	a5,a5,1
ffffffffc0204a76:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a7a:	02000793          	li	a5,32
ffffffffc0204a7e:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a80:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc0204aa8:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204aaa:	03067e63          	bgeu	a2,a6,ffffffffc0204ae6 <printnum+0x60>
...
ffffffffc0204ac0:	00002797          	auipc	a5,0x2
ffffffffc0204ac4:	32078793          	addi	a5,a5,800 # ffffffffc0206de0 <default_pmm_manager+0x1150>
ffffffffc0204ac8:	020a5a13          	srli	s4,s4,0x20
...
ffffffffc0204afa:	e8d2                	sd	s4,80(sp)
ffffffffc0204afc:	e4d6                	sd	s5,72(sp)
ffffffffc0204afe:	e0da                	sd	s6,64(sp)
ffffffffc0204b00:	fc5e                	sd	s7,56(sp)
ffffffffc0204b02:	f06a                	sd	s10,32(sp)
ffffffffc0204b04:	fc86                	sd	ra,120(sp)
ffffffffc0204b06:	f8a2                	sd	s0,112(sp)
ffffffffc0204b08:	f862                	sd	s8,48(sp)
...
ffffffffc0204b14:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b16:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204b1a:	5b7d                	li	s6,-1
ffffffffc0204b1c:	00002a97          	auipc	s5,0x2
ffffffffc0204b20:	2f0a8a93          	addi	s5,s5,752 # ffffffffc0206e0c <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b24:	00002b97          	auipc	s7,0x2
ffffffffc0204b28:	4c4b8b93          	addi	s7,s7,1220 # ffffffffc0206fe8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b2c:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b30:	001d0413          	addi	s0,s10,1
ffffffffc0204b34:	01350a63          	beq	a0,s3,ffffffffc0204b48 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b38:	c121                	beqz	a0,ffffffffc0204b78 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b3e:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b40:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b44:	ff351ae3          	bne	a0,s3,ffffffffc0204b38 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b48:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b4c:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b50:	4c81                	li	s9,0
ffffffffc0204b52:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b54:	5c7d                	li	s8,-1
ffffffffc0204b56:	5dfd                	li	s11,-1
ffffffffc0204b58:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b5c:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b5e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b62:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b66:	00140d13          	addi	s10,s0,1
ffffffffc0204b6a:	04b56263          	bltu	a0,a1,ffffffffc0204bae <vprintfmt+0xbc>
ffffffffc0204b6e:	058a                	slli	a1,a1,0x2
ffffffffc0204b70:	95d6                	add	a1,a1,s5
ffffffffc0204b72:	4194                	lw	a3,0(a1)
ffffffffc0204b74:	96d6                	add	a3,a3,s5
ffffffffc0204b76:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b78:	70e6                	ld	ra,120(sp)
ffffffffc0204b7a:	7446                	ld	s0,112(sp)
ffffffffc0204b7c:	74a6                	ld	s1,104(sp)
ffffffffc0204b7e:	7906                	ld	s2,96(sp)
ffffffffc0204b80:	69e6                	ld	s3,88(sp)
ffffffffc0204b82:	6a46                	ld	s4,80(sp)
ffffffffc0204b84:	6aa6                	ld	s5,72(sp)
ffffffffc0204b86:	6b06                	ld	s6,64(sp)
ffffffffc0204b88:	7be2                	ld	s7,56(sp)
ffffffffc0204b8a:	7c42                	ld	s8,48(sp)
ffffffffc0204b8c:	7ca2                	ld	s9,40(sp)
ffffffffc0204b8e:	7d02                	ld	s10,32(sp)
ffffffffc0204b90:	6de2                	ld	s11,24(sp)
ffffffffc0204b92:	6109                	addi	sp,sp,128
ffffffffc0204b94:	8082                	ret
            padc = '0';
ffffffffc0204b96:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b98:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b9c:	846a                	mv	s0,s10
ffffffffc0204b9e:	00140d13          	addi	s10,s0,1
ffffffffc0204ba2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ba6:	0ff5f593          	zext.b	a1,a1
ffffffffc0204baa:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b6e <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204bae:	85a6                	mv	a1,s1
ffffffffc0204bb0:	02500513          	li	a0,37
ffffffffc0204bb4:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bb6:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bba:	8d22                	mv	s10,s0
ffffffffc0204bbc:	f73788e3          	beq	a5,s3,ffffffffc0204b2c <vprintfmt+0x3a>
ffffffffc0204bc0:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bc4:	1d7d                	addi	s10,s10,-1
ffffffffc0204bc6:	ff379de3          	bne	a5,s3,ffffffffc0204bc0 <vprintfmt+0xce>
ffffffffc0204bca:	b78d                	j	ffffffffc0204b2c <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bcc:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bd0:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bd4:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bd6:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bda:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bde:	02d86463          	bltu	a6,a3,ffffffffc0204c06 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204be2:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204be6:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bea:	0186873b          	addw	a4,a3,s8
ffffffffc0204bee:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bf2:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bf4:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bf8:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bfa:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bfe:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c02:	fed870e3          	bgeu	a6,a3,ffffffffc0204be2 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c06:	f40ddce3          	bgez	s11,ffffffffc0204b5e <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c0a:	8de2                	mv	s11,s8
ffffffffc0204c0c:	5c7d                	li	s8,-1
ffffffffc0204c0e:	bf81                	j	ffffffffc0204b5e <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c10:	fffdc693          	not	a3,s11
ffffffffc0204c14:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c16:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1a:	00144603          	lbu	a2,1(s0)
ffffffffc0204c1e:	2d81                	sext.w	s11,s11
ffffffffc0204c20:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c22:	bf35                	j	ffffffffc0204b5e <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c24:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c28:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c2c:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2e:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c30:	bfd9                	j	ffffffffc0204c06 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c32:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c34:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c38:	01174463          	blt	a4,a7,ffffffffc0204c40 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c3c:	1a088e63          	beqz	a7,ffffffffc0204df8 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c40:	000a3603          	ld	a2,0(s4)
ffffffffc0204c44:	46c1                	li	a3,16
ffffffffc0204c46:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c48:	2781                	sext.w	a5,a5
ffffffffc0204c4a:	876e                	mv	a4,s11
ffffffffc0204c4c:	85a6                	mv	a1,s1
ffffffffc0204c4e:	854a                	mv	a0,s2
ffffffffc0204c50:	e37ff0ef          	jal	ra,ffffffffc0204a86 <printnum>
            break;
ffffffffc0204c54:	bde1                	j	ffffffffc0204b2c <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c56:	000a2503          	lw	a0,0(s4)
ffffffffc0204c5a:	85a6                	mv	a1,s1
ffffffffc0204c5c:	0a21                	addi	s4,s4,8
ffffffffc0204c5e:	9902                	jalr	s2
            break;
ffffffffc0204c60:	b5f1                	j	ffffffffc0204b2c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c62:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c64:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c68:	01174463          	blt	a4,a7,ffffffffc0204c70 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c6c:	18088163          	beqz	a7,ffffffffc0204dee <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c70:	000a3603          	ld	a2,0(s4)
ffffffffc0204c74:	46a9                	li	a3,10
ffffffffc0204c76:	8a2e                	mv	s4,a1
ffffffffc0204c78:	bfc1                	j	ffffffffc0204c48 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c7a:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c7e:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c80:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c82:	bdf1                	j	ffffffffc0204b5e <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c84:	85a6                	mv	a1,s1
ffffffffc0204c86:	02500513          	li	a0,37
ffffffffc0204c8a:	9902                	jalr	s2
            break;
ffffffffc0204c8c:	b545                	j	ffffffffc0204b2c <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c8e:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c92:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c94:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c96:	b5e1                	j	ffffffffc0204b5e <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c98:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c9a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c9e:	01174463          	blt	a4,a7,ffffffffc0204ca6 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204ca2:	14088163          	beqz	a7,ffffffffc0204de4 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204ca6:	000a3603          	ld	a2,0(s4)
ffffffffc0204caa:	46a1                	li	a3,8
ffffffffc0204cac:	8a2e                	mv	s4,a1
ffffffffc0204cae:	bf69                	j	ffffffffc0204c48 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204cb0:	03000513          	li	a0,48
ffffffffc0204cb4:	85a6                	mv	a1,s1
ffffffffc0204cb6:	e03e                	sd	a5,0(sp)
ffffffffc0204cb8:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204cba:	85a6                	mv	a1,s1
ffffffffc0204cbc:	07800513          	li	a0,120
ffffffffc0204cc0:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cc2:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cc4:	6782                	ld	a5,0(sp)
ffffffffc0204cc6:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cc8:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204ccc:	bfb5                	j	ffffffffc0204c48 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cce:	000a3403          	ld	s0,0(s4)
ffffffffc0204cd2:	008a0713          	addi	a4,s4,8
ffffffffc0204cd6:	e03a                	sd	a4,0(sp)
ffffffffc0204cd8:	14040263          	beqz	s0,ffffffffc0204e1c <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cdc:	0fb05763          	blez	s11,ffffffffc0204dca <vprintfmt+0x2d8>
ffffffffc0204ce0:	02d00693          	li	a3,45
ffffffffc0204ce4:	0cd79163          	bne	a5,a3,ffffffffc0204da6 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce8:	00044783          	lbu	a5,0(s0)
ffffffffc0204cec:	0007851b          	sext.w	a0,a5
ffffffffc0204cf0:	cf85                	beqz	a5,ffffffffc0204d28 <vprintfmt+0x236>
ffffffffc0204cf2:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cf6:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cfa:	000c4563          	bltz	s8,ffffffffc0204d04 <vprintfmt+0x212>
ffffffffc0204cfe:	3c7d                	addiw	s8,s8,-1
ffffffffc0204d00:	036c0263          	beq	s8,s6,ffffffffc0204d24 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d04:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d06:	0e0c8e63          	beqz	s9,ffffffffc0204e02 <vprintfmt+0x310>
ffffffffc0204d0a:	3781                	addiw	a5,a5,-32
ffffffffc0204d0c:	0ef47b63          	bgeu	s0,a5,ffffffffc0204e02 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d10:	03f00513          	li	a0,63
ffffffffc0204d14:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d16:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d1a:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d1c:	0a05                	addi	s4,s4,1
ffffffffc0204d1e:	0007851b          	sext.w	a0,a5
ffffffffc0204d22:	ffe1                	bnez	a5,ffffffffc0204cfa <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d24:	01b05963          	blez	s11,ffffffffc0204d36 <vprintfmt+0x244>
ffffffffc0204d28:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204d2a:	85a6                	mv	a1,s1
ffffffffc0204d2c:	02000513          	li	a0,32
ffffffffc0204d30:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d32:	fe0d9be3          	bnez	s11,ffffffffc0204d28 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d36:	6a02                	ld	s4,0(sp)
ffffffffc0204d38:	bbd5                	j	ffffffffc0204b2c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d3a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d3c:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d40:	01174463          	blt	a4,a7,ffffffffc0204d48 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d44:	08088d63          	beqz	a7,ffffffffc0204dde <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d48:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d4c:	0a044d63          	bltz	s0,ffffffffc0204e06 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d50:	8622                	mv	a2,s0
ffffffffc0204d52:	8a66                	mv	s4,s9
ffffffffc0204d54:	46a9                	li	a3,10
ffffffffc0204d56:	bdcd                	j	ffffffffc0204c48 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d58:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d5c:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d5e:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d60:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d64:	8fb5                	xor	a5,a5,a3
ffffffffc0204d66:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d6a:	02d74163          	blt	a4,a3,ffffffffc0204d8c <vprintfmt+0x29a>
ffffffffc0204d6e:	00369793          	slli	a5,a3,0x3
ffffffffc0204d72:	97de                	add	a5,a5,s7
ffffffffc0204d74:	639c                	ld	a5,0(a5)
ffffffffc0204d76:	cb99                	beqz	a5,ffffffffc0204d8c <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d78:	86be                	mv	a3,a5
ffffffffc0204d7a:	00000617          	auipc	a2,0x0
ffffffffc0204d7e:	1ee60613          	addi	a2,a2,494 # ffffffffc0204f68 <etext+0x2a>
ffffffffc0204d82:	85a6                	mv	a1,s1
ffffffffc0204d84:	854a                	mv	a0,s2
ffffffffc0204d86:	0ce000ef          	jal	ra,ffffffffc0204e54 <printfmt>
ffffffffc0204d8a:	b34d                	j	ffffffffc0204b2c <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d8c:	00002617          	auipc	a2,0x2
ffffffffc0204d90:	07460613          	addi	a2,a2,116 # ffffffffc0206e00 <default_pmm_manager+0x1170>
ffffffffc0204d94:	85a6                	mv	a1,s1
ffffffffc0204d96:	854a                	mv	a0,s2
ffffffffc0204d98:	0bc000ef          	jal	ra,ffffffffc0204e54 <printfmt>
ffffffffc0204d9c:	bb41                	j	ffffffffc0204b2c <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d9e:	00002417          	auipc	s0,0x2
ffffffffc0204da2:	05a40413          	addi	s0,s0,90 # ffffffffc0206df8 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da6:	85e2                	mv	a1,s8
ffffffffc0204da8:	8522                	mv	a0,s0
ffffffffc0204daa:	e43e                	sd	a5,8(sp)
ffffffffc0204dac:	0e2000ef          	jal	ra,ffffffffc0204e8e <strnlen>
ffffffffc0204db0:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204db4:	01b05b63          	blez	s11,ffffffffc0204dca <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204db8:	67a2                	ld	a5,8(sp)
ffffffffc0204dba:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dbe:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dc0:	85a6                	mv	a1,s1
ffffffffc0204dc2:	8552                	mv	a0,s4
ffffffffc0204dc4:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dc6:	fe0d9ce3          	bnez	s11,ffffffffc0204dbe <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dca:	00044783          	lbu	a5,0(s0)
ffffffffc0204dce:	00140a13          	addi	s4,s0,1
ffffffffc0204dd2:	0007851b          	sext.w	a0,a5
ffffffffc0204dd6:	d3a5                	beqz	a5,ffffffffc0204d36 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dd8:	05e00413          	li	s0,94
ffffffffc0204ddc:	bf39                	j	ffffffffc0204cfa <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dde:	000a2403          	lw	s0,0(s4)
ffffffffc0204de2:	b7ad                	j	ffffffffc0204d4c <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204de4:	000a6603          	lwu	a2,0(s4)
ffffffffc0204de8:	46a1                	li	a3,8
ffffffffc0204dea:	8a2e                	mv	s4,a1
ffffffffc0204dec:	bdb1                	j	ffffffffc0204c48 <vprintfmt+0x156>
ffffffffc0204dee:	000a6603          	lwu	a2,0(s4)
ffffffffc0204df2:	46a9                	li	a3,10
ffffffffc0204df4:	8a2e                	mv	s4,a1
ffffffffc0204df6:	bd89                	j	ffffffffc0204c48 <vprintfmt+0x156>
ffffffffc0204df8:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dfc:	46c1                	li	a3,16
ffffffffc0204dfe:	8a2e                	mv	s4,a1
ffffffffc0204e00:	b5a1                	j	ffffffffc0204c48 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204e02:	9902                	jalr	s2
ffffffffc0204e04:	bf09                	j	ffffffffc0204d16 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204e06:	85a6                	mv	a1,s1
ffffffffc0204e08:	02d00513          	li	a0,45
ffffffffc0204e0c:	e03e                	sd	a5,0(sp)
ffffffffc0204e0e:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e10:	6782                	ld	a5,0(sp)
ffffffffc0204e12:	8a66                	mv	s4,s9
ffffffffc0204e14:	40800633          	neg	a2,s0
ffffffffc0204e18:	46a9                	li	a3,10
ffffffffc0204e1a:	b53d                	j	ffffffffc0204c48 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e1c:	03b05163          	blez	s11,ffffffffc0204e3e <vprintfmt+0x34c>
ffffffffc0204e20:	02d00693          	li	a3,45
ffffffffc0204e24:	f6d79de3          	bne	a5,a3,ffffffffc0204d9e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e28:	00002417          	auipc	s0,0x2
ffffffffc0204e2c:	fd040413          	addi	s0,s0,-48 # ffffffffc0206df8 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e30:	02800793          	li	a5,40
ffffffffc0204e34:	02800513          	li	a0,40
ffffffffc0204e38:	00140a13          	addi	s4,s0,1
ffffffffc0204e3c:	bd6d                	j	ffffffffc0204cf6 <vprintfmt+0x204>
ffffffffc0204e3e:	00002a17          	auipc	s4,0x2
ffffffffc0204e42:	fbba0a13          	addi	s4,s4,-69 # ffffffffc0206df9 <default_pmm_manager+0x1169>
ffffffffc0204e46:	02800513          	li	a0,40
ffffffffc0204e4a:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e4e:	05e00413          	li	s0,94
ffffffffc0204e52:	b565                	j	ffffffffc0204cfa <vprintfmt+0x208>
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204e74:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204e78:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e7a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e7c:	cb81                	beqz	a5,ffffffffc0204e8c <strlen+0x18>
        cnt ++;
ffffffffc0204e7e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e80:	00a707b3          	add	a5,a4,a0
ffffffffc0204e84:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e88:	fbfd                	bnez	a5,ffffffffc0204e7e <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e8e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e90:	e589                	bnez	a1,ffffffffc0204e9a <strnlen+0xc>
ffffffffc0204e92:	a811                	j	ffffffffc0204ea6 <strnlen+0x18>
        cnt ++;
ffffffffc0204e94:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e96:	00f58863          	beq	a1,a5,ffffffffc0204ea6 <strnlen+0x18>
ffffffffc0204e9a:	00f50733          	add	a4,a0,a5
ffffffffc0204e9e:	00074703          	lbu	a4,0(a4)
ffffffffc0204ea2:	fb6d                	bnez	a4,ffffffffc0204e94 <strnlen+0x6>
ffffffffc0204ea4:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204ea6:	852e                	mv	a0,a1
...
ffffffffc0204eaa:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204eac:	0005c703          	lbu	a4,0(a1)
ffffffffc0204eb0:	0785                	addi	a5,a5,1
...
ffffffffc0204ec0:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ec4:	cb89                	beqz	a5,ffffffffc0204ed6 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ec6:	0505                	addi	a0,a0,1
ffffffffc0204ec8:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204eca:	fee789e3          	beq	a5,a4,ffffffffc0204ebc <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ece:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ed2:	9d19                	subw	a0,a0,a4
ffffffffc0204ed4:	8082                	ret
ffffffffc0204ed6:	4501                	li	a0,0
ffffffffc0204ed8:	bfed                	j	ffffffffc0204ed2 <strcmp+0x16>

ffffffffc0204eda <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204eda:	00054783          	lbu	a5,0(a0)
ffffffffc0204ede:	c799                	beqz	a5,ffffffffc0204eec <strchr+0x12>
        if (*s == c) {
ffffffffc0204ee0:	00f58763          	beq	a1,a5,ffffffffc0204eee <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ee4:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204ee8:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204eea:	fbfd                	bnez	a5,ffffffffc0204ee0 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ef0:	ca01                	beqz	a2,ffffffffc0204f00 <memset+0x10>
ffffffffc0204ef2:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ef4:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ef6:	0785                	addi	a5,a5,1
ffffffffc0204ef8:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204efc:	fec79de3          	bne	a5,a2,ffffffffc0204ef6 <memset+0x6>
    }
    return s;
...
ffffffffc0204f02 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204f02:	ca19                	beqz	a2,ffffffffc0204f18 <memcpy+0x16>
ffffffffc0204f04:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204f06:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f08:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f0c:	0585                	addi	a1,a1,1
ffffffffc0204f0e:	0785                	addi	a5,a5,1
ffffffffc0204f10:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f14:	fec59ae3          	bne	a1,a2,ffffffffc0204f08 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f1a:	c205                	beqz	a2,ffffffffc0204f3a <memcmp+0x20>
ffffffffc0204f1c:	962e                	add	a2,a2,a1
ffffffffc0204f1e:	a019                	j	ffffffffc0204f24 <memcmp+0xa>
ffffffffc0204f20:	00c58d63          	beq	a1,a2,ffffffffc0204f3a <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204f24:	00054783          	lbu	a5,0(a0)
ffffffffc0204f28:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204f2c:	0505                	addi	a0,a0,1
ffffffffc0204f2e:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f30:	fee788e3          	beq	a5,a4,ffffffffc0204f20 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
